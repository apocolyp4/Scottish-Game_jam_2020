...
"""
This module wraps AppGameKit commands for Python 3.  Built on AppGameKit v2017.12.12.
...
BANNER_REGULAR = 0  # type: int
BANNER_LARGE = 1  # type: int
BANNER_MEDIUM = 2  # type: int
BANNER_FULL = 3  # type: int
BANNER_LEADERBOARD = 4  # type: int
BANNER_SMART = 5  # type: int
BANNER_FLUID = 6  # type: int
...
def create_distance_joint(sprite_id1: int, sprite_id2: int, x1: float, y1: float, x2: float,
                          y2: float, can_collide: Union[bool, int], id: int=0) -> int:
    """
    ...
    :param float x1: The x coordinate of the sprite 1 anchor point.
    :param float y1: The y coordinate of the sprite 1 anchor point.
    :param float x2: The x coordinate of the sprite 2 anchor point.
    :param float y2: The y coordinate of the sprite 2 anchor point.
    :param Union[bool, int] can_collide: Set whether the two sprites connected by the joint can collide with one
        another.
    :param Optional[int] id: The ID to use for this joint.
    :return: The joint ID.
    :rtype: int
    """
    pass

def create_gear_joint(joint_id1: int, joint_id2: int, ratio: float, id: int=0) -> int:
    """
    ...
    :param float ratio: The gear ratio to use in moving one joint from the other.
    :param Optional[int] id: The ID for the gear joint.
    :rtype: int
    """
    pass

def create_line_joint(sprite_id1: int, sprite_id2: int, anchor_x: float, anchor_y: float,
                      axis_x: float, axis_y: float, can_collide: Union[bool, int],
                      id: int=0) -> int:
    """
    ...
    :param int sprite_id1: The ID of the first sprite to join.
    :param int sprite_id2: The ID of the second sprite to join.
    :param float anchor_x: The x coordinate of the anchor point.
    :param float anchor_y: The y coordinate of the anchor point.
    :param float axis_x: The x component of the axis.
    :param float axis_y: The y component of the axis.
    :param Union[bool, int] can_collide: Set whether the two sprites connected by the joint can collide with one
        another.
    :param Optional[int] id: The ID to use for this joint.
    :rtype: int
...
def create_mouse_joint(sprite_id: int, anchor_x: float, anchor_y: float, max_force: float,
                       id: int=0) -> int:
    """
    ...
    :param float anchor_x: The x coordinate of the initial anchor point on the sprite.
    :param float anchor_y: The y coordinate of the initial anchor point on the sprite.
    :param float max_force: The maximum force the joint can use to move the sprite.
    :param Optional[int] id: The ID to use for this joint.
    :rtype: int
    """
    pass

def create_physics_force(x: float, y: float, power: float, limit: float, range: float,
                         fade: Union[bool, int]) -> int:
    """
    ...
    :param float x: The x position of the force location in world coordinates.
    :param float y: The y position of the force location in world coordinates.
    :param float power: The strength of the force at 1 unit from the force point for fading forces, or the strength at
        all times for non fading.
    :param float limit: Applies to fading forces only, the maximum force that will be applied to a sprite, used when the
        sprite is closer than 1 unit.
    :param float range: The range that this force can act, sprites greater than this distance from the force point feel
        no effects. less than 0 means infinite range.
...
def create_prismatic_joint(sprite_index1: int, sprite_index2: int, anchor_x: float, anchor_y: float,
                           axis_x: float, axis_y: float, can_collide: Union[bool, int],
                           id: int=0) -> int:
    """
    ...
    :param int sprite_index1: The ID of the first sprite to join.
    :param int sprite_index2: The ID of the second sprite to join.
    :param float anchor_x: The x coordinate of the anchor point.
    :param float anchor_y: The y coordinate of the anchor point.
    :param float axis_x: The x component of the axis.
    :param float axis_y: The y component of the axis.
...
def create_pulley_joint(joint_index: int, sprite_index1: int, sprite_index2: int, ground_x1: float,
                        ground_y1: float, ground2_x2: float, ground_y2: float, anchor_x1: float,
                        anchor1_y1: float, anchor_x2: float, anchor_y2: float, ratio: float,
    ...
    :param int joint_index: The ID to use for this joint.
    :param int sprite_index1: The ID of the first sprite to join.
    :param int sprite_index2: The ID of the second sprite to join.
    :param float ground_x1: The x coordinate of the ground point for sprite 1.
    :param float ground_y1: The y coordinate of the ground point for sprite 1.
    :param float ground2_x2: The x coordinate of the ground point for sprite 2.
    :param float ground_y2: The y coordinate of the ground point for sprite 2.
    :param float anchor_x1: The x coordinate of the anchor point for sprite 1.
    :param float anchor1_y1: The y coordinate of the anchor point for sprite 1.
    :param float anchor_x2: The x coordinate of the anchor point for sprite 2.
    :param float anchor_y2: The y coordinate of the anchor point for sprite 2.
    :param float ratio: The ratio between the two sides of the pulley.
    :param Union[bool, int] can_collide: Set whether the two sprites connected by the joint can collide with one
        another.
    :rtype: None
    """
...
def create_pulley_joint2(sprite_index1: int, sprite_index2: int, ratio: float,
                         can_collide: Union[bool, int]) -> None:
    """
    Creates a pulley joint between two sprites.
...
def create_revolute_joint(sprite_index1: int, sprite_index2: int, x: float, y: float,
                          can_collide: Union[bool, int], id: int=0) -> int:
    """
    ...
    :param int sprite_index1: The ID of the first sprite to join.
    :param int sprite_index2: The ID of the second sprite to join.
    :param float x: The x coordinate of the anchor point.
    :param float y: The y coordinate of the anchor point.
    :param Union[bool, int] can_collide: Set whether the two sprites connected by the joint can collide with one
        another.
    :param Optional[int] id: The ID to use for this joint.
    :rtype: int
...
def create_rope_joint(sprite_index1: int, sprite_index2: int, x1: float, y1: float, x2: float,
                      y2: float, max_length: float, can_collide: Union[bool, int],
                      id: int=0) -> int:
    """
    ...
    :param float x2: The x coordinate of the sprite 2 anchor point.
    :param float y2: The y coordinate of the sprite 2 anchor point.
    :param float max_length: The maximum length allowed between the sprite anchor points.
    :param Union[bool, int] can_collide: Set whether the two sprites connected by the joint can collide with one
        another.
    :param Optional[int] id: The ID to use for this joint.
    :rtype: int
...
def create_weld_joint(sprite_index1: int, sprite_index2: int, x: float, y: float,
                      can_collide: Union[bool, int], id: int=0) -> int:
    """
...
def delete_joint(id: int) -> None:
    ...
    :param int id: The ID of the joint to delete.
    :rtype: None
    """
    pass

def delete_physics_force(id: int) -> None:
    """
    Deletes the specified global force.

    :param int id: The ID of the force to delete.
    :rtype: None
    """
    pass

def finish_pulley_joint(ground_x1: float, ground_y1: float, ground_x2: float, ground_y2: float,
                        anchor_x1: float, anchor_y1: float, anchor_x2: float,
                        anchor_y2: float) -> int:
    """
    Creates a pulley joint between two sprites.
    ...
    :param float ground_x1: The x coordinate of the first ground point.
    :param float ground_y1: The y coordinate of the first ground point.
    :param float ground_x2: The x coordinate of the second ground point.
    :param float ground_y2: The y coordinate of the second ground point.
    :param float anchor_x1: The x coordinate of the first anchor point.
    :param float anchor_y1: The y coordinate of the first anchor point.
    :param float anchor_x2: The x coordinate of the second anchor point.
    :param float anchor_y2: The y coordinate of the second anchor point.
    :rtype: int
    """
    pass
...
def get_joint_exists(id: int) -> bool:
    """
    Returns True if the specified joint still exists, False otherwise.

    Joints can be deleted by the system.

    :param int id: The ID of the joint to check.
    :rtype: bool
    """
    pass

def get_joint_reaction_force_x(id: int) -> float:
    """
...
def get_joint_reaction_force_y(id: int) -> float:
    """
...
def get_joint_reaction_torque(id: int) -> float:
    """
...
def physics_ray_cast(x1: float, y1: float, x2: float, y2: float) -> bool:
    """
    ...
    :param float x1: The X coordinate of the start point in world coordinates.
    :param float y1: The Y coordinate of the start point in world coordinates.
    :param float x2: The X coordinate of the end point in world coordinates.
    :param float y2: The Y coordinate of the end point in world coordinates.
    :rtype: bool
    """
    pass

def physics_ray_cast_category(category: int, x1: float, y1: float, x2: float, y2: float) -> bool:
    """
    Casts a ray through all physics objects including sprites that have physics turned on and stores the closest item
    hit.
...
def physics_ray_cast_group(group: int, x1: float, y1: float, x2: float, y2: float) -> bool:
    """
    Casts a ray through all physics objects including sprites that have physics turned on and stores the closest item
    hit.
...
def set_joint_damping(id: int, damping: float, frequency: float) -> None:
    """
    ...
    :param int id: The ID of the joint to modify.
    :param float damping: The damping ratio to use, typically between 0 and 1.
    :param float frequency: The frequency of the oscillations, should be less than half the frame rate.
    :rtype: None
    """
    pass

def set_joint_limit_off(id: int) -> None:
    """
...
def set_joint_limit_on(id: int, minimum: float, maximum: float) -> None:
    """
    Works on Prismatic joints and Revolute joints.
    ...
    :param int id: The ID of the joint to modify.
    :param float minimum: The smallest extent that the joint can reach.
    :param float maximum: The greatest extent that the joint can reach.
    :rtype: None
    """
    pass

def set_joint_motor_off(id: int) -> None:
    """
...
def set_joint_motor_on(id: int, speed: float, max_force: float) -> None:
    """
    ...
    :param int id: The ID of the joint to modify.
    :param float speed: The desired speed of the motor.
    :param float max_force: The max force it can use to achieve the speed.
    :rtype: None
    """
    pass

def set_joint_mouse_max_force(id: int, max_force: float) -> None:
    """
    ...
    :param int id: The ID of the joint to modify.
    :param float max_force: The maximum force to allow.
    :rtype: None
    """
    pass

def set_joint_mouse_target(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the joint to modify.
    :param float x: The x coordinate of the new target.
    :param float y: The y coordinate of the new target.
    :rtype: None
    """
    pass
...
def set_physics_force_position(id: int, x: float, y: float) -> None:
    """
    Changes the position of the global force in world coordinates.

    :param int id: The ID of the force to modify.
    :param float x: The x component of the new position.
    :param float y: The y component of the new position.
    :rtype: None
    """
    pass

def set_physics_force_power(id: int, power: float) -> None:
    """
    ...
    :param int id: The ID of the force to modify.
    :param float power: The new strength of the force.
    :rtype: None
    """
    pass

def set_physics_force_range(id: int, range: float) -> None:
    """
    ...
    :param int id: The ID of the force to modify.
    :param float range: The new range of the force.
    :rtype: None
    """
    pass
...
def set_physics_gravity(x: float, y: float) -> None:
    ...
    :param float x: The X component of the gravity vector.
    :param float y: The Y component of the gravity vector.
    :rtype: None
    """
    pass
...
def set_physics_scale(scale: float) -> None:
    """
    ...
    :param float scale: The new scale value to use for all screen to physics values and vice versa.
    :rtype: None
    """
    pass
...
def sprite_ray_cast(x1: float, y1: float, x2: float, y2: float) -> bool:
    """
...
def sprite_ray_cast_category(category: int, x1: float, y1: float, x2: float, y2: float) -> bool:
    """
    Casts a ray through all sprites that have a shape (including physics sprites) and stores the result of any
    intersection.
...
def sprite_ray_cast_group(group: int, x1: float, y1: float, x2: float, y2: float) -> bool:
    """
    Casts a ray through all sprites that have a shape (including physics sprites) and stores the result of any
    intersection.
...
def sprite_ray_cast_single(sprite: int, x1: float, y1: float, x2: float, y2: float) -> bool:
    """
...
def clone_object(object_id: int, id: int=0) -> int:
    """
    ...
    :param int object_id: The ID of the object to copy.
    :param Optional[int] id: The ID of the new object.
    :rtype: int
    """
    pass

def create_object_box(width: float, height: float, length: float, id: int=0) -> int:
    """
    Creates a 3D box with the given width (X), height (Y), and length (Z).

    :param float width: The size of the object in the X direction.
    :param float height: The size of the object in the Y direction.
    :param float length: The size of the object in the Z direction.
    :param Optional[int] id: The ID to use for the new object.
    :rtype: int
    """
    pass

def create_object_capsule(diameter: float, height: float, axis: int, id: int=0) -> int:
    """
    Creates a Capsule primitive.

    :param float diameter: The diameter of the capsule.
...
def create_object_cone(height: float, diameter: float, segments: int, id: int=0) -> int:
    """
    ...
    for calculating the total number of polygons used in the cone is 2*segments.

    :param float height: The height of the cone.
    :param float diameter: The diameter of the base of the cone.
...
def create_object_cylinder(height: float, diameter: float, segments: int, id: int=0) -> int:
    """
    ...
    :param float diameter: The diameter of the base of the cylinder.
...
def create_object_from_height_map(image_filename: str, width: float, height: float, length: float,
                                  smoothing: int, split: int, id: int=0) -> int:
    """
    ...
    :param float width: The desired width of the new object in the X direction.
    :param float height: The desired height of the new object in the Y direction.
    :param float length: The desired length of the new object in the Z direction.
    ...
    :param Optional[int] id: The ID of the object to create.
    :rtype: int
    """
    pass

def create_object_from_object_mesh(object_id: int, mesh: int, id: int=0) -> int:
    """
    ...
    :param int object_id: The ID of the object that contains the mesh to copy.
...
def create_object_plane(width: float, height: float, id: int=0) -> int:
    """
...
def create_object_quad(id: int=0) -> int:
    """
...
def create_object_sphere(diameter: float, rows: int, columns: int, id: int=0) -> int:
    """
    ...
    :param float diameter: The diameter of the sphere.
...
def create_point_light(id: int, x: float, y: float, z: float, radius: float, red: int, green: int,
                       blue: int) -> None:
    """
    ...
    :param int id: The ID of the light to reference it in other commands.
    :param float x: The X component of the light position.
    :param float y: The Y component of the light position.
    :param float z: The Z component of the light position.
    :param float radius: The range that the light affects.
...
def delete_object(id: int) -> None:
    ...
    Note that if the object was loaded with `load_object_with_children()` then any child objects or animations that were
    created during that loading process will not be deleted by this command. You can use `get_object_child_id()` and
    `get_object_animation_name()` to get and delete those items manually, or use `delete_object_with_children()` to
    delete everything that was created when this object was loaded.
...
def delete_object_with_children(id: int) -> None:
    """
    Deletes the object at the given ID, if the object doesn't exist then this command does nothing.

    This command also deletes any child objects or animations that were created when this object was loaded, if you do
    not want to delete those then use `delete_object()` instead. If you use this command on an object that was loaded
    with `load_object()` then it deletes it as normal.
...
def delete_point_light(id: int) -> None:
    """
    Deletes the specified point light.

    If the point light doesn't exist this command does nothing.

    :param int id: The ID of the light to delete.
    :rtype: None
    """
    pass

def delete_shader(id: int) -> None:
    """
    ...
    :param int id: The ID of the shader to delete.
    :rtype: None
    """
    pass

def draw_object(id: int) -> None:
    """
    ...
    :param int id: The ID of the object to draw.
    :rtype: None
    """
    pass

def fix_object_pivot(id: int) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :rtype: None
    """
    pass

def fix_object_to_bone(id: int, to_object_id: int, to_bone_index: int) -> None:
    """
    Similar to `fix_object_to_object()` except the parent will be a bone in the other object.

    :param int id: The ID of the object to fix.
    :param int to_object_id: The ID of the object to fix it to.
    :param int to_bone_index: The index of the bone to fix it to.
    :rtype: None
    """
    pass

def fix_object_to_object(id: int, to_object_id: int) -> None:
    """
...
def get_3d_vector_x_from_screen(x: float, y: float) -> float:
    """
    ...
    :param float x: The X component of the screen position.
    :param float y: The Y component of the screen position.
    :rtype: float
    """
    pass

def get_3d_vector_y_from_screen(x: float, y: float) -> float:
    """
    Converts a 2D point on the screen into a vector pointing into the 3D world.
...
def get_3d_vector_z_from_screen(x: float, y: float) -> float:
    """
    Converts a 2D point on the screen into a vector pointing into the 3D world.
...
def get_camera_angle_x(id: int) -> float:
    """
    Returns the X component of the camera's current rotation converted to Euler angles.

    :param int id: The ID of the camera to check, the main camera is ID 1.
    :rtype: float
    """
    pass

def get_camera_angle_y(id: int) -> float:
    """
...
def get_camera_angle_z(id: int) -> float:
    """
...
def get_camera_fov(id: int) -> float:
    """
...
def get_camera_quat_w(id: int) -> float:
    """
...
def get_camera_quat_x(id: int) -> float:
    """
...
def get_camera_quat_y(id: int) -> float:
    """
...
def get_camera_quat_z(id: int) -> float:
    """
...
def get_object_angle_x(id: int) -> float:
    """
    Returns the X component of the object's current rotation converted to Euler angles.

    :param int id: The ID of the object to check.
    :rtype: float
    """
    pass

def get_object_angle_y(id: int) -> float:
    """
...
def get_object_angle_z(id: int) -> float:
    """
...
def get_object_animation_duration(id: int, name: str) -> float:
    """
...
def get_object_animation_name(id: int, index: int) -> str:
    """
...
def get_object_animation_time(id: int) -> float:
    """
...
def get_object_bone_angle_x(id: int, bone: int) -> float:
    """
    Returns the X component of the bone's current rotation converted to Euler angles.

    :param int id: The ID of the object that contains the bone to check.
    :param int bone: The index of the bone to check.
    :rtype: float
    """
    pass

def get_object_bone_angle_y(id: int, bone: int) -> float:
    """
...
def get_object_bone_angle_z(id: int, bone: int) -> float:
    """
...
def get_object_bone_by_name(id: int, name: str) -> int:
    """
...
def get_object_bone_name(id: int, bone: int) -> str:
    """
...
def get_object_bone_quat_w(id: int, bone: int) -> float:
    """
...
def get_object_bone_quat_x(id: int, bone: int) -> float:
    """
...
def get_object_bone_quat_y(id: int, bone: int) -> float:
    """
...
def get_object_bone_quat_z(id: int, bone: int) -> float:
    """
...
def get_object_bone_world_angle_x(id: int, bone: int) -> float:
    """
...
def get_object_bone_world_angle_y(id: int, bone: int) -> float:
    """
    Returns the Y component of the bone's current rotation converted to Euler angles.
...
def get_object_bone_world_angle_z(id: int, bone: int) -> float:
    """
    Returns the Z component of the bone's current rotation converted to Euler angles.
...
def get_object_bone_world_quat_w(id: int, bone: int) -> float:
    """
    Returns the W component of the bone's current rotation converted to a quaternion.
...
def get_object_bone_world_quat_x(id: int, bone: int) -> float:
    """
    Returns the X component of the bone's current rotation converted to a quaternion.
...
def get_object_bone_world_quat_y(id: int, bone: int) -> float:
    """
    Returns the Y component of the bone's current rotation converted to a quaternion.
...
def get_object_bone_world_quat_z(id: int, bone: int) -> float:
    """
    Returns the Z component of the bone's current rotation converted to a quaternion.
...
def get_object_bone_world_x(id: int, bone: int) -> float:
    """
...
def get_object_bone_world_y(id: int, bone: int) -> float:
    """
...
def get_object_bone_world_z(id: int, bone: int) -> float:
    """
...
def get_object_bone_x(id: int, bone: int) -> float:
    """
...
def get_object_bone_y(id: int, bone: int) -> float:
    """
...
def get_object_bone_z(id: int, bone: int) -> float:
    """
...
def get_object_cast_shadow_mode(id: int) -> bool:
    """
...
def get_object_child_id(id: int, child: int) -> int:
    """
    Returns the object ID for a specified child object that was loaded as a result of this object.

    To find the number of child objects use `get_object_num_children()`. childIndex is in the range 1 to the number of
...
def get_object_cull_mode(id: int) -> int:
    """
...
def get_object_depth_bias(id: int) -> float:
    """
...
def get_object_depth_read_mode(id: int) -> int:
    """
...
def get_object_depth_write(id: int) -> int:
    """
...
def get_object_exists(id: int) -> bool:
    """
...
def get_object_height_map_height(id: int, x: float, z: float) -> float:
    """
    ...
    :param int id: The ID of the object to check.
    :param float x: The X component of the position to check.
    :param float z: The Z component of the position to check.
    :rtype: float
    """
    pass

def get_object_in_screen(id: int) -> bool:
    """
...
def get_object_is_animating(id: int) -> bool:
    """
...
def get_object_is_tweening(id: int) -> bool:
    """
...
def get_object_mesh_name(id: int, mesh: int) -> str:
    """
...
def get_object_mesh_ps_source(id: int, mesh: int) -> str:
    """
...
def get_object_mesh_size_max_x(id: int, mesh: int) -> float:
    """
...
def get_object_mesh_size_max_y(id: int, mesh: int) -> float:
    """
...
def get_object_mesh_size_max_z(id: int, mesh: int) -> float:
    """
...
def get_object_mesh_size_min_x(id: int, mesh: int) -> float:
    """
...
def get_object_mesh_size_min_y(id: int, mesh: int) -> float:
    """
...
def get_object_mesh_size_min_z(id: int, mesh: int) -> float:
    """
...
def get_object_mesh_vs_source(id: int, mesh: int) -> str:
    """
...
def get_object_name(id: int) -> str:
    """
...
def get_object_num_animations(id: int) -> int:
    """
...
def get_object_num_bones(id: int) -> int:
    """
...
def get_object_num_children(id: int) -> int:
    """
...
def get_object_num_meshes(id: int) -> int:
    """
...
def get_object_quat_w(id: int) -> float:
    """
...
def get_object_quat_x(id: int) -> float:
    """
...
def get_object_quat_y(id: int) -> float:
    """
...
def get_object_quat_z(id: int) -> float:
    """
...
def get_object_receive_shadow_mode(id: int) -> bool:
    """
...
def get_object_size_max_x(id: int) -> float:
    """
...
def get_object_size_max_y(id: int) -> float:
    """
...
def get_object_size_max_z(id: int) -> float:
    """
...
def get_object_size_min_x(id: int) -> float:
    """
...
def get_object_size_min_y(id: int) -> float:
    """
...
def get_object_size_min_z(id: int) -> float:
    """
...
def get_object_transparency(id: int) -> int:
    """
...
def get_object_visible(id: int) -> bool:
    """
...
def get_object_world_angle_x(id: int) -> float:
    """
...
def get_object_world_angle_y(id: int) -> float:
    """
...
def get_object_world_angle_z(id: int) -> float:
    """
...
def get_object_world_quat_w(id: int) -> float:
    """
...
def get_object_world_quat_x(id: int) -> float:
    """
...
def get_object_world_quat_y(id: int) -> float:
    """
...
def get_object_world_quat_z(id: int) -> float:
    """
...
def get_object_world_x(id: int) -> float:
    """
...
def get_object_world_y(id: int) -> float:
    """
...
def get_object_world_z(id: int) -> float:
    """
...
def get_point_light_exists(id: int) -> bool:
    """
    returns True if the specified point light exists, False otherwise.

    :param int id: The ID of the light to check.
    :rtype: bool
    """
    pass

def get_screen_x_from_3d(x: float, y: float, z: float) -> float:
    """
    Converts a 3D point into screen coordinates.

    :param float x: The X component of the 3D point.
    :param float y: The Y component of the 3D point.
    :param float z: The Z component of the 3D point.
    :rtype: float
    """
    pass

def get_screen_y_from_3d(x: float, y: float, z: float) -> float:
    """
    Converts a 3D point into screen coordinates.
...
def instance_object(object_id: int, id: int=0) -> int:
    """
...
def load_full_screen_shader(filename: str, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: An ID used to reference this shader in other commands.
    :rtype: int
    """
    pass

def load_object(filename: str, height: Optional[float]=None, id: int=0) -> int:
    """
    ...
    :param Optional[float] height: Scale the loaded object to this height.
    :param Optional[int] id: The ID to use for the new object.
    :rtype: int
    """
    pass

def load_object_with_children(filename: str, id: int=0) -> int:
    """
    Loads an object from a file, currently supported formats are .X .3ds .md3 .smd .md5 .lwo .ac .b3d .dae .3d .lws
    .ms3d .blend .m3 .obj and .ago.

    If the model file contains a bone hierarchy or animation data then this will also be loaded and associated with the
    object. If the model file contains a scene graph containing multiple objects then these will also be loaded and
    stored in separate objects which can be discovered with `get_object_num_children()`. If you just want to load a
    single object without any bones, animation, or children then use `load_object()` instead.
...
def load_shader(vertex_filename: str, pixel_filename: str, id: int=0) -> int:
    """
    ...
    added and should not be included in the shader source. Returns an ID that can be used to reference this shader in
    other commands.
...
def load_shader_from_string(vertex_source: str, pixel_source: str, id: int=0) -> int:
    """
    Loads a shader used for drawing objects.
...
def load_sprite_shader(filename: str, id: int=0) -> int:
    """
...
def move_camera_local_x(id: int, distance: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float distance: The distance to move in the local X direction, can be negative.
    :rtype: None
    """
    pass

def move_camera_local_y(id: int, distance: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float distance: The distance to move in the local Y direction, can be negative.
    :rtype: None
    """
    pass

def move_camera_local_z(id: int, distance: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float distance: The distance to move in the local Z direction, can be negative.
    :rtype: None
    """
    pass

def move_object_local_x(id: int, distance: float) -> None:
    """
...
def move_object_local_y(id: int, distance: float) -> None:
    """
...
def move_object_local_z(id: int, distance: float) -> None:
    """
...
def object_ray_cast(id: int, start_x: float, start_y: float, start_z: float, end_x: float,
                    end_y: float, end_z: float) -> int:
    """
    ...
    :param int id: The ID of the object to check, 0 for all objects.
...
def object_sphere_cast(id: int, start_x: float, start_y: float, start_z: float, end_x: float,
                       end_y: float, end_z: float, radius: float) -> int:
    """
    Will check if the ray starting at start_x,start_y,start_z and ending at end_x,end_y,end_z, and of width radius,
    collides with the specified object (objID=0 for all).

    Does not collide with backfaces, will return the number of the object hit first, or 0 for no collision. Sphere
    casting commands add a width dimension to normal ray casting which can be used to check if a player has hit anything
    during movement and to position them at the collision point to provide 'sticky' collision, where the player stops if
    they hit anything. The alternative is sliding collision. see `object_sphere_slide()`.
...
def object_sphere_slide(id: int, start_x: float, start_y: float, start_z: float, end_x: float,
                        end_y: float, end_z: float, radius: float) -> int:
    """
...
def play_object_animation(id: int, name: str, start_time: float, end_time: float, loop: int,
                          tween_time: float) -> None:
    """
    ...
    and end time must be exactly the same, as there will be no interpolation between them when it loops. The tween_time
    parameter can be used to interpolate between the current bone positions and the start time of the animation so that
    there is no sudden jump in bone positions. This tweening only happens once, it does not happen every loop, and does
    not contribute to the animation time. Essentially the animation is paused until tweening has finished. Note that as
    soon as this command is called the bones will be controlled by animation and cannot be moved with
    `set_object_bone_position()` or similar commands. You can regain manual control of individual bones by using
    ...
    :param float start_time: The point in the animation at which the object should start playing, in seconds.
    :param float end_time: The point in the animation at which the object should stop playing, -1 to continue to the
        end.
    :param int loop: 1 to loop the animation forever, 0 to play once, any other positive integer to loop that many
        times.
    :param float tween_time: The time in seconds to transition from the objects current state to the first frame of
        animation.
    :rtype: None
    """
    pass

def reset_object_animation(id: int) -> None:
    """
...
def rotate_camera_global_x(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float angle: The angle to rotate on the global X axis in degrees, positive pitches down, negative pitches up.
    :rtype: None
    """
    pass

def rotate_camera_global_y(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float angle: The angle to rotate on the global Y axis in degrees, positive turns right, negative turns left.
    :rtype: None
    """
    pass

def rotate_camera_global_z(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float angle: The angle to rotate on the global Z axis in degrees, negative is clockwise.
    :rtype: None
    """
    pass

def rotate_camera_local_x(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float angle: The angle to rotate on the local X axis in degrees, positive looks down, negative looks up.
    :rtype: None
    """
    pass

def rotate_camera_local_y(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float angle: The angle to rotate on the local Y axis in degrees, positive turns right, negative turns left.
    :rtype: None
    """
    pass

def rotate_camera_local_z(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float angle: The angle to rotate on the local Z axis in degrees, negative is clockwise.
    :rtype: None
    """
    pass

def rotate_object_bone_local_x(id: int, bone: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the object that contains the bone.
...
def rotate_object_bone_local_y(id: int, bone: int, angle: float) -> None:
    """
...
def rotate_object_bone_local_z(id: int, bone: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the object that contains the bone.
    :param int bone: The index of the bone to modify.
    :param float angle: The angle to rotate on the local Z axis in degrees, positive rolls anti-clockwise, negative
        rolls clockwise.
    :rtype: None
    """
    pass

def rotate_object_global_x(id: int, angle: float) -> None:
    """
...
def rotate_object_global_y(id: int, angle: float) -> None:
    """
...
def rotate_object_global_z(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param float angle: The angle to rotate on the global Z axis in degrees, positive rolls anti-clockwise, negative
        rolls clockwise.
    :rtype: None
    """
    pass

def rotate_object_local_x(id: int, angle: float) -> None:
    """
...
def rotate_object_local_y(id: int, angle: float) -> None:
    """
...
def rotate_object_local_z(id: int, angle: float) -> None:
    """
...
'''*EXCLUDED*
def save_object(id: int, filename: str) -> None:
    """
    Not yet functional.

    :param int id: The ID of the object to save.
    :param str filename: The file name to use for the new file.
    :rtype: None
    """
    pass
'''
...
def set_camera_aspect(id: int, aspect: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float aspect: The new aspect ratio to use.
    :rtype: None
    """
    pass

def set_camera_bounds(id: int, left: float, right: float, top: float, bottom: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float left: The left component of the projection matrix.
    :param float right: The left component of the projection matrix.
    :param float top: The left component of the projection matrix.
    :param float bottom: The left component of the projection matrix.
    :rtype: None
    """
    pass

def set_camera_fov(id: int, fov: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float fov: The field of view in degrees.
    :rtype: None
    """
    pass

def set_camera_look_at(id: int, x: float, y: float, z: float, roll: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float x: The X component of the position to look at.
    :param float y: The Y component of the position to look at.
    :param float z: The Z component of the position to look at.
    :param float roll: The Z angle to roll the camera when looking at the given position, negative is clockwise.
    :rtype: None
    """
    pass

def set_camera_off_center(id: int, active: Union[bool, int]) -> None:
    """
...
def set_camera_ortho_width(id: int, width: float) -> None:
    """
    ...
    value, a cube of size 40 units would always fill the camera view when the camera is looking at it. This command will
    overwrite any values set with `set_camera_bounds()`.

    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float width: The width of the view in world coordinates.
    :rtype: None
    """
    pass

def set_camera_position(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float x: The X component of the position.
    :param float y: The Y component of the position.
    :param float z: The Z component of the position.
    :rtype: None
    """
    pass

def set_camera_range(id: int, near: float, far: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float near: The nearest that an object will be rendered.
    :param float far: The furthest that an object will be rendered.
    :rtype: None
    """
    pass

def set_camera_rotation(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float x: The X component of the euler rotation.
    :param float y: The Y component of the euler rotation.
    :param float z: The Z component of the euler rotation.
    :rtype: None
    """
    pass

def set_camera_rotation_quat(id: int, w: float, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the camera to modify, the main camera is ID 1.
    :param float w: The W component of the quaternion.
    :param float x: The X component of the quaternion.
    :param float y: The Y component of the quaternion.
    :param float z: The Z component of the quaternion.
    :rtype: None
    """
    pass
...
def set_fog_range(minimum: float, maximum: float) -> None:
    """
    ...
    :param float minimum: The minimum distance for the fog, no fog will affect pixels within this distance from the
        camera.
    :param float maximum: The maximum distance for the fog, the fog will reach full intensity around this distance.
    :rtype: None
    """
    pass
...
def set_object_alpha_mask(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_animation_frame(id: int, name: str, time: float, tween_time: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param str name: The name of the animation to play, defined by the modelling program.
    :param float time: The point in the animation to read the bone positions, in seconds.
    :param float tween_time: The time in seconds to transition from the objects current state to the given frame.
    :rtype: None
    """
    pass

def set_object_animation_speed(id: int, speed: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param float speed: The new animation speed to use for this object, default 1.0.
    :rtype: None
    """
    pass

def set_object_blend_modes(id: int, src: int, dst: int) -> None:
    """
...
def set_object_bone_can_animate(id: int, bone: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_bone_look_at(id: int, bone: int, x: float, y: float, z: float, roll: float) -> None:
    """
    ...
    :param float y: The Y component of the position to look at.
    :param float z: The Z component of the position to look at.
    :param float roll: The Z angle to roll the bone when looking at the given position, negative is clockwise.
    :rtype: None
    """
    pass

def set_object_bone_position(id: int, bone: int, x: float, y: float, z: float) -> None:
    """
...
def set_object_bone_rotation(id: int, bone: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the object that contains the bone.
    :param int bone: The index of the bone to modify.
    :param float x: The X component of the rotation.
    :param float y: The Y component of the rotation.
    :param float z: The Z component of the rotation.
    :rtype: None
    """
    pass

def set_object_bone_rotation_quat(id: int, bone: int, w: float, x: float, y: float,
                                  z: float) -> None:
    """
    ...
    :param int id: The ID of the object that contains the bone.
    :param int bone: The index of the bone to modify.
    :param float w: The W component of the rotation.
    :param float x: The X component of the rotation.
    :param float y: The Y component of the rotation.
    :param float z: The Z component of the rotation.
    :rtype: None
...
def set_object_cast_shadow(id: int, enabled: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the object to cast shadows.
    :param Union[bool, int] enabled: True to make this object cast shadows, False to stop it casting shadows.
    :rtype: None
    """
    pass

def set_object_collision_mode(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_color(id: int, red: int, green: int, blue: int, alpha: int) -> None:
    """
...
def set_object_color_emissive(id: int, red: int, green: int, blue: int) -> None:
    """
...
def set_object_cull_mode(id: int, cull: int) -> None:
    """
...
def set_object_depth_bias(id: int, bias: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param float bias: The bias amount, 0 to turn depth biasing off for this object.
    :rtype: None
    """
    pass

def set_object_depth_range(id: int, near: float, far: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param float near: The start of the depth range for this object.
    :param float far: The end of the depth range for this object.
    :rtype: None
    """
    pass

def set_object_depth_read_mode(id: int, mode: int) -> None:
    """
...
def set_object_depth_write(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_fog_mode(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_image(id: int, image_id: int, stage: int) -> None:
    """
...
def set_object_light_map(id: int, image_id: int) -> None:
    """
...
def set_object_light_mode(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_look_at(id: int, x: float, y: float, z: float, roll: float) -> None:
    """
    ...
    :param float y: The Y component of the position to look at.
    :param float z: The Z component of the position to look at.
    :param float roll: The Z angle to roll the object when looking at the given position, negative is clockwise.
    :rtype: None
    """
    pass

def set_object_mesh_image(id: int, mesh: int, image_id: int, stage: int) -> None:
    """
...
def set_object_mesh_light_map(id: int, mesh: int, image_id: int) -> None:
    """
...
def set_object_mesh_normal_map(id: int, mesh: int, image_id: int) -> None:
    """
...
def set_object_mesh_normal_map_scale(id: int, mesh: int, u: float, v: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param int mesh: The index of the mesh to modify, first mesh is at index 1.
    :param float u: The amount to scale the normal map in the U direction.
    :param float v: The amount to scale the normal map in the V direction.
    :rtype: None
    """
    pass

def set_object_mesh_shader(id: int, mesh: int, shader_id: int) -> None:
    """
...
def set_object_mesh_uv_offset(id: int, mesh: int, stage: int, u: float, v: float) -> None:
    """
    ...
    :param float u: The offset to use in the U direction, the default is 0.
    :param float v: The offset to use in the V direction, the default is 0.
    :rtype: None
    """
    pass

def set_object_mesh_uv_scale(id: int, mesh: int, stage: int, u: float, v: float) -> None:
    """
    ...
    :param int mesh: The index of the mesh to modify.
    :param int stage: The texture stage of the UVs to modify, in the range 0 to 7.
    :param float u: The offset to use in the U direction, the default is 1.
    :param float v: The offset to use in the V direction, the default is 1.
    :rtype: None
    """
    pass

def set_object_normal_map(id: int, image_id: int) -> None:
    """
...
def set_object_normal_map_scale(id: int, u: float, v: float) -> None:
    """
    Scales the normal map UV coordinates by the specified amount.
...
def set_object_position(id: int, x: float, y: float, z: float) -> None:
    """
...
def set_object_receive_shadow(id: int, enabled: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the object to receive shadows.
    :param Union[bool, int] enabled: True to make this object receive shadows, False to stop it receiving shadows.
    :rtype: None
    """
    pass

def set_object_rotation(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    used at the same time. For example setting an Euler angle rotation will generate a quaternion representation that
    can be retrieved with `get_object_quat_x()`, etc.
...
def set_object_rotation_quat(id: int, w: float, x: float, y: float, z: float) -> None:
    """
    ...
    quaternion rotation will generate Euler representation that can be retrieved with `get_object_angle_x, etc.
...
def set_object_scale(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param float x: The amount to scale the object on the X axis.
    :param float y: The amount to scale the object on the Y axis.
    :param float z: The amount to scale the object on the Z axis.
    :rtype: None
    """
    pass

def set_object_scale_permanent(id: int, x: float, y: float, z: float) -> None:
    """
    Modifies the object size in the X, Y, and Z directions.
...
def set_object_screen_culling(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_shader(id: int, shader_id: int) -> None:
    """
...
def set_object_shader_constant_array_by_name(id: int, name: str, index: int, value1: float,
                                             value2: float, value3: float, value4: float) -> None:
    """
    ...
    :param float value1: The X or R component of the new value, this value will always be used.
    :param float value2: The Y or G component of the new value, if the constant only uses 1 component this value is
        discarded.
    :param float value3: The Z or B component of the new value, if the constant only uses 2 components this value is
        discarded.
    :param float value4: The W or A component of the new value, if the constant only uses 3 components this value is
        discarded.
    :rtype: None
    """
    pass

def set_object_shader_constant_by_name(id: int, name: str, value1: float, value2: float,
    ...
    :param int id: The ID of the shader to modify.
    :param str name: The name of the constant to change, as defined in the shader source file.
    :param float value1: The X or R component of the new value, this value will always be used.
    :param float value2: The Y or G component of the new value, if the constant only uses 1 component this value is
        discarded.
...
def set_object_shader_constant_default(id: int, name: str) -> None:
    """
...
def set_object_transparency(id: int, mode: int) -> None:
    """
...
def set_object_uv_offset(id: int, stage: int, u: float, v: float) -> None:
    """
...
def set_object_uv_scale(id: int, stage: int, u: float, v: float) -> None:
    """
    ...
    :param int id: The ID of the object to modify.
    :param int stage: The texture stage of the UVs to modify, in the range 0 to 7.
    :param float u: The scale to use in the U direction, the default is 1.
    :param float v: The scale to use in the V direction, the default is 1.
    :rtype: None
    """
    pass

def set_object_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def set_point_light_color(id: int, red: int, green: int, blue: int) -> None:
    """
    ...
    :param int id: The ID of the light to modify.
    :param int red: The red component of the light color.
    :param int green: The green component of the light color.
    :param int blue: The blue component of the light color.
    :rtype: None
...
def set_point_light_mode(id: int, mode: int) -> None:
    """
...
def set_point_light_position(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param float x: The X component of the new position.
    :param float y: The Y component of the new position.
    :param float z: The Z component of the new position.
    :rtype: None
    """
    pass

def set_point_light_radius(id: int, radius: float) -> None:
    """
    ...
    :param int id: The ID of the light to modify.
    :param float radius: The distance that the light can affect.
    :rtype: None
    """
    pass

def set_shader_constant_array_by_name(id: int, name: str, index: int, value1: float, value2: float,
                                      value3: float, value4: float) -> None:
    """
    Sets a shader constant array index by name, the constant must be marked as "uniform" in the shader source.
...
def set_shader_constant_by_name(id: int, name: str, value1: float, value2: float, value3: float,
                                value4: float) -> None:
    """
...
def set_shadow_bias(bias: float) -> None:
    """
    ...
    :param float bias: The distance to shift shadows.
    :rtype: None
    """
    pass

def set_shadow_light_step_size(step: float) -> None:
    """
    ...
    :param float step: The light angle step size in degrees.
    :rtype: None
    """
    pass
...
def set_shadow_mapping_mode(mode: int) -> None:
    ...
    (SHADOW_MAP_LIPSM) uses Light Space Perspective shadow mapping (LiPSM) which has higher quality in most cases but if
    the camera is looking in the same direction as the light then it is no better than Uniform shadow mapping. Light
    ...
    Note that when using modes 1 (SHADOW_MAP_UNIFORM) and 2 (SHADOW_MAP_LIPSM), texture stage 7 on all objects receiving
    shadow is reserved for the shadow map. When using shadow mode 3 (SHADOW_MAP_CASCADE) then texture stages 4, 5, 6,
    and 7 are reserved for the shadow maps.

    :param int mode: 0 (SHADOW_MAP_NONE) to turn it off, 1 (SHADOW_MAP_UNIFORM) to use Uniform shadows, 2
        (SHADOW_MAP_LIPSM) to use LiPSM shadows, 3 (SHADOW_MAP_CASCADE) to use Cascade shadows.
    :rtype: None
    """
    pass
...
def set_shadow_range(range: float) -> None:
    """
    ...
    :param float range: The distance to stop drawing shadows, -1 to use the camera far range instead.
    :rtype: None
    """
    pass
...
def set_sky_box_horizon_size(size: float, height: float) -> None:
    """
    ...
    :param float size: The size of the horizon above the horizon height.
    :param float height: The height that the horizon starts.
    :rtype: None
    """
    pass
...
def set_sky_box_sun_size(sun: float, halo: float) -> None:
    """
    ...
    :param float sun: The size of the sun.
    :param float halo: The size of the halo around the sun.
    :rtype: None
    """
    pass
...
def set_sprite_shader(id: int, shader_id: int) -> None:
    """
...
def set_sun_direction(x: float, y: float, z: float) -> None:
    """
    Sets the direction for the global directional light to shine.

    :param float x: The X component of the new direction.
    :param float y: The Y component of the new direction.
    :param float z: The Z component of the new direction.
    :rtype: None
    """
    pass

def stop_object_animation(id: int) -> None:
    """
...
def add_3d_particles_color_key_frame(id: int, time: float, red: int, green: int, blue: int,
                                     alpha: int) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float time: The time that particles should become this color.
    :param int red: The red component of the new color.
    :param int green: The green component of the new color.
    :param int blue: The blue component of the new color.
...
def add_3d_particles_force(id: int, start_time: float, end_time: float, x: float, y: float,
                           z: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float start_time: The time in a particle's life at which this force should start having an effect.
    :param float end_time: The time in a particle's life at which this force should stop having an effect.
    :param float x: The x component of the force's influence on a particle's speed in units per second.
    :param float y: The y component of the force's influence on a particle's speed in units per second.
    :param float z: The z component of the force's influence on a particle's speed in units per second.
    :rtype: None
    """
    pass

def add_3d_particles_scale_key_frame(id: int, time: float, scale: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float time: The time that particles should become this size.
    :param float scale: The scale relative to the normal particle size, must be greater then or equal to 0.
    :rtype: None
    """
    pass

def clear_3d_particles_colors(id: int) -> None:
    """
...
def clear_3d_particles_forces(id: int) -> None:
    """
...
def clear_3d_particles_scales(id: int) -> None:
    """
...
def create_3d_particles(x: float, y: float, z: float, id: int=0) -> int:
    """
    ...
    :param float x: The x coordinate to position this emitter.
    :param float y: The y coordinate to position this emitter.
    :param float z: The z coordinate to position this emitter.
    :param Optional[int] id: The ID to use when referencing this 3D particle emitter.
    :rtype: int
    """
    pass

def delete_3d_particles(id: int) -> None:
    """
    Deletes a 3D particle emitter and all its particles.

    If any particles were currently visible they will disappear instantly.

    :param int id: The ID of the emitter to delete.
    :rtype: None
    """
    pass

def get_3d_particles_active(id: int) -> bool:
    """
    ...
    :param int id: The ID of the emitter to check.
    :rtype: bool
    """
    pass

def get_3d_particles_direction_range1(id: int) -> float:
    """
...
def get_3d_particles_direction_range2(id: int) -> float:
    """
...
def get_3d_particles_direction_x(id: int) -> float:
    """
...
def get_3d_particles_direction_y(id: int) -> float:
    """
...
def get_3d_particles_direction_z(id: int) -> float:
    """
...
def get_3d_particles_exists(id: int) -> bool:
    """
...
def get_3d_particles_frequency(id: int) -> float:
    """
...
def get_3d_particles_life(id: int) -> float:
    """
...
def get_3d_particles_max_reached(id: int) -> bool:
    """
...
def get_3d_particles_size(id: int) -> float:
    """
...
def get_3d_particles_visible(id: int) -> bool:
    """
...
def get_3d_particles_x(id: int) -> float:
    """
...
def get_3d_particles_y(id: int) -> float:
    """
...
def get_3d_particles_z(id: int) -> float:
    """
...
def offset_3d_particles(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float x: The distance to move the particles in the X direction.
    :param float y: The distance to move the particles in the Y direction.
    :param float z: The distance to move the particles in the Z direction.
    :rtype: None
    """
    pass

def reset_3d_particle_count(id: int) -> None:
    """
...
def set_3d_particles_active(id: int, active: Union[bool, int]) -> None:
    """
...
def set_3d_particles_color_interpolation(id: int, mode: int) -> None:
    """
...
def set_3d_particles_direction(id: int, vx: float, vy: float, vz: float, roll: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float vx: The x direction that particles will move initially.
    :param float vy: The y direction that particles will move initially.
    :param float vz: The z direction that particles will move initially.
    :param float roll: The angle to turn the emitter as it is facing in the given direction.
    :rtype: None
    """
    pass

def set_3d_particles_direction_range(id: int, angle1: float, angle2: float) -> None:
    """
    ...
    and angle/2 degrees in one direction and angle2/2 degrees in the perpendicular direction. For example an angle1 of 0
    and an angle2 of 0 would mean that all new particles follow exactly the direction specified earlier. An angle1 of
    360 and an angle2 of 0 would mean that particles could appear travelling in any direction in a flat circle, whilst
    an angle1 of 360 and an angle2 of 180 would mean that particles would travel in any direction in a sphere. The
    angles form a pyramid aligned with the particle emitter direction specified earlier. Angle1 must be between 0 and
    360, angle2 must be between 0 and 180.

    :param int id: The ID of the emitter to modify.
    :param float angle1: The range of variation a particle can choose from the emitter direction.
    :param float angle2: The perpendicular range of variation a particle can choose from the emitter direction.
    :rtype: None
    """
    pass

def set_3d_particles_frequency(id: int, freq: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float freq: The rate of new particle production in particles per second.
    :rtype: None
    """
    pass
...
def set_3d_particles_life(id: int, time: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float time: The time in seconds that a particle is visible.
    :rtype: None
    """
    pass

def set_3d_particles_max(id: int, maximum: int) -> None:
    """
...
def set_3d_particles_position(id: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float x: The new x coordinate for the emitter in world coordinates.
    :param float y: The new y coordinate for the emitter in world coordinates.
    :param float z: The new z coordinate for the emitter in world coordinates.
    :rtype: None
    """
    pass

def set_3d_particles_size(id: int, size: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float size: Size of the particles.
    :rtype: None
    """
    pass

def set_3d_particles_start_zone(id: int, x1: float, y1: float, z1: float, x2: float, y2: float,
                                z2: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float x1: The x coordinate of the top left corner of the start zone.
    :param float y1: The y coordinate of the top left corner of the start zone.
    :param float z1: The z coordinate of the top left corner of the start zone.
    :param float x2: The x coordinate of the bottom right corner of the start zone.
    :param float y2: The y coordinate of the bottom right corner of the start zone.
    :param float z2: The z coordinate of the bottom right corner of the start zone.
    :rtype: None
    """
    pass

def set_3d_particles_transparency(id: int, mode: int) -> None:
    """
    ...
    :param int id: The ID of the particle emitter to modify.
...
def set_3d_particles_velocity_range(id: int, v1: float, v2: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to modify.
    :param float v1: The minimum velocity multiplier.
    :param float v2: The maximum velocity multiplier.
    :rtype: None
    """
    pass

def set_3d_particles_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def update_3d_particles(id: int, time: float) -> None:
    """
    ...
    :param int id: The ID of the emitter to check.
    :param float time: The time in seconds to advance the emitter.
    :rtype: None
    """
    pass

def add_3d_physics_ragdoll_bone(start_bone_id: int, end_bone_id: int, diameter: float,
    ...
    :param int start_bone_id: Start ojects bone ID.
    :param int end_bone_id: End objects bone ID.
    :param float diameter: Size of the capsule that will be the ragdoll bone.
...
def add_3d_physics_ragdoll_hinge_joint(ragdoll_bone_id1: int, ragdoll_bone_id2: int,
                                       object_bone_id: int, rotation_vector: int, minimum: float,
                                       maximum: float) -> None:
    """
    Creates a physics hing joint between ragdoll bone A and B at the location of the objects bone.

    :param int ragdoll_bone_id1: ID of the Ragdoll bone returned from `add_3d_physics_ragdoll_bone()`.
    :param int ragdoll_bone_id2: ID of the Ragdoll bone returned from `add_3d_physics_ragdoll_bone()`.
    :param int object_bone_id: ID of the bone in the object which will be the location of the ragdoll joint.
    :param int rotation_vector: ID of the vector with the rotation of the joint.
    :param float minimum: Float value in angular degrees.
    :param float maximum: Float value in angular degrees.
    :rtype: None
    """
    pass

def add_3d_physics_ragdoll_twist_joint(ragdoll_bone_id1: int, ragdoll_bone_id2: int,
                                       object_bone_id: int, rotation_vector: int,
                                       limits_vector: int) -> None:
    """
    ...
    :param int object_bone_id: ID of the bone in the object which will be the location of the ragdoll joint.
    :param int rotation_vector: ID of the vector with the rotation of the joint.
    :param int limits_vector: ID of the vector with the joint limits.
    :rtype: None
    """
    pass

def add_object_shape_box(id: int, position_vector: int, rotation_vector: int,
                         size_vector: int) -> None:
    """
    ...
    :param int position_vector: The vector ID of the vector with the world position for the center of the shape.
    :param int rotation_vector: The vector ID of the vector with the world rotation of the shape.
    :param int size_vector: The vector ID of the vector with the size of the shape.
    :rtype: None
    """
    pass

def add_object_shape_capsule(id: int, position_vector: int, rotation_vector: int, size_vector: int,
                             axis: int) -> None:
    """
...
def add_object_shape_cone(id: int, position_vector: int, rotation_vector: int, size_vector: int,
                          axis: int) -> None:
    """
...
def add_object_shape_cylinder(id: int, position_vector: int, rotation_vector: int, size_vector: int,
                              axis: int) -> None:
    """
...
def add_object_shape_sphere(id: int, position_vector: int, diameter: float) -> None:
    """
    ...
    :param int id: Object ID.
    :param int position_vector: The vector ID of the vector with the world position for the center of the shape.
    :param float diameter: Size of sphere shape.
    :rtype: None
    """
    pass

def assign_to_3d_physics_ragdoll_bone_object_bone(ragdoll_bone_id: int,
                                                  object_bone_id: int) -> None:
    """
    ...
    :param int ragdoll_bone_id: ID of ragdoll bone.
    :param int object_bone_id: ID of objects bone to be controlled by the ragdoll bone.
    :rtype: None
    """
    pass

def create_3d_physics_6d_of_joint(object_id1: int, object_id2: int, position_vector: int,
                                  rotation_vector: float) -> int:
    """
    ...
    :param int position_vector: Vector ID.
    :param float rotation_vector: Vector ID.
    :rtype: int
    """
    pass

def create_3d_physics_character_controller(id: int, axis: int, offset_vector: int,
                                           orientation_vector: int, crouch_scale: float) -> None:
    """
    Creates a 3D physics Character Controller for the model.

    Character controller can be created on the X,Y or Z axis. For example a standing character would be on the Y axis. A
    lying down character could be on the X or Z. If the model has an offset from origin the `offset_vector()` is needed
    to line up the character controller with the object. If the object does not face down the positive Z axis use the
    `orientation_vector()` to adjust. Crouch scale adjusts the crouch capsule size to fit the height of your crouched
    model.

    :param int id: Object ID.
    :param int axis: 0 (AXIS_X)= X axis, 1 (AXIS_Y)= Y axis, 2 (AXIS_Z)= Z axis.
    :param int offset_vector: This vector is the half the amount that the model is off set from origin.
    :param int orientation_vector: This vector is used to line up the rotation your model with the character controller.
    :param float crouch_scale: Percentage amount to scale the crouched capsule to fit crouched model.
    :rtype: None
    """
    pass

def create_3d_physics_cone_twist_joint(object_id1: int, object_id2: int, position_vector: int,
                                       rotation_vector: int, disable_collisions: Union[bool,
                                       int]) -> int:
    """
    Creates a Cone Twist joint between object a and b.

    The `rotation_vector()` parameter should be an axis in the form (0,1,0) for vertical, (1,0,0) for horizontal along
    ...
    :param int object_id2: Second object ID.
    :param int position_vector: Vector ID.
    :param int rotation_vector: Vector ID.
...
def create_3d_physics_dynamic_body(id: int) -> None:
    """
...
def create_3d_physics_fixed_joint(object_id1: int, object_id2: int, position_vector: int) -> int:
    """
    ...
    :param int object_id1: First object ID.
    :param int object_id2: Second object ID.
    :param int position_vector: Bector ID.
    :rtype: int
    """
    pass

def create_3d_physics_hinge_joint(object_id1: int, object_id2: int, position_vector: int,
                                  rotation_vector: int, disable_collisions: Union[bool,
                                  int]) -> int:
    """
...
def create_3d_physics_kinematic_body(id: int) -> None:
    """
...
def create_3d_physics_pick_joint(id: int, position_vector: int) -> int:
    """
    Returns Joint ID.

    :param int id: Object ID.
    :param int position_vector: ID of the position Vector.
    :rtype: int
    """
    pass

def create_3d_physics_ragdoll(id: int, weight: float) -> None:
    """
    ...
    :param int id: Object ID.
    :param float weight: Total weight in lbs. This weight gets divided up among the ragdoll bones based on volume of the
        bones.
    :rtype: None
    """
    pass
...
def create_3d_physics_slider_joint(object_id1: int, object_id2: int, position_vector: int,
                                   rotation_vector: int) -> int:
    """
...
def create_3d_physics_static_body(id: int) -> None:
    """
...
def create_3d_physics_static_plane(x: float, y: float, z: float, offset: float) -> int:
    """
    Creates a static plane.

    Returns a static Plane ID.

    :param float x: X value of the normal vector.
    :param float y: Y value of the normal vector.
    :param float z: Z value of the  normal vector.
    :param float offset: How much the plane will be offset from its world position.
    :rtype: int
    """
    pass

def create_3d_physics_world(scale: Optional[float]=None) -> None:
    """
    You must create the the Physics world before calling any other physics commands.

    `create_3d_physics_world()` creates the physics world using the default scale factor of 40. This function will
    create the physics world with a different scale factor. The scale is not the size of the world, it is the factor by
    which all the data passed in is scaled down by to convert it to the Bullet Physics scale for the physics
    ...
    :param Optional[float] scale: The default scale factor is 40.
    :rtype: None
    """
    pass

def crouch_3d_physics_character_controller(id: int) -> None:
    """
...
def debug_3d_physics_character_controller(id: int, enabled: Union[bool, int]) -> None:
    """
...
def delete_3d_physics_body(id: int) -> None:
    """
...
def delete_3d_physics_character_controller(id: int) -> None:
    """
...
def delete_3d_physics_joint(id: int) -> None:
    """
    Deletes the physics joint.

    :param int id: ID of joint.
    :rtype: None
    """
    pass

def delete_3d_physics_pick_joint(id: int) -> None:
    """
    Deletes pick joint.
...
def delete_3d_physics_ragdoll(id: int) -> None:
    """
...
def delete_3d_physics_ray(id: int) -> None:
    """
    Deletes a physics ray and all associated data.

    :param int id: ID of the ray to delete.
    :rtype: None
    """
    pass

def delete_3d_physics_static_plane(id: int) -> None:
    """
    Deletes the static plane.

    :param int id: Static plane ID.
    :rtype: None
    """
    pass
...
def get_3d_physics_character_controller_exists(id: int) -> bool:
    """
...
def get_3d_physics_character_controller_gravity(id: int) -> float:
    """
...
def get_3d_physics_character_controller_max_slope(id: int) -> float:
    """
    Returns the max slope in degrees.
...
def get_3d_physics_joint_enabled(id: int) -> int:
    """
...
def get_3d_physics_joint_position_vector(id: int) -> int:
    """
    Returns the vector ID.

    :param int id: ID of a Joint.
    :rtype: int
    """
    pass

def get_3d_physics_joint_rotation_vector(id: int) -> int:
    """
    Returns the joints X rotation angle in degrees.

    :param int id: The ID of the joint.
    :rtype: int
    """
    pass

def get_3d_physics_ragdoll_exist(id: int) -> int:
    """
...
def get_3d_physics_ragdoll_from_bone_object(id: int) -> int:
    """
    Returns the object ID of the Model with the ragdoll which contains the ragdoll bone object passed in.

    :param int id: Object ID of a ragdoll bone capsule.
    :rtype: int
    """
    pass

def get_3d_physics_ray_cast_closest_contact_position(id: int, out_vector: int) -> int:
    """
    Returns true if there is a closest contact vector and fills the vector `out_vector()`.

    First create a vector with `create_vector3()` then pass in the ID. The vector you have created and passed in will be
    filled with the results.

    :param int id: ID of the ray.
    :param int out_vector: ID of the vector that will be filled with the position.
    :rtype: int
    """
    pass

def get_3d_physics_ray_cast_closest_object_hit(id: int) -> int:
    """
...
def get_3d_physics_ray_cast_contact_position(id: int, fraction: float, out_vector: int) -> int:
    """
    Returns true if there is a contact vector and fills the vector `out_vector()`.

    First create a vector with `create_vector3()` then pass in the ID. The vector you have created and passed in will be
    filled with the results.

    :param int id: ID of the ray.
    :param float fraction: Value returned by `get_3d_physics_ray_cast_fraction()` command.
    :param int out_vector: ID of the vector that will be filled with the position.
    :rtype: int
    """
    pass

def get_3d_physics_ray_cast_fraction(id: int) -> float:
    """
...
def get_3d_physics_ray_cast_normal_vector(id: int, out_vector: int) -> None:
    """
    ...
    :param int id: The ID of the ray which is returned by calling `create_3d_physics_ray()`.
    :param int out_vector: The ID of a vector. Vector ID is the return value from `create_vector3()` command.
    :rtype: None
    """
    pass

def get_3d_physics_ray_cast_num_hits(id: int) -> int:
    """
...
def get_3d_physics_ray_cast_object_hit(id: int, fraction: float) -> int:
    """
...
def get_object_3d_physics_angular_damp(id: int) -> float:
    """
...
def get_object_3d_physics_angular_sleeping_threshold(id: int) -> float:
    """
...
def get_object_3d_physics_angular_velocity_x(id: int) -> float:
    """
...
def get_object_3d_physics_angular_velocity_y(id: int) -> float:
    """
...
def get_object_3d_physics_angular_velocity_z(id: int) -> float:
    """
...
def get_object_3d_physics_contact_vector(out_vector: int) -> int:
    """
    Returns true if there is a contact vector and fills the vector `out_vector()`.
    ...
    :param int out_vector: The ID of the vector to be filled with the results.
    :rtype: int
    """
    pass
...
def get_object_3d_physics_first_contact(id: int) -> int:
    """
...
def get_object_3d_physics_friction(id: int) -> float:
    """
...
def get_object_3d_physics_group(id: int) -> int:
    """
...
def get_object_3d_physics_linear_damp(id: int) -> float:
    """
...
def get_object_3d_physics_linear_sleeping_threshold(id: int) -> float:
    """
...
def get_object_3d_physics_linear_velocity_x(id: int) -> float:
    """
...
def get_object_3d_physics_linear_velocity_y(id: int) -> float:
    """
    Returns the X component of the Linear Velocity vector.
...
def get_object_3d_physics_linear_velocity_z(id: int) -> float:
    """
    Returns the X component of the Linear Velocity vector.
...
def get_object_3d_physics_mask(id: int) -> int:
    """
...
def get_object_3d_physics_mass(id: int) -> float:
    """
...
def get_object_3d_physics_next_contact() -> int:
    """
...
def get_object_3d_physics_restitution(id: int) -> float:
    """
...
def get_object_3d_physics_rolling_friction(id: int) -> float:
    """
...
def get_objects_3d_physics_contact_position_vector(object_id1: int, object_id2: int,
                                                   out_vector: int) -> int:
    """
    Fills `out_vector()` with contact position.

    Returns false if no contact. First create a vector with `create_vector3()` then pass in the ID. The vector you have
    created and passed in will be filled with the results.

    :param int object_id1: First object ID.
    :param int object_id2: Second object ID.
    :param int out_vector: ID of the position vector to be filled. Create this vector first.
    :rtype: int
    """
    pass

def is3d_physics_ragdoll_static(id: int) -> int:
    """
...
def jump_3d_physics_character_controller(id: int) -> None:
    """
...
def load_object_shape(id: int, filename: str) -> bool:
    """
...
def move_3d_physics_character_controller(id: int, direction: int, velocity: float) -> None:
    """
    ...
    :param float velocity: Travel speed.
    :rtype: None
    """
    pass

def ray_3d_physics_exist(id: int) -> int:
    """
...
def ray_cast_3d_physics(id: int, from_vector: int, to_vector: int, all_or_closest: int) -> None:
    """
    Cast a ray.

    :param int id: ID of the ray.
    :param int from_vector: ID of the starting point vector. Create a vector with the `create_vector3()` command.
    :param int to_vector: ID of the destination vector.
    :param int all_or_closest: 1 (RAY_CAST_ALL)= all contacts, 0 (RAY_CAST_CLOSEST)= closest contact.
    :rtype: None
    """
    pass

def ray_cast_3d_physics_object(object_id: int, ray_id: int, from_vector: int, to_vector: int,
...
def rotate_3d_physics_character_controller(id: int, angle: float) -> None:
    """
    Rotates the controller.

    :param int id: Object ID.
    :param float angle: Amount in degrees.
    :rtype: None
    """
    pass

def save_object_shape(id: int, filename: str) -> bool:
    """
...
def set_3d_physics_character_controller_fall_speed(id: int, speed: float) -> None:
    """
    Sets the speed at which the controller will fall.

    :param int id: Object ID.
    :param float speed: Default value is 55.0 which is the terminal velocity of a sky diver in meters per second.
    :rtype: None
    """
    pass

def set_3d_physics_character_controller_gravity(id: int, gravity: float) -> None:
    """
    ...
    :param int id: Object ID.
    :param float gravity: Default value is (9.8 * 3).
    :rtype: None
    """
    pass

def set_3d_physics_character_controller_jump_speed(id: int, speed: float) -> None:
    """
    Set the speed at which the controller moves up when jump is called.

    :param int id: Object ID.
    :param float speed: Default is 10.0.
    :rtype: None
    """
    pass

def set_3d_physics_character_controller_max_slope(id: int, angle: float) -> None:
    """
    set the max slope in angle degrees that a controller can climb.

    :param int id: Object ID.
    :param float angle: Default value is 45.0 degrees.
    :rtype: None
    """
    pass

def set_3d_physics_character_controller_position(id: int, x: float, y: float, z: float) -> None:
    """
...
def set_3d_physics_character_controller_step_height(id: int, height: float) -> None:
    """
    Sets the height that the controller can step up and over.

    :param int id: Object ID.
    :param float height: Step height in world values.
    :rtype: None
    """
    pass

def set_3d_physics_gravity(x: Optional[float]=None, y: Optional[float]=None,
                           z: Optional[float]=None, vector: int=0) -> None:
    """
    ...
    :param Optional[float] x: The value of gravity on the X axis in meters per second.
    :param Optional[float] y: The value of gravity on the Y axis in meters per second.
    :param Optional[float] z: The value of gravity on the Z axis in meters per second.
    :param Optional[int] vector: The ID of the vector to use as gravity.
    :rtype: None
    """
    pass

def set_3d_physics_hinge_joint_max_motor_impulse(id: int, max_impulse: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float max_impulse: The maximum impulse value to be applied to the joint motor.
    :rtype: None
    """
    pass

def set_3d_physics_hinge_joint_motor_is_enabled(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_3d_physics_hinge_joint_motor_velocity(id: int, target_velocity: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float target_velocity: The target velocity to be used.
    :rtype: None
    """
    pass

def set_3d_physics_joint_breaking_threshold(id: int, threshold: float) -> None:
    """
    Sets the breaking threshold for the joint.

    :param int id: ID of joint.
    :param float threshold: Breaking threshold value.
    :rtype: None
    """
    pass

def set_3d_physics_joint_cone_twist_limits(id: int, swing_span1: float, swing_span2: float,
                                           twist_span: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float swing_span1: Angle in degrees.
    :param float swing_span2: Angle in degrees.
    :param float twist_span: Angle in degrees.
    :rtype: None
    """
    pass

def set_3d_physics_joint_enabled(id: int, enabled: Union[bool, int]) -> None:
    """
    Sets the breaking threshold for the joint.
...
def set_3d_physics_joint_hinge_limits(id: int, minimum: float, maximum: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float minimum: The minimum angle in degrees.
    :param float maximum: The maximum angle in degrees.
    :rtype: None
    """
    pass

def set_3d_physics_joint_slider_angular_limits(id: int, minimum: float, maximum: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float minimum: The lower limit in degrees.
    :param float maximum: The upper limit in degrees.
    :rtype: None
    """
    pass

def set_3d_physics_joint_slider_linear_limits(id: int, minimum: float, maximum: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float minimum: The lower limit.
    :param float maximum: The upper limit.
    :rtype: None
    """
    pass

def set_3d_physics_ragdoll_bones_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def set_3d_physics_ragdoll_damping(linear: float, angular: float) -> None:
    """
    ...
    :param float linear: Default value is 0.08.
    :param float angular: Default value is 0.95.
    :rtype: None
    """
    pass

def set_3d_physics_ragdoll_deactivation(id: int, disabled: Union[bool, int]) -> None:
    """
...
def set_3d_physics_ragdoll_deactivation_time(time: float) -> None:
    """
    ...
    :param float time: Default value is 0.8.
    :rtype: None
    """
    pass

def set_3d_physics_ragdoll_sleeping_thresholds(linear: float, angular: float) -> None:
    """
    ...
    :param float linear: Default value is 1.8.
    :param float angular: Default value is 2.8.
    :rtype: None
    """
    pass

def set_3d_physics_ragdoll_static(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_3d_physics_slider_joint_max_linear_motor_force(id: int, force: float) -> None:
    """
    Sets the joints motor to the maximum linear force.

    :param int id: ID of joint.
    :param float force: The maximum linear force to be applied to the joint motor.
    :rtype: None
    """
    pass

def set_3d_physics_slider_joint_powered_linear_motor_is_enabled(id: int, enabled: Union[bool,
                                                                int]) -> None:
    """
...
def set_3d_physics_slider_joint_target_linear_motor_velocity(id: int, velocity: float) -> None:
    """
    Sets the target linear Motor Velocity for the physics slider joint.

    :param int id: ID of joint.
    :param float velocity: The linear velocity to be applied to the joint motor.
    :rtype: None
    """
    pass

def set_3d_physics_static_plane_position(id: int, x: float, y: float, z: float) -> None:
    """
    Sets the position of the static plane.

    :param int id: Static plane ID.
    :param float x: The world X position.
    :param float y: The world Y position.
    :param float z: The world Z position.
    :rtype: None
    """
    pass

def set_3d_physics_static_plane_rotation(id: int, x: float, y: float, z: float) -> None:
    """
    Sets the rotation of the static Plane.

    :param int id: Static plane ID.
    :param float x: The world X angle of rotation.
    :param float y: The world Y angle of rotation.
    :param float z: The world Z angle of rotation.
    :rtype: None
    """
    pass

def set_3d_physics_twist_joint_max_motor_impulse(id: int, impulse: float) -> None:
    """
    ...
    :param int id: ID of joint.
    :param float impulse: The maximum impulse to be applied to the joint motor.
    :rtype: None
    """
    pass

def set_3d_physics_twist_joint_motor_is_enabled(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_3d_physics_twist_joint_motor_rotation_target(id: int, rotation_vector: int) -> None:
    """
    ...
    :param int id: ID of joint.
    :param int rotation_vector: The ID of a vector which has the rotation target for a twist joint motor.
    :rtype: None
    """
    pass

def set_object_3d_physics_angular_velocity(id: int, initial_speed: float, x: Optional[float]=None,
    ...
    :param int id: Object ID.
    :param float initial_speed: The initial speed.
    :param Optional[float] x: The X component of the angle vector.
    :param Optional[float] y: The Y component of the angle vector.
    :param Optional[float] z: The Z component of the angle vector.
    :param Optional[int] vector: ID of direction Vector.
    :rtype: None
    """
    pass

def set_object_3d_physics_anisotropic_friction(id: int, mode: int) -> None:
    """
    This will set the type of anisotropic friction.

    :param int id: Object ID.
    :param int mode: DISABLED = 0, FRICTION = 1, ROLLING_FRICTION = 2.
    :rtype: None
    """
    pass

def set_object_3d_physics_can_sleep(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_object_3d_physics_damping(id: int, linear: float, angular: float) -> None:
    """
    Sets the linear and angular damping for the object.

    :param int id: Object ID.
    :param float linear: The amount of linear damping applied to the object.
    :param float angular: The amount of angular damping applied to the object.
    :rtype: None
    """
    pass

def set_object_3d_physics_deactivation_time(id: int, time: float) -> None:
    """
    ...
    :param int id: Object ID.
    :param float time: The amount of time before deactivating.
    :rtype: None
    """
    pass

def set_object_3d_physics_friction(id: int, friction: float) -> None:
    """
    This will set the friction for dynamic and static objects.

    :param int id: Object ID.
    :param float friction: Friction value as a float.
    :rtype: None
    """
    pass

def set_object_3d_physics_group_and_mask(id: int, group: int, mask: int) -> None:
    """
...
def set_object_3d_physics_linear_velocity(id: int, initial_speed: float, x: Optional[float]=None,
                                          y: Optional[float]=None, z: Optional[float]=None,
                                          vector: int=0) -> None:
    """
    ...
    :param int id: Object ID.
    :param float initial_speed: The initial speed.
    :param Optional[float] x: The X component of the direction vector.
    :param Optional[float] y: The Y component of the direction vector.
    :param Optional[float] z: The Z component of the direction vector.
    :param Optional[int] vector: ID of the direction vector.
    :rtype: None
    """
    pass

def set_object_3d_physics_mass(id: int, mass: float) -> None:
    """
...
def set_object_3d_physics_max_linear_velocity(id: int, maximum: float) -> None:
    """
    ...
    :param int id: Object ID.
    :param float maximum: Max speed an object can reach.
    :rtype: None
    """
    pass

def set_object_3d_physics_restitution(id: int, friction: float) -> None:
    """
    ...
    :param int id: Object ID.
    :param float friction: The amount of friction applied to the object.
    :rtype: None
    """
    pass

def set_object_3d_physics_rolling_friction(id: int, friction: float) -> None:
    """
    This will set the rolling friction for static and dynamic objects.

    :param int id: Object ID.
    :param float friction: Rolling friction value as a float.
    :rtype: None
    """
    pass

def set_object_3d_physics_sleeping_threshold(id: int, angular: float, linear: float) -> None:
    """
    Sets the 3d physics sleeping thresholds for the object.

    :param int id: Object ID.
    :param float angular: Angular velocity.
    :param float linear: Linear velocity.
    :rtype: None
    """
    pass

def set_object_shape_box(id: int, x: Optional[float]=None, y: Optional[float]=None,
                         z: Optional[float]=None, vector: int=0) -> None:
    """
    ...
    :param int id: Object ID.
    :param Optional[float] x: Dimension on the x axis.
    :param Optional[float] y: Dimension on the Y axis.
    :param Optional[float] z: Dimension on the Z axis.
    :param Optional[int] vector: ID of a dimension vector.
    :rtype: None
    """
    pass

def set_object_shape_capsule(id: int, axis: int, x: Optional[float]=None, y: Optional[float]=None,
                             z: Optional[float]=None, vector: int=0) -> None:
    """
    ...
    :param int id: Object ID.
    :param int axis: 0 (AXIS_X)= X, 1 (AXIS_Y)= Y, 2 (AXIS_Z)= Z axis orientation.
    :param Optional[float] x: Dimension on the x axis.
    :param Optional[float] y: Dimension on the Y axis.
    :param Optional[float] z: Dimension on the Z axis.
    :param Optional[int] vector: ID of the dimension vector.
    :rtype: None
    """
    pass

def set_object_shape_compound(id: int) -> None:
    """
...
def set_object_shape_cone(id: int, axis: int, height: Optional[float]=None,
    ...
    :param int id: Object ID.
    :param int axis: 0 (AXIS_X)= X, 1 (AXIS_Y)= Y, 2 (AXIS_Z)= Z axis orientation.
    :param Optional[float] height: Height on the y.
    :param Optional[float] diameter: Diameter on the x and z.
    :rtype: None
    """
    pass

def set_object_shape_convex_hull(id: int) -> None:
    """
...
def set_object_shape_cylinder(id: int, axis: int, height: Optional[float]=None,
                              diameter: Optional[float]=None) -> None:
    """
...
def set_object_shape_sphere(id: int, diameter: Optional[float]=None) -> None:
    """
    ...
    :param int id: Object ID.
    :param Optional[float] diameter: Size of sphere.
    :rtype: None
    """
    pass

def set_object_shape_static_polygon(id: int) -> None:
    """
...
def sphere_cast_3d_physics(ray_id: int, from_vector: int, to_vector: int, radius: float) -> None:
    """
...
def sphere_cast_3d_physics_object(object_id: int, ray_id: int, from_vector: int, to_vector: int,
                                  radius: float) -> bool:
    """
    Casts a sphere collision shape along the length of the ray.
...
def update_3d_physics_pick_joint(joint_id: int, position_vector: int) -> None:
    """
...
def create_advert(size: int, horizontal_align: int, vertical_align: int, test_ads: Union[bool,
    ...
    one already exists will replace the existing ad. The size parameter can be used to select the size of the banner: 0
    (BANNER_REGULAR)=Banner(320x50), 1 (BANNER_LARGE)=LargeBanner, 2 (BANNER_MEDIUM)=MediumRectangle, 3
    (BANNER_FULL)=FullBanner, 4 (BANNER_LEADERBOARD)=Leaderboard, 5 (BANNER_SMART)=SmartBanner, 6
    (BANNER_FLUID)=FluidBanner.
...
def create_advert_ex(size: int, horizontal_align: int, vertical_align: int, test_ads: Union[bool,
                     int], offset_x: float, offset_y: float) -> None:
    """
    Creates an advert for revenue generation.
    ...
    takes optional offset values for positioning the ad. The size parameter can be used to select the size of the
    banner: 0 (BANNER_REGULAR)=Banner(320x50), 1 (BANNER_LARGE)=LargeBanner, 2 (BANNER_MEDIUM)=MediumRectangle, 3
    (BANNER_FULL)=FullBanner, 4 (BANNER_LEADERBOARD)=Leaderboard, 5 (BANNER_SMART)=SmartBanner, 6
    (BANNER_FLUID)=FluidBanner.
    ...
    :param int vertical_align: The vertical position of the ad, 0 (ALIGN_TOP)=top, 1 (ALIGN_CENTER)=center, 2
        (ALIGN_BOTTOM)=bottom.
    :param Union[bool, int] test_ads: Set to True to receive a non paying test ad, False to receive a real ad.
    :param float offset_x: When horizontal_align is equal to 0 or 2 this value offsets the ad from the specified edge.
    :param float offset_y: When vertical_align is equal to 0 or 2 this value offsets the ad from the specified edge.
    :rtype: None
    """
    pass
...
'''*DEPRECATED*
def create_fullscreen_advert() -> None:
    """
    This command is deprecated, you should use `show_fullscreen_advert_admob()`, `show_fullscreen_advert_chartboost()`,
    or `show_fullscreen_advert_amazon()` instead.

    Creates a fullscreen (interstitial) advert for revenue generation.

    Before calling this function you must have set your ad account details with one of the other commands such as
    `set_admob_details()`, `set_chartboost_details()`, or `set_amazon_ad_details()`. Not all platforms support all ad
    providers so setting as many account details as possible will allow AGK to select a suitable ad for this platform.
    ...
    because the ad provider has run out of ads to show to users in a particular country. You can check if an ad is
    waiting to be displayed for a particular provider with `get_fullscreen_advert_loaded_admob()`,
    `get_fullscreen_advert_loaded_chartboost()`, or `get_fullscreen_advert_loaded_amazon()`. Your app will be paused
    when the advert is displayed, and will resume when the advert is dismissed.
...
def set_admob_details(id: str) -> None:
    """
    ...
    :param str id: Ad unit ID as provided by AdMob.
    :rtype: None
    """
    pass

def set_admob_reward_ad_details(id: str) -> None:
    """
    ...
    :param str id: Ad unit ID as provided by AdMob (not the App ID).
    :rtype: None
    """
    pass
...
def set_advert_location(horizontal_align: int, vertical_align: int, width: float) -> None:
    """
    ...
    :param int vertical_align: The vertical position of the ad, 0 (ALIGN_TOP)=top, 1 (ALIGN_CENTER)=center, 2
        (ALIGN_BOTTOM)=bottom.
    :param float width: The desired width of the ad, it will be scaled to this width.
    :rtype: None
    """
    pass

def set_advert_location_ex(horizontal_align: int, vertical_align: int, offset_x: float,
                           offset_y: float, width: float) -> None:
    """
    Positions the advert created with `create_advert()` somewhere on screen and attempts to scale it to a certain width.
...
def set_advert_position(x: float, y: float, width: float) -> None:
    """
    Positions the advert created with `create_advert()` somewhere on screen and attempts to scale it to a certain width.
    ...
    :param float x: The x position of the top left corner of the ad.
    :param float y: The y position of the top left corner of the ad.
    :param float width: The desired width of the ad, it will be scaled to this width.
    :rtype: None
    """
    pass
...
def abs(a: float) -> float:
    ...
    :param float a: The value to convert.
    :rtype: float
    """
    pass
'''
...
def acos(a: float) -> float:
    ...
    :param float a: The value to pass into the arccosine function.
    :rtype: float
    """
    pass

def acos_rad(a: float) -> float:
    """
...
def asin(a: float) -> float:
    ...
    :param float a: The value to pass into the arcsine function.
    :rtype: float
    """
    pass

def asin_rad(a: float) -> float:
    """
...
def atan(a: float) -> float:
    ...
    :param float a: The value to pass into the arctangent function.
    :rtype: float
    """
    pass
...
def atan2(y: float, x: float) -> float:
    ...
    :param float y: The y value to pass to atan2.
    :param float x: The x value to pass to atan2.
    :rtype: float
    """
    pass
...
def atan_full(x: float, y: float) -> float:
    """
    ...
    :param float x: The x component of the vector to check.
    :param float y: The y component of the vector to check.
    :rtype: float
    """
    pass

def atan_full_rad(x: float, y: float) -> float:
    """
    ...
    looking for an equivalent to atan2 in C++ use the AGK command ATan2Rad instead.
...
def bin(value: int) -> str:
    ...
    For example Bin(7) would return a string containing "111".

    :param int value: Integer value to convert into a binary string.
    :rtype: str
    """
    pass
'''
...
def ceil(a: float) -> int:
    ...
    :param float a: The value to round up.
    :rtype: int
    """
    pass
...
def chr(value: int) -> str:
    ...
    :param int value: The Unicode integer value to convert to a Unicode character.
    :rtype: str
    """
    pass
'''
...
def compare_string(text1: str, text2: str, ignore_case: Union[bool, int]=True,
    ...
    By default this is case insensitive, use the ignoreCase parameter to set case sensitivity. Use the maxChars
    ...
    :param Optional[Union[bool, int]] ignore_case: True to ignore case when comparing, False to match case.
    :param Optional[int] max_chars: The number of characters to check, -1 for all.
    :rtype: bool
    """
    pass
...
def cos(a: float) -> float:
    ...
    :param float a: The value to pass into the cosine function.
    :rtype: float
    """
    pass

def cos_rad(a: float) -> float:
    """
...
def draw_box(x1: float, y1: float, x2: float, y2: float, color1: int, color2: int, color3: int,
             color4: int, filled: Union[bool, int]) -> None:
    """
    ...
    :param float x1: The X component of the top left corner of the box.
    :param float y1: The Y component of the top left corner of the box.
    :param float x2: The X component of the bottom right corner of the box.
    :param float y2: The Y component of the bottom right corner of the box.
...
def draw_ellipse(x: float, y: float, radius_x: float, radius_y: float, color1: int, color2: int,
                 filled: Union[bool, int]) -> None:
    """
    ...
    :param float x: The X component of the center of the ellipse.
    :param float y: The Y component of the center of the ellipse.
    :param float radius_x: The radius of the ellipse in the X direction.
    :param float radius_y: The radius of the ellipse in the Y direction.
...
def draw_line(x1: float, y1: float, x2: float, y2: float, red: Optional[int]=None,
              green: Optional[int]=None, blue: Optional[int]=None, color1: Optional[int]=None,
              color2: Optional[int]=None) -> None:
    """
    ...
    Either red, green, and blue or color1 and color2 must be given.

    :param float x1: The X component of the start position of the line.
    :param float y1: The Y component of the start position of the line.
    :param float x2: The X component of the end position of the line.
    :param float y2: The Y component of the end position of the line.
    :param Optional[int] red: The red component of the line color.
    :param Optional[int] green: The green component of the line color.
    :param Optional[int] blue: The blue component of the line color.
    :param Optional[int] color1: The color to use at the start of the line. (Hex: 0xBBGGRR)
    :param Optional[int] color2: The color to use at the end of the line. (Hex: 0xBBGGRR)
    :rtype: None
    """
    pass
...
def find_string(text: str, find_str: str, ignore_case: Union[bool, int]=True, start: int=1) -> int:
    """
    Returns the index of the first occurrence of findStr in the given string.

    Index 1 is the first character in the string, returns 0 if not found. By default this is case insensitive, use the
    ignoreCase parameter to set case sensitivity.

    :param str text: The string to check.
    :param str find_str: The string to find.
    :param Optional[Union[bool, int]] ignore_case: True to ignore case when searching, False to match case.
    :param Optional[int] start: The index to start from, the first character is at index 1.
    :rtype: int
    """
    pass

def find_string_count(text: str, find_str: str, ignore_case: Union[bool, int]=True,
                      start: int=1) -> int:
    """
...
def find_string_reverse(text: str, find_text: str, ignore_case: Union[bool, int]=True,
                        start: int=-1) -> int:
    """
    Returns the index of the first occurrence of findStr in the given string, starting from the end of the string and
    moving backwards.

    Use a start value of -1 to start at the very end of the string regardless of length. Index 1 is the first character
    in the string, returns 0 if not found. By default this is case insensitive, use the ignoreCase parameter to set case
    sensitivity.

    :param str text: The string to check.
    :param str find_text: The string to find.
    :param Optional[Union[bool, int]] ignore_case: True to ignore case when searching, False to match case.
    :param Optional[int] start: The index to start from, the first character is at index 1, use -1 to start at the very
        end.
    :rtype: int
    """
    pass
...
def floor(a: float) -> int:
    ...
    :param float a: The value to floor.
    :rtype: int
    """
    pass
...
def get_app_running(id: int) -> bool:
    """
    Returns True if the specified app ID is still running, False if it is not.

    :param int id: The app ID to check, returned from `run_app()`.
    :rtype: bool
    """
    pass
...
def get_device_base_name() -> str:
    ...
    This will only refer to the base platform, i.e. "windows", "ios", "android", "mac", or "linux". Use
...
def get_device_height() -> int:
    """
    Returns the height in pixels of the current device's screen.

    For most platforms this value is usually the size of the screen in portrait mode, but this is not guaranteed. This
    value will not change if the screen is rotated.
...
def get_device_name() -> str:
    """
    This command is deprecated, please use `get_device_base_name()` and `get_device_type()` instead.

    Returns a string containing the name of the current platform. e.g. "windows" or "bada". When dealing with iOS more
    information is returned e.g. on iPad 1 "ios|iPad1,1" and on iPod 2nd gen: "ios|iPod2,1" and on iPhone 3G:
...
def get_device_width() -> int:
    """
    Returns the width in pixels of the current device's screen.
...
def get_milliseconds() -> int:
    ...
    Calling this command will internally make a system call to get the amount of time passed, therefore it's advisable
    to not call it too often per frame. A better approach might be to store the time value and reuse it throughout the
    current frame.
...
def get_string_token2(text: str, delimiter: str, token: int) -> str:
    ...
    :param str text: The string to check.
    :param str delimiter: The characters that delimits the string.
    :param int token: The index of the token to return, starting at 1 for the first token.
    :rtype: str
    """
    pass
...
def hex(value: int) -> str:
    """
    Converts an integer value into a string containing its hexadecimal representation.

    For example Hex(31) would return a string containing "1F".

    :param int value: Integer value to convert into a hexadecimal string.
    :rtype: str
    """
    pass
'''
...
def left(text: str, count: int) -> str:
    ...
    :param str text: The string to be cropped.
    :param int count: The number of characters to retain.
    :rtype: str
    """
    pass
'''
...
def len(text: str) -> int:
    ...
    Note that for strings encoded in UTF-8 this may not be equal to the number of bytes in the string, as each character
    can use up to 4 bytes. To determine the length in bytes use the `byte_len()` command.
...
'''*EXCLUDED*
def mid(text: str, position: int, length: int) -> str:
    """
    Extracts a sub string from the given string located at the position provided.

    :param str text: The string to be extracted from.
    :param int position: The position to start within the string, the first character is position 1.
    :param int length: The number of characters to extract from the string, use -1 to continue to the end of the string.
    :rtype: str
    """
    pass
'''
...
def round(a: float) -> int:
    ...
    :param float a: The value to round.
    :rtype: int
    """
    pass
'''
...
def screen_to_world_x(x: float) -> float:
    """
    ...
    :param float x: The screen X coordinate to convert.
    :rtype: float
    """
    pass

def screen_to_world_y(y: float) -> float:
    """
    ...
    :param float y: The screen Y coordinate to convert.
    :rtype: float
    """
    pass
...
def set_antialias_mode(mode: int) -> None:
    ...
    :param int mode: 0 (AA_NONE)=off, 1 (AA_4XMS)=4x multi-sampling.
    :rtype: None
    """
    pass
...
def set_display_aspect(aspect: float) -> None:
    """
    ...
    :param float aspect: The aspect ratio to use from now on, in the form of width/height.
    :rtype: None
    """
    pass
...
'''*DEPRECATED*
def set_intended_device_size(width: int, height: int) -> None:
    """
    Sets the size of the device you have designed all your artwork for, this allows AGK to downsize the images to save
    memory on lower resolution devices.

    Note that commands such as `set_sprite_animation()` that might assume image sizes must account for images that have
    been reduced. For example loading a 512x512 image and using `set_sprite_animation(spr, 128, 128, 16)` should instead
    use `set_sprite_animation(spr, get_image_width(img) / 4, get_image_height(img) / 4, 16)` in case the image is no
    longer 512 in size.

    This command has been deprecated and you should use `load_image_resized()` to adjust image sizes depending on the
    device resolution, you can check the device resolution with `get_device_width()` and `get_device_height()`.
...
def set_orientation_allowed(portrait1: Union[bool, int], portrait2: Union[bool, int],
    ...
    This auto rotation does not work on iOS, so if you need the device to change orientation you will have to set your
    allowed orientations and then ask the user to rotate the device into one of the allowed orientations, which will
    then lock it to your allowed orientations.
...
def set_scissor(x1: float, y1: float, x2: float, y2: float) -> None:
    """
    ...
    is not be visible. Using `set_scissor(0,0,0,0)` is a special case that will turn off all clipping and make the full
    screen usable for displaying things. This can be useful when making an app that works across varying aspect ratios.
    For example using a virtual resolution of 1024x768 on a device with a 1280x800 screen would fit the 1024x768 area as
    closely as possible in the center of the screen, with black borders either side. `set_scissor(0,0,0,0)` places the
    1024x768 area in the same place, but there are no black borders, so placing something at a negative X position would
    still be visible for as long as the screen can still fit it in. Whereas placing something at a negative position on
    a device with a 1024x768 screen (which fits your virtual resolution perfectly), would make that item disappear off
    the edge of the screen. You can use this with the commands `get_screen_bounds_left()`, `get_screen_bounds_right()`,
    `get_screen_bounds_top()`, and `get_screen_bounds_bottom()` to find the actual edge of the screen in your chosen
    resolution. This allows you to place items at the edge of the screen on all devices regardless of its aspect ratio.

    :param float x1: The x component of the first coordinate.
    :param float y1: The y component of the first coordinate.
    :param float x2: The x component of the second coordinate.
    :param float y2: The y component of the second coordinate.
    :rtype: None
    """
    pass
...
'''*DEPRECATED*
def set_sort_depth(enabled: Union[bool, int]) -> None:
    """
    Sets whether the AGK should sort opaque sprites by depth when drawing.

    This draws sprites at the front of the screen first, which fills the depth buffer so later sprites behind can be
    skipped. This will improve performance on fill rate limited devices where you are drawing lots of overlapping opaque
    sprites. It is off by default but if you do not change sprite depth frequently it is recommended to turn it on. This
    does not apply to transparent sprites which have their own sorting requirements. This command is deprecated, sorting
    is now handled automatically.

    :param Union[bool, int] enabled: True to sort opaque sprites by depth. default=False.
    :rtype: None
    """
    pass
'''
...
'''*DEPRECATED*
def set_sort_textures(enabled: Union[bool, int]) -> None:
    """
    Sets whether the AGK should sort sprites by texture when drawing to limit the number of texture changes.

    This will improve performance on devices that do not cope well with frequent state changes, but may reduce
    performance if textures on sprites are changed frequently. It is off by default but if you do not change sprite
    textures, or are using atlas textures it is recommended to turn it on. This command is deprecated, sorting is now
    handled automatically.

    :param Union[bool, int] enabled: Set to True to sort sprites by texture. default=False.
    :rtype: None
    """
    pass
'''
...
'''*DEPRECATED*
def set_sort_transparent_depth(enabled: Union[bool, int]) -> None:
    """
    Sets whether the AGK should sort transparent sprites by depth when drawing.

    This draws sprites at the back of the screen first to achieve the correct blending result when transparent sprites
    overlap. It is on by default but if your transparent sprites are guaranteed to not overlap you may turn it off to
    increase performance. This command is deprecated, sorting is now handled automatically.

    :param Union[bool, int] enabled: Set to True to sort transparent sprites by depth, False to turn transparent sorting
        off.
    :rtype: None
    """
    pass
...
def set_sync_rate(fps: float, mode: int) -> None:
    """
    ...
    :param float fps: The desired frame rate in frames per second, 0 for unlimited.
...
def set_view_offset(x: float, y: float) -> None:
    """
    ...
    :param float x: The x offset for the view.
    :param float y: The y offset for the view.
    :rtype: None
    """
    pass

def set_view_zoom(zoom: float) -> None:
    """
    ...
    :param float zoom: The zoom level for scrolling sprites.
    :rtype: None
    """
    pass
...
def set_vsync(mode: int) -> None:
    ...
    :param int mode: 1 to turn vsync on, 0 to turn it off, > 1 to skip refreshes.
    :rtype: None
    """
    pass
...
def set_window_size(width: int, height: int, fullscreen: Union[bool, int],
                    allow_oversized: Union[bool, int]=False) -> None:
    """
...
def sin(a: float) -> float:
    ...
    :param float a: The value to pass into the sine function.
    :rtype: float
    """
    pass

def sin_rad(a: float) -> float:
    """
...
def spaces(length: int) -> str:
    ...
    :param int length: The length of the string of spaces to create.
    :rtype: str
    """
    pass
'''
...
def sqrt(a: float) -> float:
    ...
    :param float a: The value to square root.
    :rtype: float
    """
    pass

def step_physics(time: float) -> None:
    """
    ...
    :param float time: The amount of time by which to step the physics simulation.
    :rtype: None
    """
    pass
...
'''*EXCLUDED*
def str(value: Optional[*UNKNOWN*]=None, decimals: Optional[int]=None) -> str:
    """
    Converts a value into a string.

    :param Optional[*UNKNOWN*] value: Value to convert into a string.
    :param Optional[int] decimals: The number of places after the decimal point to include.
    :rtype: str
    """
    pass
'''
...
def tan(a: float) -> float:
    ...
    :param float a: The value to pass into the tangent function.
    :rtype: float
    """
    pass

def tan_rad(a: float) -> float:
    """
...
def trunc(a: float) -> int:
    ...
    :param float a: The value to truncate.
    :rtype: int
    """
    pass
...
def update(time: float) -> None:
    ...
    :param float time: The time in seconds to move everything along. Can be fractions of seconds.
    :rtype: None
    """
    pass

def update_2d(time: float) -> None:
    """
    Called automatically.
...
def update_device_size(width: int, height: int) -> None:
    """
    If for any reason the device dimensions may have changed (e.g. change in orientation rotates the viewspace to a new
    size) call this function to update the internal values.

    :param int width: The new device width.
    :param int height: The new device height.
    :rtype: None
    """
    pass
...
'''*EXCLUDED*
def val(text: str, base: Optional[int]=None) -> int:
    """
    Converts a string into an integer value.

    For example Val("10") would return the value 10.

    :param str text: The string to convert to an integer.
    :param Optional[int] base: The base that the string number is in.
    :rtype: int
    """
    pass
'''
...
'''*EXCLUDED*
def val_float(text: str) -> float:
    """
    Converts a string into an floating point value.

    For example ValFloat("1.045") would return the value 1.045.
...
def world_to_screen_x(x: float) -> float:
    ...
    :param float x: The world X coordinate to convert.
    :rtype: float
    """
    pass

def world_to_screen_y(y: float) -> float:
    """
    ...
    :param float y: The world Y coordinate to convert.
    :rtype: float
    """
    pass
...
def activate_smart_watch(reserved: str) -> None:
    """
    ...
    :param str reserved: Reserved for future use, must be an empty string.
    :rtype: None
    """
    pass

def cancel_local_notification(id: int) -> None:
    """
    Cancels a notification that was scheduled by this application.

    :param int id: The ID of the notification to cancel.
    :rtype: None
    """
    pass
...
def facebook_activate_app_tracking() -> None:
    """
    Activates tracking in the Facebook SDK, this is useful if you are using Facebook Ads as this will associate installs
    to adverts previously seen and clicked on Facebook.

    Note that on iOS this functionality requires the IDFA (Advertising Identifier) and you must declare this if you
    submit the app to Apple. Apple will ask if you use the IDFA and what you use it for. For install tracking with
    Facebook Ads you MUST tick "Attribute this app installation to a previously served advertisement" and "Attribute an
    action taken within this app to a previously served advertisement". If you are also using AdMob, Amazon Ads, or
    Chartboost in your app then you must also tick "Serve advertisements within the app".
...
def facebook_destroy_like_button() -> None:
    """
...
def facebook_download_friends_photo(index: int) -> None:
    """
    Download the specified friends photo.

    This command is currently only supported on iOS and Android.

    :param int index: Index for the player starting at 0.
    :rtype: None
    """
    pass

def facebook_get_access_token() -> str:
    """
    Returns the Facebook access token that was generated when the user logged in.

    This can be used in HTTP calls to the Facebook graph API.

    :rtype: str
    """
    pass

def facebook_get_friends() -> None:
    """
    Get a list of friends for the user logged in.

    This command is currently only supported on iOS and Android. Facebook recently modified the way this command works
    so it will only return the friends that also have your app installed.

    :rtype: None
    """
    pass

def facebook_get_friends_count() -> int:
    """
...
def facebook_get_friends_id(index: int) -> str:
    """
...
def facebook_get_friends_name(index: int) -> str:
    """
...
def facebook_get_friends_state() -> int:
    """
    Returns:
     * 1 when the list of friends has been downloaded,
     * 0 if the download is in progress, or
     * -1 if an error occurred during download.
...
def facebook_get_user_name() -> str:
    """
...
def facebook_invite_friend(id: str, message: str) -> None:
    """
    This command is not currently supported.

    :param str id: ID of the friend.
    :param str message: The message.
    :rtype: None
    """
    pass

def facebook_login() -> None:
    """
    Call this to start the process of logging in to Facebook.

    If the user is already logged in nothing will happen when calling this command. This command is currently only
...
def facebook_post_on_friends_wall(id: str, link: str, picture: str, name: str, caption: str,
                                  description: str) -> None:
    """
    Post a message on the wall of a friend.

    This will display a dialog where the user can enter a specific message. This command is currently only supported on
    iOS and Android.

    :param str id: ID of the friend.
    :param str link: Link to a URL, this must match the URL given to Facebook in the Website with Facebook Login
        section.
    :param str picture: Link to a picture.
    :param str name: Name to be displayed.
    :param str caption: Caption.
    :param str description: Description of post.
    :rtype: None
    """
    pass

def facebook_post_on_my_wall(link: str, picture: str, name: str, caption: str,
                             description: str) -> None:
    """
    ...
    The more recently added commands `share_image()` and `share_text()` may be a better alternative to this command.
    They will open a dialog box giving the user the option to share via various installed apps, including Facebook.
...
def facebook_setup(id: str) -> None:
    """
    Set up facebook.

    Pass in the AppID given to you by Facebook when you set up your app. This will work on Android, but on iOS you must
    also change the Info.plist file, read part 5 of http: developers.facebook.com/docs/getting-started/facebook-sdk-for-
    ios/3.1/ This command is currently only supported on iOS and Android.

    :param str id: Your Facebook app ID.
    :rtype: None
    """
    pass

def facebook_show_like_button(url: str, x: int, y: int, width: int, height: int) -> None:
    """
    This command is not currently supported.

    :param str url: URL that you want to like.
    :param int x: X position of like button.
    :param int y: Y position of like button.
    :param int width: Width of like button.
    :param int height: Height of like button.
    :rtype: None
    """
    pass
...
'''*EXCLUDED*
def game_center_achievements_reset() -> None:
    """
    Not yet functional.
...
def game_center_login() -> None:
    """
    Call this once to log the user in to Game Center, if they are already logged in to the Game Center app then this
    happens in the background and does not interrupt the user, otherwise a popup will appear asking them to log in.
...
def game_center_submit_achievement(achievement_id: str, percentage_complete: int) -> None:
    ...
    The iPercentageComplete values should be between 0 and 100. However, for incremental achievements this value is
...
def get_facebook_download_file() -> str:
    """
...
def get_facebook_download_state() -> int:
    """
    Returns
     * 0 when nothing is happening,
     * 1 when downloading is taking place,
     * 2 when the download has finished, or
...
def get_facebook_logged_in() -> int:
    """
    Returns:
     * 1 if the user is logged in to Facebook,
     * 0 if not, or
     * -1 if an error occurred during login.
...
def get_game_center_exists() -> bool:
    """
    Returns True if the current platform supports Game Center.
...
def get_game_center_logged_in() -> int:
    """
    Will return 1 if the user is logged in to Game Center, 0 if not.
...
def get_in_app_purchase_available(id: int) -> bool:
    """
...
def get_in_app_purchase_description(id: int) -> str:
    """
...
def get_in_app_purchase_local_price(id: int) -> str:
    """
...
def get_in_app_purchase_signature(id: int) -> str:
    """
    ...
    :param int id: The ID of the product to check. e.g. your first product ID is 0, your second is 1 etc.
    :rtype: str
    """
    pass
...
def get_local_notification_exists(id: int) -> bool:
    """
...
def get_local_notification_message(id: int) -> str:
    """
...
def get_local_notification_time(id: int) -> int:
    """
...
'''*EXCLUDED*
def get_notification() -> bool:
    """
    Returns a value of True if a notification has been received.

    This command is currently only supported on iOS.
...
def get_notification_data() -> str:
    """
    Get data associated with a notification.
...
'''*EXCLUDED*
def get_notification_type() -> int:
    """
    Returns a value representing the type of notification that has been received.
...
def in_app_purchase_activate(id: int) -> None:
    """
...
def in_app_purchase_add_product_id(id: str, consumable: Union[bool, int]) -> None:
    """
    ...
    :param str id: The product ID as specified in iTunes Connect or the Google Play developer console.
...
def load_shared_variable(name: str, default_value: str) -> str:
    ...
    This only works on iOS and Android platforms, and apps can only share a variable if they meet certain requirements
    ...
    On Android the apps must have the WRITE_EXTERNAL_STORAGE permission and have the same package name up to the last
    dot. For example com.mycompany.mygroup.myapp1 and com.mycompany.mygroup.myapp2 would be able to share variables. On
    Android shared variables are written to a user accessible location, so be aware that users may be able to read
...
'''*EXCLUDED*
def notification_create(date_time: str, message: str, data: str) -> None:
    """
    Create a notification.

    This command is currently only supported on iOS.

    :param str date_time: Date and time in format "dd-MM-yyyy HH:mm:ss". Controls when the notification is triggered.
    :param str message: Message that the notification will display.
    :param str data: Associated data that the app retrieves when this notification is received.
    :rtype: None
    """
    pass
'''
...
'''*EXCLUDED*
def notification_reset() -> None:
    """
    Reset the state and data associated with a notification.
...
def rate_app(id: str, title: Optional[str]=None, message: Optional[str]=None) -> None:
    """
    Displays a dialog box asking the user to rate the app on the App Store.

    Currently this command is only supported on iOS.

    :param str id: This is the ID of your app. You can obtain this from iTunes Connect.
...
def set_local_notification(id: int, datetime: int, message: str) -> None:
    """
    ...
    notification will display to the user and tapping on it will open up your app. The datetime parameter should be
    specified in unix time, which is measured in seconds since 1st Jan 1970, you can use the command `get_unix_time()`
    to return the current date and time then modify it as needed. If the date and time is in the past then the
    notification will be ignored, it will not overwrite any existing notification. The ID must be in the range 1 to 50
    inclusive.

    :param int id: The ID to use to reference this notification in future.
...
'''*EXCLUDED*
def set_notification_image(id: int) -> None:
    """
    Sends the specified image to the device's notification system.

    This command is not yet functional.

    :param int id: The image to send.
    :rtype: None
    """
    pass
'''
...
'''*EXCLUDED*
def set_notification_text(text: str) -> None:
    """
    Sends the specified text to the device's notification system.
...
def set_push_notification_keys(data1: str, reserved: str) -> None:
    """
    Sets some extra key information for using push notifications.

    For Android this will be your project number, e.g. "210280671980", for iOS this is not used. If used, this must be
    called before `push_notification_setup()`.

    :param str data1: Your key data.
    :param str reserved: Not currently used, must be an empty string.
    :rtype: None
    """
    pass
...
'''*EXCLUDED*
def twitter_message(message: str) -> None:
    """
    Send the specified message using Twitter.

    If the user is not logged into Twitter then this command will take care of the login process. This command is not
    currently supported on any platform.

    :param str message: The message to post to Twitter.
    :rtype: None
    """
    pass
'''
...
'''*EXCLUDED*
def twitter_setup(key: str, secret: str) -> None:
    """
    Set up Twitter access with your application key and secret.

    This command is not currently supported on any platform.

    :param str key: You need to supply your Twitter app ouath key.
    :param str secret: You need to supply your Twitter app ouath secret.
    :rtype: None
    """
    pass
'''
...
def add_zip_entry(id: int, filename: str, path: str) -> None:
    """
    Adds a local file into the zip file.

    The path variable is the path to the local file, the zipPath variable is the path that will be used inside the zip
    file, this is the only way to add folders to the zip file (by adding a file with a zipPath such as
    "folder1/myfile.txt").
    ...
    :param int id: The ID of the zip file to add to.
    :param str filename: The path of the file to add.
    :param str path: The path for the file inside the zip.
    :rtype: None
    """
    pass

def choose_raw_file(ext: str, full_path: Union[bool, int]=False) -> str:
    """
    ...
    If you set full_path to True then the file will not be copied to the write folder, instead the full path will be
    returned to you and you can load it using the "raw:" prefix with the normal file commands.

    :param str ext: The extensions to allow.
    :param Optional[Union[bool, int]] full_path: True to return the full path, False to copy it to the write folder and
        return the write folder path.
    :rtype: str
    """
    pass

def close_file(id: int) -> None:
    """
    Closes a file and clears the ID used to create it, no further file commands can be called with this ID.

    :param int id: The ID of the file to close.
    :rtype: None
    """
    pass

def close_raw_folder(id: int) -> None:
    """
    ...
    :param int id: The ID of the folder to close.
    :rtype: None
    """
    pass

def close_zip(id: int) -> None:
    """
    Closes a zip file opened with `create_zip()`.

    This finalizes the zip and allows it to be opened for extraction.

    :param int id: The ID of the zip file to close.
    :rtype: None
    """
    pass
...
def create_zip(filename: str, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The ID used to reference this zip file.
    :rtype: int
    """
    pass
...
def extract_zip(filename: str, path: str) -> None:
    """
...
def file_eof(id: int) -> bool:
    """
    Returns True if the given file has reached the end of its data stream, False otherwise.

    Only used when reading.

    :param int id: The ID of the file to check.
    :rtype: bool
    """
    pass

def file_is_open(id: int) -> bool:
    """
...
def get_current_dir() -> str:
    """
    This command is deprecated and has been replaced with `get_folder()`.
...
def get_documents_path() -> str:
    ...
    "C:\\Users\\Me\\AppData" on Windows, "/home/user/.config" on Linux, and a protected app data folder on Android. The
    documents path is guaranteed to be visible to the user, for example on Android it will be the sdcard folder. Only
    iOS can't provide a publicly accessible location to write to.
...
def get_file_count(mode: int=2) -> int:
    ...
    :param Optional[int] mode: 0 to count only files in the read folder, 1 to only count the write folder, 2 to count
        both.
    :rtype: int
    """
    pass
...
def get_first_file(mode: int=2) -> str:
    """
    Returns the name of the first file found in the current folder, which is set using `set_folder()`.

    You can call `get_next_file()` to continue down the list of files in the current folder. Returns an empty string if
    ...
    :param Optional[int] mode: 0 to only return files from the read folder, 1 to only return files from the write
        folder, 2 for both (default).
    :rtype: str
    """
    pass
'''
...
def get_first_folder(mode: int=2) -> str:
    """
    Returns the name of the first folder found in the current folder, which is set using `set_folder()`.

    You can call `get_next_folder()` to continue down the list of folders in the current folder. Returns an empty string
    if there are no folders in the current folder. Does not include . or .. Note that there is a known limitation on
    Android that any folders within the "assets" folder cannot be found using this command. You may be able to work
    around this by using `make_folder()` to create the same folder structure in the write folder which AGK can then use
    to find files in the assets folder with `get_first_file()`.
    ...
    :param Optional[int] mode: 0 to only return folders from the read folder, 1 to only return folders from the write
        folder, 2 for both (default).
    :rtype: str
    """
    pass
...
def get_folder_count(mode: int=2) -> int:
    """
    Returns the number of folders in the current folder.

    Does not include . or ..

    :param Optional[int] mode: 0 to count only folders in the read folder, 1 to only count the write folder, 2 to count
        both (default).
    :rtype: int
    """
    pass
...
def get_next_file() -> str:
    """
    Returns the name of the next file found in the current folder, which is set using `set_folder()`.

    `get_first_file()` must have been called first for this to work, any call to `set_folder()` or `open_to_write()`
    will require starting again with `get_first_file()`.
...
def get_raw_folder_num_files(id: int) -> int:
    """
...
def get_raw_folder_num_folders(id: int) -> int:
    """
...
def open_raw_folder(path: str) -> int:
    ...
    text "raw:" or not, both are accepted. This command will return an ID that you can use to access the file list that
    was found, it will remain accessible until you close it with `close_raw_folder()`. Multiple folders can be open at
    the same time, they will each be given a different ID.
...
def open_to_read(filename: str, id: int=0) -> int:
    r"""
    ...
    the GPIO pin number, for example `open_to_read("gpio:4", id=1)`, this is case sensitive. You can then use
    `read_byte()` to read from the pin and `close_file()` to close the pin.

    :param str filename: The filename to open for reading.
    :param Optional[int] id: The ID to use for referencing this file later.
    :rtype: int
    """
    pass

def open_to_write(filename: str, append: Union[bool, int]=False, id: int=0) -> int:
    r"""
    ...
    the GPIO pin number, for example `open_to_write("gpio:4", id=1)`, this is case sensitive. You can then use
    ...
    :param Optional[Union[bool, int]] append: Set to True to append to the file, False to overwrite all data (optional,
        default False).
    :param Optional[int] id: The ID to use to reference this file later.
    :rtype: int
    """
    pass

def read_byte(id: int) -> int:
    """
    Reads a 1 byte unsigned integer (0-255) from the given file, which must have been opened for reading.

    :param int id: The ID of the file to read.
    :rtype: int
    """
    pass

def read_float(id: int) -> float:
    """
...
'''*DEPRECATED*
def set_current_dir(path: str) -> int:
    """
    This command is deprecated and has been replaced with `set_folder()`.

    :param str path: The directory to use as the new current directory.
    :rtype: int
    """
    pass
'''
...
def set_file_pos(id: int, position: int) -> None:
    """
...
def set_folder(path: str) -> bool:
    ...
    :param str path: The new folder path.
    :rtype: bool
    """
    pass
...
'''*DEPRECATED*
def set_raw_write_path(path: str) -> None:
    """
    Sets the folder where files created by AGK will be stored.

    This has no effect on iOS since it cannot write outside its app folder. You can set this to any absolute path on the
    device, however some locations, such as the Program Files folder on Windows, will require administrator privileges
    to write to them. Some locations will be protected by the operating system, `set_raw_write_path()` will let you set
    the path to these locations but any attempt to write to them will fail. You can use `get_documents_path()` to get
    the system defined documents folder for the current user, or sdcard folder on Android, which is guaranteed to allow
    write access.

    This command is now deprecated. The preferred method of accessing files outside of the usual write folder is to use
    the `open_raw_folder()` commands and "raw:" file paths.
...
def write_byte(id: int, value: int) -> None:
    """
    ...
    :param int id: The ID of the file to modify.
    :param int value: The byte to write.
    :rtype: None
    """
    pass

def write_float(id: int, value: float) -> None:
    """
    ...
    :param int id: The ID of the file to modify.
    :param float value: The float to write.
    :rtype: None
    """
    pass

def write_integer(id: int, value: int) -> None:
    """
...
def write_line(id: int, text: str) -> None:
    r"""
...
def write_string(id: int, text: str) -> None:
    """
...
def write_string2(id: int, text: str) -> None:
    """
...
def load_font(name: str, id: int=0) -> int:
    """
    Loads a font file into AGK, typically in the TrueType format, but anything supported by FreeType should work.

    The filename parameter can either be a font file located in your media folder or the name of a system font, this
    ...
    :param Optional[int] id: The ID to use to reference this font in future.
    :rtype: int
    """
    pass

def close_http_connection(id: int) -> None:
    """
    Closes the connection to the server, further connections can be created if you call `set_http_host()` again.

    :param int id: The ID of the connection to close.
    :rtype: None
    """
    pass
...
def delete_http_connection(id: int) -> None:
    """
...
def get_http_file(id: int, server_filename: str, local_filename: str,
                  post_data: Optional[str]=None) -> int:
    """
    ...
    :param int id: The ID of the connection to use.
...
def get_http_file_complete(id: int) -> bool:
    """
    ...
    :param int id: The ID of the connection to check.
    :rtype: bool
    """
    pass

def get_http_file_progress(id: int) -> float:
    """
...
def get_http_response(id: int) -> str:
    """
...
def get_http_response_ready(id: int) -> int:
    """
...
def http_encode(text: str) -> str:
    ...
    additional variables inside the string you want to send. Using HTTPEncode on this string would turn these characters
    into POST safe values which are then automatically converted back to their original characters once they reach
    something like a PHP script. This uses standard URL encoding for non-alphanumeric characters leaving alphanumeric
    characters alone.
...
def send_http_file(id: int, server_filename: str, post_data: str, local_filename: str) -> int:
    """
    Send a file to the server specified in `set_http_host()`, for example if requesting http:
    www.thegamecreators.com/index.php szServerFile should be "index.php".
...
def send_http_request(id: int, server_filename: str, post_data: Optional[str]=None) -> str:
    """
...
def send_http_request_async(id: int, server_filename: str, post_data: Optional[str]=None) -> int:
    """
    Send a request to the server specified in `set_http_host()`, for example if requesting http:
    www.thegamecreators.com/index.php szServerFile should be "index.php".
...
def set_http_host(id: int, host: str, secure: Union[bool, int], username: Optional[str]=None,
    ...
    :param int id: The ID of the connection to set.
...
def set_http_timeout(id: int, milliseconds: int) -> None:
    """
...
def set_http_verify_certificate(id: int, enabled: int) -> None:
    """
...
def copy_image(image_id: int, x: int, y: int, width: int, height: int, id: int=0) -> int:
    """
    ...
    :param int image_id: The ID of the image to copy.
    ...
    :param Optional[int] id: The ID of the new image to create, this image must not exist.
    :rtype: int
    """
    pass

def create_image_color(red: int, green: int, blue: int, alpha: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The image ID to use for this image.
    :rtype: int
    """
    pass

def create_render_image(width: int, height: int, mode: int, mipmap: Union[bool, int],
                        id: int=0) -> int:
    """
    ...
    :param int mode: 0 (IMAGE_RGBA)=RGBA (32bit), 1 (IMAGE_DEPTH)=Depth.
...
def decode_qr_code(id: int) -> str:
    ...
    :param int id: The ID of the image to decode, can be an image captured from the camera.
    :rtype: str
    """
    pass
...
'''*DEPRECATED*
def get_captured_image() -> int:
    """
    This function has been deprecated, use `set_device_camera_to_image()` instead.

    Returns the ID of a newly captured image created using `show_image_capture_screen()`.

    If this returns 0 then the user cancelled the process or you have not yet started it with
    `show_image_capture_screen()`. Once you have called this command to retrieve the image ID it will return 0 until
    `show_image_capture_screen()` is called again.
...
def get_device_camera_type(id: int) -> int:
    """
    Returns:
    ...
    :param int id: The ID of the device camera you want to check.
    :rtype: int
    """
    pass

def get_image(x: float, y: float, width: float, height: float, id: int=0) -> int:
    """
    ...
    different devices. For example, with a virtual resolution of 480x320, you would get an image of the full screen by
    calling this command with a width of 480 and a height of 320, but on an iPhone this would produce an image of
    480x320 pixels, whilst on an iPad it would be around 1024x768 pixels. This should not effect how you use the image
    as applying it to a sprite and setting the sprite size to the same 480x320 will make the sprite fill the screen in
    both cases. It simply means that on the iPad you have a higher quality image to play with.
    ...
    When drawing transparent sprites and using `get_image()` on them AGK has to undo the blending of the sprite with the
    background color to retrieve an image that can be used again in future transparent sprites. As such you should not
    call `set_clear_color()` unless you intend to call `clear_screen()` immediately after it.

    :param float x: The x coordinate of the top left corner of the box to copy.
    :param float y: The y coordinate of the top left corner of the box to copy.
    :param float width: The width of the box to copy.
    :param float height: The height of the box to copy.
    :param Optional[int] id: The image number that will contain the image captured.
    :rtype: int
    """
    pass

def get_image_exists(id: int) -> bool:
    """
    Returns True if the image exists, False if not.

    :param int id: The ID of the image to check.
    :rtype: bool
    """
    pass
...
def get_image_height(id: int) -> float:
    """
...
def get_image_width(id: int) -> float:
    """
...
def get_num_device_cameras() -> int:
    """
    Returns the number of cameras available for `set_device_camera_to_image()`.
...
'''*DEPRECATED*
def is_capturing_image() -> bool:
    """
    This function has been deprecated, use `set_device_camera_to_image()` instead.

    Returns True if AGK is currently displaying a camera feed and waiting for the user to capture an image.

    When this returns False the user has either cancelled or captured an image, check `get_captured_image()` to see what
    the result was.
...
def load_image(filename: str, black_to_alpha: Union[bool, int]=False, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: ID number for the image.
    :rtype: int
    """
    pass

def load_image_resized(filename: str, scale_x: float, scale_y: float, id: int=0) -> int:
    """
    ...
    :param float scale_x: The amount to scale in the X direction, 1.0 is the original size.
    :param float scale_y: The amount to scale in the Y direction, 1.0 is the original size.
    :param Optional[int] id: The ID to use to reference this image in future.
    :rtype: int
    """
    pass

def load_subimage(parent_id: int, name: str, id: int=0) -> int:
    """
    ...
    :param str name: The name of the sub image as stored in subimages.txt. Do not use a path before the filename.
    :param Optional[int] id: The image ID to use to reference this image later.
    :rtype: int
    """
    pass

def print_image(id: int, size: float) -> None:
    """
    ...
    :param int id: The ID of the image to print.
    :param float size: The amount of space to use on the page, between 0 and 100.
    :rtype: None
    """
    pass

def resize_image(id: int, width: int, height: int) -> None:
    """
    ...
    :param int id: The ID of the image to resize.
...
def save_image(id: int, filename: str) -> None:
    """
    ...
    :param int id: The ID of the image to change.
    :param str filename: The filename of the saved image.
    :rtype: None
    """
    pass

def set_device_camera_to_image(id: int, image_id: int) -> bool:
    """
    Using an image ID greater than zero will stream the device camera to the chosen image.

    The image must not currently exist, it will be created by this command. Use an imageID of 0 to stop streaming, this
    will also delete the image.

    The cameraID parameter is used when the device has multiple cameras, for example front and back facing cameras.
    Typically 0 refers the back facing camera. Use `get_num_device_cameras()` to see how many cameras this device has
    and `get_device_camera_type()` to check whether it is front or back facing. This parameter is ignored if the imageID
    is 0.

    You can only have one device camera active at once, so to switch from back to front facing cameras you must first
    call this command with imageID set to 0 to stop the capture, then start it again with the new cameraID.
    ...
    :param int id: The ID of the device camera you want to use, could be back or front facing camera.
    :param int image_id: The imageID you want to use for this image, must not exist.
    :rtype: bool
    """
    pass

def set_image_mag_filter(id: int, mode: int) -> None:
    """
...
def set_image_min_filter(id: int, mode: int) -> None:
    """
...
'''*EXCLUDED*
def set_image_save_pixels(enabled: Union[bool, int]) -> None:
    """
    By default image pixel data is compressed and saved in RAM so that future image manipulation commands have direct
    access to the pixel data.

    If you do not use the image manipulation commands like `copy_image()`, `set_image_mask()`, etc, or use them
    infrequently then you can turn this off to fall back to a slower method of getting the pixel data (from the GPU) and
    save some memory instead.

    :param Union[bool, int] enabled: False to turn pixel saving off, True to turn it on (default).
    :rtype: None
    """
    pass
'''
...
def set_image_transparent_color(id: int, red: int, green: int, blue: int) -> None:
    """
...
def set_image_wrap_u(id: int, wrap_mode: int) -> None:
    """
...
def set_image_wrap_v(id: int, wrap_mode: int) -> None:
    """
...
'''*DEPRECATED*
def show_image_capture_screen() -> bool:
    """
    This function has been deprecated, use `set_device_camera_to_image()` instead.

    Presents the user with an option to take a photo with the device camera, if available.

    If the device does not have a camera, or otherwise cannot be used, this will return False and your app will continue
    as normal. This does not immediately capture the image, depending on the platform your app may continue running in
    the background whilst the user is taking a photo, or it may pause execution whilst the photo is taken. In any case
    you must assume your app continues running but is no longer visible, use `is_capturing_image()` to check when the
    user returns from the image capture process, and `get_captured_image()` to discover the result of the process. This
    does not currently work on Mac.
...
def add_virtual_button(id: int, x: float, y: float, size: float) -> None:
    """
    ...
    :param int id: The ID of the virtual button to create, must be in the range 1 to 100.
    :param float x: The x position of the center of the button in screen coordinates.
    :param float y: The y position of the center of the button in screen coordinates.
    :param float size: The diameter of the button in screen coordinates.
    :rtype: None
    """
    pass

def add_virtual_joystick(id: int, x: float, y: float, size: float) -> None:
    """
    ...
    :param int id: The ID of the virtual joystick to create, must be in the range 1 to 4.
    :param float x: The x position of the center of the joystick in screen coordinates.
    :param float y: The y position of the center of the joystick in screen coordinates.
    :param float size: The diameter of the joystick in screen coordinates.
    :rtype: None
    """
    pass

def create_edit_box(id: int=0) -> int:
    """
    Create an edit box that can be positioned anywhere on screen.

    It returns the ID used to reference this edit box later.

    :param Optional[int] id: The ID to use for this edit box.
    :rtype: int
    """
    pass

def delete_edit_box(id: int) -> None:
    """
...
def delete_virtual_button(id: int) -> None:
    """
    Deletes the virtual button at the given index.

    No further virtual button commands can be called on this index unless it is recreated using `add_virtual_button()`.

    :param int id: The ID of the virtual button to delete.
    :rtype: None
    """
    pass

def delete_virtual_joystick(id: int) -> None:
    """
    Deletes a virtual joystick and removes it from screen.

    No further virtual joystick commands can be called on this index unless it is recreated using
    `add_virtual_joystick()`.

    :param int id: The ID of the virtual joystick to delete.
    :rtype: None
    """
    pass

def fix_edit_box_to_screen(id: int, fixed: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
...
def get_button_pressed(id: int) -> bool:
    """
    ...
    :param int id: The ID of the button to check, must be in the range 1 to 5 inclusive.
    :rtype: bool
    """
    pass

def get_button_released(id: int) -> bool:
    """
...
def get_button_state(id: int) -> int:
    """
...
def get_edit_box_active(id: int) -> bool:
    """
    Returns True if the edit box is enabled and can be clicked on, False if the edit box is disabled and cannot be
    changed.

    :param int id: The ID of the edit box to check.
    :rtype: bool
    """
    pass

def get_edit_box_changed(id: int) -> bool:
    """
...
def get_edit_box_cursor_position(id: int) -> int:
    """
...
def get_edit_box_exists(id: int) -> bool:
    """
...
def get_edit_box_has_focus(id: int) -> bool:
    """
...
def get_edit_box_height(id: int) -> float:
    """
...
def get_edit_box_lines(id: int) -> int:
    """
...
def get_edit_box_text(id: int) -> str:
    """
...
def get_edit_box_visible(id: int) -> bool:
    """
...
def get_edit_box_width(id: int) -> float:
    """
...
def get_edit_box_x(id: int) -> float:
    """
...
def get_edit_box_y(id: int) -> float:
    """
...
def get_virtual_button_exists(id: int) -> bool:
    """
    Returns True if a virtual button exists at the given index, False otherwise.

    :param int id: The ID of the virtual button to check.
    :rtype: bool
    """
    pass

def get_virtual_button_pressed(id: int) -> bool:
    """
...
def get_virtual_button_released(id: int) -> bool:
    """
...
def get_virtual_button_state(id: int) -> int:
    """
...
def get_virtual_joystick_exists(id: int) -> bool:
    """
    Returns True if a virtual joystick exists at the given index.

    Must be in the range 1 to 4.

    :param int id: The ID of the virtual joystick to check.
    :rtype: bool
    """
    pass

def get_virtual_joystick_x(id: int) -> float:
    """
    Returns the X value of the virtual joystick at the given index.

    This will be in the range -1.0 to 1.0 with 0 being centered. When the user is not interacting with the virtual
    joystick this will return 0.
...
def get_virtual_joystick_y(id: int) -> float:
    """
    Returns the Y value of the virtual joystick at the given index.
...
def set_button_screen_position(id: int, x: float, y: float, size: float) -> None:
    """
    ...
    :param int id: The ID of the button to position, must be in the range 1 to 5 inclusive.
    :param float x: The X coordinate of the button position in screen coordinates.
    :param float y: The Y coordinate of the button position in screen coordinates.
    :param float size: The diameter of the button position in screen coordinates.
    :rtype: None
    """
    pass

def set_cursor_blink_time(seconds: float) -> None:
    """
...
def set_edit_box_active(id: int, active: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID to modify.
    :param Union[bool, int] active: The new state of the edit box, True for active, False for inactive.
    :rtype: None
    """
    pass

def set_edit_box_background_color(id: int, red: int, green: int, blue: int, alpha: int) -> None:
    """
...
def set_edit_box_background_image(id: int, image_id: int) -> None:
    """
...
def set_edit_box_border_color(id: int, red: int, green: int, blue: int, alpha: int) -> None:
    """
...
def set_edit_box_border_image(id: int, image_id: int) -> None:
    """
...
def set_edit_box_border_size(id: int, size: float) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
    :param float size: The size of the border.
    :rtype: None
    """
    pass

def set_edit_box_cursor_blink_time(id: int, seconds: float) -> None:
    """
...
def set_edit_box_cursor_color(id: int, red: int, green: int, blue: int) -> None:
    """
...
def set_edit_box_cursor_position(id: int, position: int) -> None:
    """
...
def set_edit_box_cursor_width(id: int, width: float) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
    :param float width: The new width of the cursor.
    :rtype: None
    """
    pass

def set_edit_box_depth(id: int, depth: int) -> None:
    """
...
def set_edit_box_extended_font_image(id: int, image_id: int) -> None:
    """
...
def set_edit_box_focus(id: int, focus: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
    :param Union[bool, int] focus: The new focus state of the edit box, True to set focus, False to lose focus.
    :rtype: None
    """
    pass

def set_edit_box_font(id: int, font_id: int) -> None:
    """
...
def set_edit_box_font_image(id: int, image_id: int) -> None:
    """
...
def set_edit_box_max_chars(id: int, maximum: int) -> None:
    """
...
def set_edit_box_max_lines(id: int, maximum: int) -> None:
    """
...
def set_edit_box_multiline(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_edit_box_password_mode(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_edit_box_position(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
    :param float x: The X value of the position.
    :param float y: The Y value of the position.
    :rtype: None
    """
    pass

def set_edit_box_scissor(id: int, x1: float, y1: float, x2: float, y2: float) -> None:
    """
    Clips the edit box to the specified world coordinates when drawn.

    :param int id: The ID of the edit box to modify.
    :param float x1: The x coordinate of the top left corner of the box to use as a clip boundary.
    :param float y1: The y coordinate of the top left corner of the box to use as a clip boundary.
    :param float x2: The x coordinate of the bottom right corner of the box to use as a clip boundary.
    :param float y2: The y coordinate of the bottom right corner of the box to use as a clip boundary.
    :rtype: None
    """
    pass

def set_edit_box_size(id: int, width: float, height: float) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
    :param float width: The width of the new size.
    :param float height: The height of the new size.
    :rtype: None
    """
    pass

def set_edit_box_text(id: int, text: str) -> None:
    """
...
def set_edit_box_text_color(id: int, red: int, green: int, blue: int) -> None:
    """
...
def set_edit_box_text_size(id: int, size: float) -> None:
    """
    ...
    :param int id: The ID of the edit box to modify.
    :param float size: The new size of font to use.
    :rtype: None
    """
    pass

def set_edit_box_use_alternate_input(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_edit_box_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def set_edit_box_wrap_mode(id: int, mode: int) -> None:
    """
...
def set_joystick_dead_zone(threshold: float) -> None:
    """
    ...
    :param float threshold: The value below which 0 will be returned.
    :rtype: None
    """
    pass

def set_joystick_screen_position(x: float, y: float, size: float) -> None:
    """
    The AGK joystick is an emulated input method that uses whatever device inputs are available to produce a joystick
    style input in the range -1 to 1.
    ...
    :param float x: The X coordinate of the new position in screen coordinates.
    :param float y: The Y coordinate of the new position in screen coordinates.
    :param float size: The diameter of the joystick in screen coordinates.
    :rtype: None
    """
    pass
...
def set_virtual_button_active(id: int, active: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the virtual button to set.
    :param Union[bool, int] active: True to accept input, False to deactivate it.
    :rtype: None
    """
    pass

def set_virtual_button_alpha(id: int, alpha: int) -> None:
    """
    Sets the transparency of the virtual button at the given index.

    The alpha value should be in the range 0-255 where 255 is fully opaque.
...
def set_virtual_button_color(id: int, red: int, green: int, blue: int) -> None:
    """
    Sets the color of the virtual button at the given index.

    By default buttons are greyscale so that they can accept various colors. Colors should be specified in the range
    0-255.
...
def set_virtual_button_image_down(id: int, image_id: int) -> None:
    """
...
def set_virtual_button_image_up(id: int, image_id: int) -> None:
    """
...
def set_virtual_button_position(id: int, x: float, y: float) -> None:
    """
...
def set_virtual_button_size(id: int, width: float, height: Optional[float]=None) -> None:
    """
    Sets the size of the virtual button in screen coordinates.

    :param int id: The ID of the virtual button to set.
    :param float width: The new X size of the button in screen coordinates.
    :param Optional[float] height: The new Y size of the button in screen coordinates. If not given, it will match the
        width.
    :rtype: None
    """
    pass

def set_virtual_button_text(id: int, text: str) -> None:
    """
...
def set_virtual_button_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def set_virtual_joystick_active(id: int, active: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the virtual joystick to set.
    :param Union[bool, int] active: True to allow input, False to deactivate it.
    :rtype: None
    """
    pass

def set_virtual_joystick_alpha(id: int, outer: int, inner: int) -> None:
    """
    Sets the transparency of the virtual joystick on screen.

    The virtual joystick is composed of two parts the inner movable part, and the outer static part. The outer parameter
    sets the transparency of the outer part in the range 0-255 with 255 being fully opaque. The inner parameter sets the
    transparency of the inner part in the range 0-255.
...
def set_virtual_joystick_dead_zone(threshold: float) -> None:
    """
...
def set_virtual_joystick_image_inner(id: int, image_id: int) -> None:
    """
...
def set_virtual_joystick_image_outer(id: int, image_id: int) -> None:
    """
...
def set_virtual_joystick_position(id: int, x: float, y: float) -> None:
    """
...
def set_virtual_joystick_size(id: int, size: float) -> None:
    """
    ...
    :param int id: The ID of the virtual joystick to set.
    :param float size: The new diameter of the joystick in screen coordinates.
    :rtype: None
    """
    pass

def set_virtual_joystick_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
'''*EXCLUDED*
def get_nfc_exists() -> bool:
    """
    Returns True if the current device has an NFC device built-in, otherwise False is returned.
...
def get_raw_first_touch_event(include_unknown: int) -> int:
    ...
    receive unknown events as well set include_unknown to True. Use False to ignore unknown events. All you can be sure
    about with unknown events is that the finger is currently on screen and has been there less than 1 second. After 1
    second it automatically becomes a hold event. If the user lifts their finger off the screen it becomes a short
    event, and if they move their finger it becomes a drag event. If no events are available it returns 0.
...
def get_raw_joystick_button_pressed(id: int, button: int) -> bool:
    """
    ...
    :param int id: The ID of the joystick to check.
    :param int button: The ID of the button to check.
    :rtype: bool
    """
    pass

def get_raw_joystick_button_released(id: int, button: int) -> bool:
    """
...
def get_raw_joystick_button_state(id: int, button: int) -> int:
    """
...
def get_raw_joystick_connected(id: int) -> bool:
    """
...
def get_raw_joystick_exists(id: int) -> bool:
    """
    Returns True if a joystick exists at the given index.

    Physical joysticks are detected at startup and placed in IDs 1-8 incrementally. You should call
    `complete_raw_joystick_detection()` at some point before this command to make sure that all present joysticks have
    been discovered. After the initial detection process plugging in additional joysticks will not be detected (except
    on Android which will detect new joysticks). Unplugging a joystick will not delete its index and this command will
    still return 1. You can use `get_raw_joystick_connected()` to detect when a previously detected joystick is
    disconnected. If a disconnected joystick is reattached the AGK will attempt to reconnect to it.
...
def get_raw_joystick_rx(id: int) -> float:
    """
    Returns the current rotational X value (if applicable) for the physical joystick at the given index.

    This will be in the range -1.0 to 1.0 with 0 being centered. In reality some joystick devices use this value for a
...
def get_raw_joystick_ry(id: int) -> float:
    """
...
def get_raw_joystick_rz(id: int) -> float:
    """
...
def get_raw_joystick_x(id: int) -> float:
    """
...
def get_raw_joystick_y(id: int) -> float:
    """
...
def get_raw_joystick_z(id: int) -> float:
    """
    Returns the current Z value (if applicable) for the physical joystick at the given index.
...
def get_raw_key_state(key: int) -> int:
    """
    Returns 1 (SATE_DOWN) if the key code given is currently down, 0 (STATE_UP) if it is up.

    This only applies to platforms with a full sized keyboard such as PC and Mac, otherwise all keys will return 0
    (STATE_UP). You can check if a keyboard exists by checking `get_keyboard_exists()` returns 1. Key codes are in the
    range 0 to 255, anything out of range will return 0 (STATE_UP). Check out the scan codes page in the guides section
    of the help files to see which key matches which key code.
...
def get_raw_last_key() -> int:
    ...
    This only applies to platforms with a full sized keyboard such as PC and Mac. You can check if a keyboard exists by
    using `get_keyboard_exists()`. This function continue to return the last key pressed even when the key has been
    released. Check out the scan codes page in the guides section of the help files to see which key matches which key
    code.
...
def get_raw_mouse_right_state() -> int:
    """
    Returns 1 (STATE_DOWN)if the right mouse button is currently down, 0 (STATE_UP) if not.
...
def get_raw_touch_count(include_unknown: Union[bool, int]) -> int:
    ...
    :param Union[bool, int] include_unknown: True to count unknown events which may become any type of touch event in
        the future.
    :rtype: int
    """
    pass
...
def get_raw_touch_type(index: int) -> int:
    ...
    1 second. After 1 second it automatically becomes a hold event. If the user lifts their finger off the screen it
    becomes a short event, and if they move their finger it becomes a drag event. If no events are available it returns
    0. Events may change from being hold events to being drag events, but short and drag events do not change type.
    Unknown events are guaranteed to change type once more information is available.

    Possible return values are:
     * 0 (TOUCH_DEFAULT) to indicate a default touch,
...
def set_raw_joystick_dead_zone(threshold: float) -> None:
    """
...
def set_raw_mouse_position(x: float, y: float) -> None:
    """
    ...
    :param float x: The X component of the new mouse position.
    :param float y: The Y component of the new mouse position.
    :rtype: None
    """
    pass
...
def create_vector3(x: float=0.0, y: float=0.0, z: float=0.0) -> int:
    """
    Creates a vector and fills it with the values passed in.

    Returns a vector ID.

    :param Optional[float] x: The value for X in the vector (default: 0).
    :param Optional[float] y: The value for Y in the vector (default: 0).
    :param Optional[float] z: The value for Z in the vector (default: 0).
    :return: A vector ID.
    :rtype: int
    """
    pass

def delete_vector3(id: int) -> None:
    """
    Deletes the Vector.

    :param int id: ID of vector.
    :rtype: None
    """
    pass

def get_vector3_add(result_vector: int, add_vector: int) -> None:
    """
    Fills the result vector with the result of adding another vector to itself.

    :param int result_vector: ID of the vector to add and hold results.
    :param int add_vector: ID of vector to add.
    :rtype: None
    """
    pass

def get_vector3_cross(result_vector: int, vector1: int, vector2: int) -> None:
    """
    Fills the result vector with the cross product of 2 vectors passed in.

    :param int result_vector: ID of vector for results.
    :param int vector1: ID of the first vector.
    :param int vector2: ID of the second vector.
    :rtype: None
    """
    pass

def get_vector3_distance(vector1: int, vector2: int) -> float:
    """
...
def get_vector3_dot(vector1: int, vector2: int) -> float:
    """
...
def get_vector3_length(id: int) -> float:
    """
    Returns the length of the vector.

    :param int id: ID of the vector.
    :rtype: float
    """
    pass

def get_vector3_multiply(id: int, multiplier: float) -> None:
    """
    Multiplies the components of the vector ID by the given multiplier.

    :param int id: ID of the vector to multiply.
    :param float multiplier: Float value to multiply by.
    :rtype: None
    """
    pass

def get_vector3_x(id: int) -> float:
    """
...
def get_vector3_y(id: int) -> float:
    """
...
def get_vector3_z(id: int) -> float:
    """
...
def set_vector3(id: int, x: float, y: float, z: float) -> None:
    """
    Fills the specified vector.

    :param int id: ID of Vector.
    :param float x: The x value for the vector.
    :param float y: The y value for the vector.
    :param float z: The z value for the vector.
    :rtype: None
    """
    pass
...
def create_file_from_memblock(filename: str, id: int) -> None:
    """
    ...
    :param int id: The ID of the memblock to read, the memblock is unaffected by this command.
    :rtype: None
    """
    pass

def create_image_from_memblock(memblock_id: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The ID of the image to create or modify.
    :rtype: int
    """
    pass

def create_memblock(size: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The ID of the memblock you want to use.
    :rtype: int
    """
    pass

def create_memblock_from_file(filename: str, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The ID of the memblock to create.
    :rtype: int
    """
    pass

def create_memblock_from_image(image_id: int, id: int=0) -> int:
    """
...
def create_memblock_from_object_mesh(object_id: int, mesh: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The ID of the new memblock.
    :rtype: int
    """
    pass

def create_memblock_from_sound(sound_id: int, id: int=0) -> int:
    """
...
def create_object_from_mesh_memblock(memblock_id: int, id: int=0) -> int:
    """
...
def create_sound_from_memblock(memblock_id: int, id: int=0) -> int:
    """
    ...
    :param int memblock_id: The ID of the memblock to read, the memblock is unaffected by this command.
    :param Optional[int] id: The ID of the sound to create or modify.
    :rtype: int
    """
    pass

def delete_memblock(id: int) -> None:
    """
    ...
    :param int id: The ID of the memblock to delete.
    :rtype: None
    """
    pass

def get_memblock_byte(id: int, offset: int) -> int:
    """
...
def get_memblock_exists(id: int) -> bool:
    """
...
def get_memblock_float(id: int, offset: int) -> float:
    """
...
def get_memblock_int(id: int, offset: int) -> int:
    """
    ...
    2 as 0, and the byte at offset 3 as 0. The returned value will be a signed int between -2,147,483,648 and
    2,147,483,647.
...
def get_memblock_short(id: int, offset: int) -> int:
    """
...
def get_memblock_size(id: int) -> int:
    """
...
def get_memblock_string(id: int, offset: int, length: int) -> str:
    """
    ...
    :param int id: The ID of the memblock to check.
    :param int offset: The offset from the start of the memblock of the value to return, between 0 and size.
    :param int length: The length of the memblock to return.
    :rtype: str
    """
    pass

def get_mesh_memblock_vertex_alpha(id: int, vertex: int) -> int:
    """
...
def get_mesh_memblock_vertex_blue(id: int, vertex: int) -> int:
    """
...
def get_mesh_memblock_vertex_green(id: int, vertex: int) -> int:
    """
...
def get_mesh_memblock_vertex_normal_x(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_normal_y(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_normal_z(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_red(id: int, vertex: int) -> int:
    """
...
def get_mesh_memblock_vertex_u(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_v(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_x(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_y(id: int, vertex: int) -> float:
    """
...
def get_mesh_memblock_vertex_z(id: int, vertex: int) -> float:
    """
...
def set_memblock_byte(id: int, offset: int, value: int) -> None:
    """
    ...
    :param int id: The ID of the memblock to modify.
...
def set_memblock_byte_signed(id: int, offset: int, value: int) -> None:
    """
    Writes a single byte value at the given offset.
...
def set_memblock_float(id: int, offset: int, value: float) -> None:
    """
...
def set_memblock_int(id: int, offset: int, value: int) -> None:
    """
...
def set_memblock_short(id: int, offset: int, value: int) -> None:
    """
...
def set_memblock_string(id: int, offset: int, value: str) -> None:
    """
...
def set_mesh_memblock_vertex_color(id: int, vertex: int, red: int, green: int, blue: int,
                                   alpha: int) -> None:
    """
...
def set_mesh_memblock_vertex_normal(id: int, vertex: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the memblock to modify.
    :param int vertex: The index of the vertex to modify.
    :param float x: The X component of the new normal for this vertex.
    :param float y: The Y component of the new normal for this vertex.
    :param float z: The Z component of the new normal for this vertex.
    :rtype: None
    """
    pass

def set_mesh_memblock_vertex_position(id: int, vertex: int, x: float, y: float, z: float) -> None:
    """
    ...
    :param int id: The ID of the memblock to modify.
    :param int vertex: The index of the vertex to modify.
    :param float x: The new X position for this vertex.
    :param float y: The new Y position for this vertex.
    :param float z: The new Z position for this vertex.
    :rtype: None
    """
    pass

def set_mesh_memblock_vertex_uv(id: int, vertex: int, u: float, v: float) -> None:
    """
    ...
    :param int id: The ID of the memblock to modify.
    :param int vertex: The index of the vertex to modify.
    :param float u: The new U value for this vertex.
    :param float v: The new V value for this vertex.
    :rtype: None
    """
    pass
...
def add_network_message_float(id: int, value: float) -> None:
    """
    Adds a float to a previously created network message.

    This can only be called on messages created by `create_network_message()`, using this function on messages received
    from the network is undefined.

    :param int id: The ID of the message to modify.
    :param float value: The value to add to the meessage.
    :rtype: None
    """
    pass

def add_network_message_integer(id: int, value: int) -> None:
    """
    ...
    :param int id: The ID of the message to modify.
    :param int value: The value to add to the meessage.
    :rtype: None
    """
    pass

def add_network_message_string(id: int, value: str) -> None:
    """
    ...
    :param int id: The ID of the message to modify.
    :param str value: The string to add to the meessage.
    :rtype: None
    """
    pass

def close_network(id: int) -> None:
    """
    Disconnects from the specified network.

    The ID is freed and can no longer be used in other network commands.

    :param int id: The ID of the network to disconnect from.
    :rtype: None
    """
    pass

def connect_socket(ip: str, port: int, timeout: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: An ID to use to reference this socket later.
    :rtype: int
    """
    pass

def create_broadcast_listener(port: int=45631, ipv6: Optional[str]=None) -> int:
    """
    ...
    :param Optional[int] port: The port that the messages are being broadcast on, in the case of AGK networks this will
        be port 45631.
    :param Optional[str] ipv6: The multicast IP to listen for, only applies to IPv6 networks, if left empty then it will
        listen for IPv4 broadcasts.
    :rtype: int
    """
    pass
...
def create_socket_listener(ip: str, port: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: An ID to use to reference this listener in the future.
    :rtype: int
    """
    pass

def delete_broadcast_listener(id: int) -> None:
    """
    Deletes a broadcast listener and frees up the port for something else to listen on it.

    :param int id: The ID of the broadcast listener to delete.
    :rtype: None
    """
    pass
...
def delete_network_message(id: int) -> None:
    """
    ...
    :param int id: The ID of the message to read.
    :rtype: None
    """
    pass

def delete_socket(id: int) -> None:
    """
    Deletes the socket ID so it can be used again.

    If the socket is currently connected then the connection is closed first.

    :param int id: The ID of the socket to delete.
    :rtype: None
    """
    pass

def delete_socket_listener(id: int) -> None:
    """
    ...
    :param int id: The ID of the listener to check.
    :rtype: None
    """
    pass

def flush_socket(id: int) -> bool:
    """
    ...
    :param int id: The ID of the socket to check.
    :rtype: bool
    """
    pass

def get_broadcast_message(id: int) -> int:
    """
    ...
    :param int id: The ID of the broadcast listener to check.
    :rtype: int
    """
    pass
...
def get_network_client_disconnected(network_id: int, client_id: int) -> int:
    """
...
def get_network_client_name(network_id: int, client_id: int) -> str:
    ...
    All client names must be unique and this is enforced by the host.
...
def get_network_exists(id: int) -> bool:
    """
    Returns True if a network exists at the given ID, otherwise it returns False.

    :param int id: The ID of the network to check.
    :rtype: bool
    """
    pass

def get_network_first_client(id: int) -> int:
    """
...
def get_network_message(id: int) -> int:
    """
    ...
    :param int id: The ID of the network to check for messages.
    :rtype: int
    """
    pass

def get_network_message_float(id: int) -> float:
    """
    Gets a single float from the message and advances the message pointer to the next message item.

    This can only be called on messages received from network devices, calling it on messages created locally will
    result in undefined behaviour. Messages should be created and read according to known formats, e.g. string, int,
    string as there is no immediate way for the receiver to know the format of a message. You could use an initial
    integer to specify a message type ID which you can use to identify the message format.
...
def get_network_message_from_client(id: int) -> int:
    """
    Returns the client ID that sent this message.

    Only applicable to messages received from networks, broadcast listener messages will return 0 for this function. It
    will also return 0 for messages created using `create_network_message()`.
...
def get_network_message_from_ip(id: int) -> str:
    """
    Returns the IP that sent this message.

    Only applicable to messages received from broadcast listeners, network messages will return an empty string for this
    function. It will also return an empty string for messages created using `create_network_message()`. This could be
...
def get_network_message_integer(id: int) -> int:
    """
...
def get_network_message_string(id: int) -> str:
    """
...
def get_network_my_client_id(id: int) -> int:
    """
...
def get_network_next_client(id: int) -> int:
    """
...
def get_network_num_clients(id: int) -> int:
    """
...
def get_network_server_id(id: int) -> int:
    """
...
def get_socket_byte(id: int) -> int:
    """
    ...
    :param int id: The ID of the socket to read.
    :rtype: int
    """
    pass

def get_socket_bytes_available(id: int) -> int:
    """
...
def get_socket_connected(id: int) -> int:
    """
...
def get_socket_exists(id: int) -> bool:
    """
...
def get_socket_float(id: int) -> float:
    """
...
def get_socket_integer(id: int) -> int:
    """
...
def get_socket_listener_connection(id: int) -> int:
    """
...
def get_socket_remote_ip(id: int) -> str:
    """
...
def get_socket_string(id: int) -> str:
    """
...
def host_network(my_name: str, network_name: str, port: int, portv6: int=0) -> int:
    """
    ...
    If you specify 0 for the port then it will disable IPv4 connections, if you set portv6 to 0 then it will disable
    IPv6 connections. At least one must be greater than 0 or an error will be generated. If you do not specify portv6 at
    all then it will be set to 0. It should be safe to use the same port for both IPv4 and IPv6, but this hasn't been
    widely tested.
...
def is_network_active(id: int) -> bool:
    """
...
def join_network(my_name: str, network_name: Optional[str]=None, ip: Optional[str]=None,
    ...
    attempt a direct connection to the host the host. In the case of internet connections an IP and port is the only way
    to connect as broadcasts will not leave the local area network. IP addresses can be IPv4 or IPv6 depending on what
    IP addresses the host is using (it could have one or more of each).
    ...
    :param str my_name: The name to use in identifying this client.
    :param Optional[str] network_name: The name of the network to connect to.
    :param Optional[str] ip: The IP address of the host to connect to, can be IPv4 or IPv6.
...
def send_socket_byte(id: int, value: int) -> bool:
    """
    ...
    :param int id: The ID of the socket to write.
    :param int value: The value to send.
    :rtype: bool
    """
    pass

def send_socket_float(id: int, value: float) -> bool:
    """
    ...
    :param int id: The ID of the socket to write.
    :param float value: The value to send.
    :rtype: bool
    """
    pass

def send_socket_integer(id: int, value: int) -> bool:
    """
...
def send_socket_string(id: int, value: str) -> bool:
    """
...
def set_network_allow_clients(id: int) -> None:
    """
    ...
    :param int id: The ID of the network to modify.
    :rtype: None
    """
    pass
...
def set_network_latency(id: int, latency: int) -> None:
    """
    ...
    :param int id: The ID of the network to disconnect from.
    :param int latency: How often the network sends and checks for updates in milliseconds.
    :rtype: None
    """
    pass

def set_network_local_float(id: int, name: str, value: float, mode: int=0) -> None:
    """
    ...
    :param float value: The value to set this variable to.
    :param Optional[int] mode: The type of this variable, 0 (NETWORK_VAR_TYPE_NORMAL)=normal, 1
        (NETWORK_VAR_TYPE_RESETTING)=resetting.
    :rtype: None
    """
    pass

def set_network_local_integer(id: int, name: str, value: int, mode: int=0) -> None:
    """
    Sets a local integer variable for this client by name.

    Other clients can then read this variable by using the same name when requesting its value. An integer variable may
    not have the same name as a float variable. If the variable with that name does not exist it is created.
...
def set_network_no_more_clients(id: int) -> None:
    """
...
'''*DEPRECATED*
def delete_music(id: int) -> None:
    """
    Deletes a music file from the playlist.

    :param int id: The ID of the music to delete.
    :rtype: None
    """
    pass
'''
...
def delete_music_ogg(id: int) -> None:
    """
    Deletes the music file and frees up the ID to be used again.

    :param int id: The ID of the music file to delete.
    :rtype: None
    """
    pass
...
'''*DEPRECATED*
def get_music_duration(id: int) -> float:
    """
    Returns the number of seconds it will take to play the given music file from start to finish.

    There must be no sounds playing for this command to work, or the given ID must be the track currently playing. For
    example if you try to get the duration of ID 2 and ID 1 is currently playing then it will fail, but if ID 2 is
    currently playing it will succeed. For variable bit rate files this command will return an approximation.
...
def get_music_duration_ogg(id: int) -> float:
    """
    Returns the duration of the music file in seconds as a floating point value.

    :param int id: The ID of the music file to check.
    :rtype: float
    """
    pass
...
'''*DEPRECATED*
def get_music_exists(id: int) -> bool:
    """
    Returns True if a music file exists at the current ID, False if not.
...
def get_music_exists_ogg(id: int) -> bool:
    """
...
def get_music_loop_count_ogg(id: int) -> int:
    """
...
'''*DEPRECATED*
def get_music_playing() -> int:
    """
    Returns the ID of the currently playing music file.

    If no music is playing it returns 0.
...
def get_music_playing_ogg(id: int) -> bool:
    """
...
def get_music_position() -> float:
    """
    Returns the number of seconds played of the current music file.

    If no music is currently playing this command will return 0.
...
def get_music_position_ogg(id: int) -> float:
    """
...
'''*DEPRECATED*
def load_music(filename: str, id: int=0) -> int:
    """
    Loads a music file from the application media folder into a specified ID.

    File paths must be relative, not absolute, you cannot load music files from elsewhere on the disk. It returns the ID
    of the music file for referencing it later. The recommended format for cross platform compatibility is MP3.

    Please note that the Meego platform does not currently support MP3, it will instead attempt to load an OGG Vorbis
    file. For example, if you attempt to load "music.mp3", on Meego this will be interpreted as "music.ogg".

    The ID must be in the range 1 to 50.

    :param str filename: The filename of the music file to load.
    :param Optional[int] id: The music number to store the music.
    :rtype: int
    """
    pass
'''
...
def load_music_ogg(filename: str, id: int=0) -> int:
    """
    Loads a music file compressed with OGG Vorbis.

    This is supported on all platforms as is the new preferred way of playing music, replacing the `load_music()`
    command. Multiple OGG music files can be played at the same time. OGG music file IDs are separate from normal music
    file IDs and are not limited to a specific range of numbers.

    :param str filename: The filename of the music file to load.
    :param Optional[int] id: The ID to use to refer to this music file.
    :rtype: int
    """
    pass
...
def pause_music_ogg(id: int) -> None:
    """
    Pauses the music file.

    `get_music_playing_ogg()` will continue to return True.

    :param int id: The ID of the music file to pause.
    :rtype: None
    """
    pass
...
'''*DEPRECATED*
def play_music(id: Optional[int]=None, loop: Optional[Union[bool, int]]=None,
               start_id: Optional[int]=None, end_id: Optional[int]=None) -> None:
    """
    Plays the given music file only and loops it if desired.

    This is a change from previous versions where AGK would continue playing the next music track after this one. Now
    you must use the additional parameters of `play_music()` to play tracks one after the other.

    Only one music file may be playing at any one time.

    :param Optional[int] id: The music file to start with.
    :param Optional[Union[bool, int]] loop: True to loop forever, False to stop after the last ID.
    :param Optional[int] start_id: The ID to return to when looping from the end to the beginning of the file list.
    :param Optional[int] end_id: The ID after which it should loop back to the beginning.
    :rtype: None
    """
    pass
'''
...
def play_music_ogg(id: int, loop: int=1) -> None:
    """
    Plays the music file.

    Multiple OGG music files can be playing at the same time.

    :param int id: The ID of the music file to play.
    :param Optional[int] loop: The number of times to loop, or 1 to loop forever. (optional, default 1)
    :rtype: None
    """
    pass
...
def resume_music_ogg(id: int) -> None:
    """
...
'''*DEPRECATED*
def seek_music(seconds: float, mode: int) -> None:
    """
    Seeks the currently playing music to the specified number of seconds, either relative to the current position or an
    absolute position.

    For example if the music track is 60 seconds long and is currently at a position of 10 seconds (it has played 10
    seconds of music), seeking to an absolute value of 3 seconds will take it back to 3 seconds after the start of the
    music track. Using a relative value of 3 will add 3 seconds to the current position, taking it to 13.

    :param float seconds: The number of seconds to seek to.
    :param int mode: 0 (SEEK_ABSOLUTE) to use an absolute position, 1 (SEEK_RELATIVE) to use a relative position.
    :rtype: None
    """
    pass
'''
...
def seek_music_ogg(id: int, seconds: float, mode: int) -> None:
    """
    ...
    :param int id: The ID of the music file to seek.
    :param float seconds: The time in seconds to seek to.
...
'''*DEPRECATED*
def set_music_file_volume(id: int, volume: int) -> None:
    """
    Sets the volume on a per file basis, this volume level is combined with the music system volume to create the final
    volume.

    By default files are played at volume 100. The volume level should be between 0 and 100.

    :param int id: The music number to set.
...
def set_music_loop_count_ogg(id: int, loop: int) -> None:
    """
    ...
    :param int id: The ID of the music file to change.
    :param int loop: The number of times to loop, 0 to stop looping.
    :rtype: None
    """
    pass

def set_music_loop_times_ogg(id: int, start_time: float, end_time: float) -> None:
    """
    ...
    :param int id: The ID of the music file to change.
    :param float start_time: The time in seconds to return to at the beginning of a loop.
    :param float end_time: The time in seconds to end the loop and return to the start.
    :rtype: None
    """
    pass
...
'''*DEPRECATED*
def set_music_system_volume(volume: int) -> None:
    """
    Sets the master volume of the music player, in the range 0 to 100.

    :param int volume: The new volume value to use.
    :rtype: None
    """
    pass
'''
...
def set_music_volume_ogg(id: int, volume: int) -> None:
    """
    Sets the volume on a per file basis.

    By default files are played at volume 100. The volume level should be between 0 and 100.

    :param int id: The ID of the music file to modify.
    :param int volume: The volume to use for this file.
    :rtype: None
    """
    pass
...
def stop_music() -> None:
    """
    Stops any playing music, the music can then only be restarted by calling `play_music()`.
...
def stop_music_ogg(id: int) -> None:
    """
    Stops the music file and resets its position to the beginning of the file.

    :param int id: The ID of the music file to stop.
    :rtype: None
    """
    pass

def add_particles_color_key_frame(id: int, time: float, red: int, green: int, blue: int,
                                  alpha: int) -> None:
    """
    Adds a color change at a certain point in a particle's life.
...
def add_particles_force(id: int, start_time: float, end_time: float, x: float, y: float) -> None:
    """
    Adds a force that will act at a given time in every particle's life.
...
def add_particles_scale_key_frame(id: int, time: float, scale: float) -> None:
    """
    Adds a size change at a certain point in a particle's life.
...
def clear_particles_colors(id: int) -> None:
    """
    Clears all colors that have been assigned to the emitter, the particles will maintain whatever color they currently
    have.
...
def clear_particles_forces(id: int) -> None:
    """
    Clears all forces assigned to this emitter.
...
def clear_particles_scales(id: int) -> None:
    """
    Clears all size modifiers that have been assigned to the emitter, the particles will maintain whatever size they
    currently are.
...
def create_particles(x: float, y: float, id: int=0) -> int:
    """
    ...
    :param float x: The x coordinate to position this emitter.
    :param float y: The y coordinate to position this emitter.
    :param Optional[int] id: The ID to use when referencing this particle emitter.
    :rtype: int
    """
    pass

def delete_particles(id: int) -> None:
    """
...
def fix_particles_to_screen(id: int, fixed: Union[bool, int]) -> None:
    """
...
def get_particles_active(id: int) -> bool:
    """
...
def get_particles_angle(id: int) -> float:
    """
...
def get_particles_angle_rad(id: int) -> float:
    """
...
def get_particles_depth(id: int) -> int:
    """
...
def get_particles_direction_x(id: int) -> float:
    """
    Returns the X component of the emitter direction, which is the base direction that particles will be moving when
    they are created.
...
def get_particles_direction_y(id: int) -> float:
    """
    Returns the y component of the emitter direction, which is the base direction that particles will be moving when
    they are created.
...
def get_particles_exists(id: int) -> bool:
    """
...
def get_particles_frequency(id: int) -> float:
    """
    Returns the current frequency of particle generation in particles per second.
...
def get_particles_life(id: int) -> float:
    """
    Returns the current life of particles in seconds.
...
def get_particles_max_reached(id: int) -> bool:
    """
...
def get_particles_size(id: int) -> float:
    """
    Returns the current size of all particles in world coordinates.
...
def get_particles_visible(id: int) -> bool:
    """
...
def get_particles_x(id: int) -> float:
    """
    Returns the current X position of the emitter, this is the point that new particles will appear from.
...
def get_particles_y(id: int) -> float:
    """
    Returns the current Y position of the emitter, this is the point that new particles will appear from.
...
def offset_particles(id: int, x: float, y: float) -> None:
    """
    Immediately moves all existing particles by the given offset.
...
def reset_particle_count(id: int) -> None:
    """
    Resets the emitted particle count when the emitter has been set with a maximum number of particles using
    `set_particles_max()`.
...
def set_particles_active(id: int, active: Union[bool, int]) -> None:
    """
    Sets whether the emitted particles are updated every frame.
...
def set_particles_angle(id: int, angle: float) -> None:
    """
    Sets the range of direction in degrees that a particle can choose when it first starts.
    ...
    :param int id: The ID of the emitter to modify.
    :param float angle: The range of variation a particle can choose from the emitter direction.
    :rtype: None
    """
    pass

def set_particles_angle_rad(id: int, angle: float) -> None:
    """
...
def set_particles_color_interpolation(id: int, mode: int) -> None:
    """
    Sets the interpolation mode for color changes.
...
def set_particles_depth(id: int, depth: int) -> None:
    """
...
def set_particles_direction(id: int, x: float, y: float) -> None:
    """
    Sets the initial direction of new particles when they emerge from the emitter.
    ...
    the vector as units per second. For example if the initial direction is x=10, y=-15, particles will begin by moving
    to the right at a rate of 10 units per second and upwards at a rate of 15 units per second and will continue this
    rate of motion for their entire life unless influenced by forces added with `add_particles_force()`.

    :param int id: The ID of the emitter to modify.
    :param float x: The x direction that particles will move initially.
    :param float y: The y direction that particles will move initially.
    :rtype: None
    """
    pass

def set_particles_face_direction(id: int, mode: int) -> None:
    """
...
def set_particles_frequency(id: int, frequency: float) -> None:
    """
    Sets the frequency of new particle generation.
    ...
    :param int id: The ID of the emitter to modify.
    :param float frequency: The rate of new particle production in particles per second.
    :rtype: None
    """
    pass

def set_particles_image(id: int, image_id: int) -> None:
    """
    Sets the image to use for each particle.
...
def set_particles_life(id: int, time: float) -> None:
    """
...
def set_particles_max(id: int, maximum: int) -> None:
    """
    Sets the maximum number of particles that will be emitted.
...
def set_particles_position(id: int, x: float, y: float) -> None:
    """
...
def set_particles_rotation_range(id: int, minimum: float, maximum: float) -> None:
    """
    Sets the range of rotation in radians that a particle can have during its life.

    When a particle is created it starts at angle 0 and chooses and random rotation rate between minimum and maximum.
    The particle will then rotate at that chosen rate for its entire life. Use negative values for counter-clockwise
    rotation and positive for clockwise rotation.

    :param int id: The ID of the emitter to modify.
    :param float minimum: The minimum angle of the range in degrees per second.
    :param float maximum: The maximum angle of the range in degrees per second.
    :rtype: None
    """
    pass

def set_particles_rotation_range_rad(id: int, minimum: float, maximum: float) -> None:
    """
    Sets the range of rotation in radians that a particle can have during its life.
    ...
    :param int id: The ID of the emitter to modify.
    :param float minimum: The minimum angle of the range in radians per second.
    :param float maximum: The maximum angle of the range in radians per second.
    :rtype: None
    """
    pass

def set_particles_size(id: int, size: float) -> None:
    """
    Sets the size of all particles in world coordinates.
...
def set_particles_start_zone(id: int, x1: float, y1: float, x2: float, y2: float) -> None:
    """
    Sets the area around the emitter where new particles may appear.
...
def set_particles_transparency(id: int, mode: int) -> None:
    """
    Set the particle transparency to a particular setting, with a choice of no transparency, alpha transparency, and
    additive blending.
...
def set_particles_velocity_range(id: int, minimum: float, maximum: float) -> None:
    """
    Sets a minimum and maximum multiplier that will affect particles being emitted.
    ...
    :param int id: The ID of the emitter to modify.
    :param float minimum: The minimum velocity multiplier.
    :param float maximum: The maximum velocity multiplier.
    :rtype: None
    """
    pass

def set_particles_visible(id: int, visible: Union[bool, int]) -> None:
    """
    Sets whether the emitted particles are drawn.
...
def update_particles(id: int, time: float) -> None:
    """
    Immediately advances the particle emitter by the given amount of time.
...
def create_skeleton_2d(id: int=0) -> int:
    """
    ...
    :param Optional[int] id: ID to use to reference this skeleton.
    :rtype: int
    """
    pass

def delete_skeleton_2d(id: int) -> None:
    """
...
def get_skeleton_2d_bone(id: int, name: str) -> int:
    """
...
def get_skeleton_2d_bone_angle(id: int, bone: int) -> float:
    """
...
def get_skeleton_2d_bone_curr_angle(id: int, bone: int) -> float:
    """
...
def get_skeleton_2d_bone_curr_x(id: int, bone: int) -> float:
    """
...
def get_skeleton_2d_bone_curr_y(id: int, bone: int) -> float:
    """
...
def get_skeleton_2d_bone_parent(id: int, bone: int) -> int:
    """
...
def get_skeleton_2d_bone_x(id: int, bone: int) -> float:
    """
...
def get_skeleton_2d_bone_y(id: int, bone: int) -> float:
    """
...
def get_skeleton_2d_current_time(id: int) -> float:
    """
...
def get_skeleton_2d_exists(id: int) -> bool:
    """
...
def get_skeleton_2d_is_animating(id: int) -> bool:
    """
...
def get_skeleton_2d_is_tweening(id: int) -> bool:
    """
...
def get_skeleton_2d_x(id: int) -> float:
    """
...
def get_skeleton_2d_y(id: int) -> float:
    """
...
def load_skeleton_2d_from_spine_file(filename: str, scale: float, atlas_id: int,
                                     load_animation: Union[bool, int], id: int=0) -> int:
    """
    ...
    :param float scale: The amount to scale the object sizes.
    ...
    :param Optional[int] id: ID to use for this skeleton.
    :rtype: int
    """
    pass

def load_skeleton_2d_from_spriter_file(filename: str, scale: float, atlas_id: int=0,
                                       id: int=0) -> int:
    """
...
def play_skeleton_2d_animation(id: int, name: str, start_time: float, loop: int,
                               tween_time: float) -> None:
    """
    ...
    :param float start_time: An optional offset into the animation to skip some frames.
    :param int loop: 1 to loop the animation until stopped, 0 to play it once, greater than 1 to loop that many times.
    :param float tween_time: Number of seconds to transition from its current state before animating.
    :rtype: None
    """
    pass

def set_skeleton_2d_animation_frame(id: int, name: str, time: float, tween_time: float) -> None:
    """
    ...
    :param float time: The time offset to use to set the frame of the skeleton.
    :param float tween_time: Number of seconds to transition from its current state to the given frame.
    :rtype: None
    """
    pass

def set_skeleton_2d_animation_speed(id: int, speed: float) -> None:
    """
    Sets the animation speed (Default 1.0), negative values are allowed to reverse the animation.

    :param int id: ID of the skeleton to modify.
    :param float speed: The speed of the animation with 1.0 being normal speed.
    :rtype: None
    """
    pass

def set_skeleton_2d_bone_angle(id: int, bone: int, angle: float) -> None:
    """
    ...
    :param float angle: The new angle to use in degrees.
    :rtype: None
    """
    pass

def set_skeleton_2d_bone_mode(id: int, bone: int, animate: Union[bool, int]) -> None:
    """
...
def set_skeleton_2d_bone_position(id: int, bone: int, x: float, y: float) -> None:
    """
    ...
    :param float x: The new X position to use.
    :param float y: The new Y position to use.
    :rtype: None
    """
    pass

def set_skeleton_2d_bone_scale(id: int, bone: int, x: float, y: float) -> None:
    """
    ...
    :param int id: ID of the skeleton to modify.
    :param int bone: ID of the bone to modify.
    :param float x: The new X scale value to use.
    :param float y: The new Y scale value to use.
    :rtype: None
    """
    pass

def set_skeleton_2d_depth(id: int, depth: int) -> None:
    """
...
def set_skeleton_2d_flip(id: int, horizontal: Union[bool, int], vertical: int) -> None:
    """
    ...
    :param int vertical: True to flip the skeleton in the vertical axis, False for no flip.
    :rtype: None
    """
    pass

def set_skeleton_2d_position(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: ID of the skeleton to modify.
    :param float x: The X position of the skeleton.
    :param float y: The Y position of the skeleton.
    :rtype: None
    """
    pass

def set_skeleton_2d_rotation(id: int, angle: float) -> None:
    """
    Sets the angle of the root of the skeleton, the bone angles will be relative to this angle.

    :param int id: ID of the skeleton to modify.
    :param float angle: The angle to use in degrees.
    :rtype: None
    """
    pass

def set_skeleton_2d_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def stop_skeleton_2d_animation(id: int) -> None:
    """
...
def get_sound_instance_playing(id: int) -> bool:
    """
...
def get_sound_instance_rate(id: int) -> float:
    """
...
def get_sound_instances(id: int) -> int:
    """
...
def get_sound_instance_volume(id: int) -> int:
    """
...
def get_sounds_playing(id: int) -> int:
    """
    Returns the number of instances of this sound ID that are currently playing or looping.
...
def is_speaking() -> bool:
    """
    Returns True if `speak()` has been called and the text has not yet finished.

    If multiple items of text have been queued up then this command will continue to return True until all of them have
    been spoken, or `stop_speaking()` is called.
...
def load_sound(filename: str, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The sound number to store the sound.
    :rtype: int
    """
    pass

def load_sound_ogg(filename: str, id: int=0) -> int:
    """
...
def play_sound(id: int, volume: int=100, loop: int=0, priority: int=0) -> int:
    """
    ...
    :param int id: The sound number to play.
    :param Optional[int] volume: The volume at which the sound should be played (optional, default 100).
...
'''*EXCLUDED*
def record_sound(filename: str) -> None:
    """
    Not yet functional.

    :param str filename: The file to save the sound to.
    :rtype: None
    """
    pass
'''
...
def save_sound(id: int, filename: str) -> None:
    """
    Saves a sound file to the application write folder.

    :param int id: The ID of the sound to save.
    :param str filename: The filename to use for the sound file, recommended it end in .wav.
    :rtype: None
    """
    pass

def set_sound_instance_balance(id: int, balance: float) -> None:
    """
    ...
    :param int id: The ID of the instance to modify.
    :param float balance: The new balance of the instance.
    :rtype: None
    """
    pass

def set_sound_instance_rate(id: int, rate: float) -> None:
    """
    ...
    :param int id: The ID of the instance to modify.
    :param float rate: The new playback rate of the instance.
    :rtype: None
    """
    pass

def set_sound_instance_volume(id: int, volume: int) -> None:
    """
...
def set_speech_language(language: str) -> None:
    ...
    If the language engine is not currently on the device then the device will attempt to download it when `speak()` is
    next called, this may introduce a delay before that text is spoken. If the download fails, or no internet connection
    is available then the default language engine for the current device will be used.
...
def set_speech_rate(rate: float) -> None:
    ...
    :param float rate: The rate to speak text, default is 1.0.
    :rtype: None
    """
    pass
...
def stop_sound(id: int) -> None:
    """
    Stop the sound currently playing at the specified sound number.

    :param int id: The sound number to stop.
    :rtype: None
    """
    pass

def stop_sound_instance(id: int) -> None:
    """
...
def vibrate_device(seconds: float) -> None:
    """
    ...
    :param float seconds: The time in seconds to vibrate.
    :rtype: None
    """
    pass

def add_sprite_animation_frame(id: int, image_id: int) -> None:
    """
    ...
    :param int id: The ID of the sprite to set for animation.
    :param int image_id: The ID of the image to add.
    :rtype: None
    """
    pass

def add_sprite_shape_box(id: int, x1: float, y1: float, x2: float, y2: float, angle: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float x1: The x coordinate of the top left corner of the new box in sprite space.
    :param float y1: The y coordinate of the top left corner of the new box in sprite space.
    :param float x2: The x coordinate of the bottom right corner of the new box in sprite space.
    :param float y2: The x coordinate of the bottom right corner of the new box in sprite space.
    :param float angle: The angle of the box in radians.
    :rtype: None
    """
    pass

def add_sprite_shape_chain(id: int, num_points: int, index: int, loop: Union[bool, int], x: float,
                           y: float) -> None:
    """
    Adds a new shape to the sprite, in addition to any it already has.
    ...
    multiple times, with index starting at 0. Once the index equals numPoints-1 then the shape will be created using the
    previously defined points. Once you start defining points you must complete the process by reaching
    index=numPoints-1 before defining points for any other shape.

    This will recalculate the sprite's mass and center of mass values.

    :param int id: The ID of the sprite to modify.
    :param int num_points: The number of points to use in the chain; minimum of 2, no maximum.
    :param int index: The index of the point to set, if it equals numPoints-1 then the shape will be created.
    :param Union[bool, int] loop: When True, the two ends of the chain are joined to create a hollow polygon.
    :param float x: X position for the specified point.
    :param float y: Y position for the specified point.
    :rtype: None
    """
    pass

def add_sprite_shape_circle(id: int, x: float, y: float, radius: float) -> None:
    """
    Adds a new shape to the sprite, in addition to any it already has.
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The x coordinate of the center of the circle in sprite space.
    :param float y: The y coordinate of the center of the circle in sprite space.
    :param float radius: The radius of the circle.
    :rtype: None
    """
    pass

def add_sprite_shape_polygon(id: int, total_points: int, point: int, x: float, y: float) -> None:
    """
    Adds a new shape to the sprite, in addition to any it already has.
    ...
    are defined one at a time by calling this command multiple times, with index starting at 0. Once the index equals
    numPoints-1 then the shape will be created using the previously defined points. Once you start defining points you
    must complete the process by reaching index=numPoints-1 before defining points for any other shape.
...
def calculate_sprite_physics_com(id: int) -> None:
    """
...
def clear_sprite_animation_frames(id: int) -> None:
    """
    ...
    :param int id: The ID of the sprite to clear.
    :rtype: None
    """
    pass

def clear_sprite_shapes(id: int) -> None:
    """
...
def clone_sprite(sprite_id: int, id: int=0) -> int:
    """
    ...
    :param int sprite_id: The ID of the sprite to copy.
    :param Optional[int] id: The ID to use for the new sprite.
    :rtype: int
    """
    pass

def create_dummy_sprite(id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The ID to use for this sprite.
    :rtype: int
    """
    pass

def create_sprite(image_id: int, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The sprite ID to use to reference this sprite later (separate from image IDs, so there can
        be both a sprite 1 and an image 1).
    :rtype: int
    """
    pass
...
def delete_sprite(id: int) -> None:
    """
    Deletes the sprite at the given ID.

    :param int id: The ID of the sprite to delete.
    :rtype: None
    """
    pass

def draw_sprite(id: int) -> None:
    """
    ...
    :param int id: The ID of the sprite to draw.
    :rtype: None
    """
    pass

def fix_sprite_to_screen(id: int, fixed: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the sprite to change.
...
def get_physics_collision(sprite_id1: int, sprite_id2: int) -> bool:
    ...
    :param int sprite_id1: The ID of the sprite to check for intersection with sprite 2.
    :param int sprite_id2: The ID of the sprite to check for intersection with sprite 1.
    :rtype: bool
    """
    pass
...
def get_sprite_collision(sprite_id1: int, sprite_id2: int) -> bool:
    ...
    used in this function, use `get_physics_collision()` instead.
...
def get_sprite_color_alpha(id: int) -> int:
    """
...
def get_sprite_color_blue(id: int) -> int:
    """
...
def get_sprite_color_green(id: int) -> int:
    """
...
def get_sprite_color_red(id: int) -> int:
    """
...
def get_sprite_current_frame(id: int) -> int:
    """
...
def get_sprite_depth(id: int) -> int:
    """
...
def get_sprite_exists(id: int) -> bool:
    """
...
def get_sprite_frame_count(id: int) -> int:
    """
...
def get_sprite_group(id: int) -> int:
    """
...
def get_sprite_height(id: int) -> float:
    """
...
def get_sprite_hit(x: float, y: float) -> int:
    """
    ...
    :param float x: The x position in world coordinates to check.
    :param float y: The y position in world coordinates to check.
    :rtype: int
    """
    pass

def get_sprite_hit_category(categories: int, x: float, y: float) -> int:
    """
    Returns the ID of the first sprite found under the point x,y in world coordinates, 0 if none.
...
def get_sprite_hit_group(group: int, x: float, y: float) -> int:
    """
    Returns the ID of the first sprite found under the point x,y in world coordinates, 0 if none.
...
def get_sprite_hit_test(id: int, x: float, y: float) -> bool:
    """
    ...
    :param int id: The sprite to test.
    :param float x: The x position in world coordinates to check.
    :param float y: The y position in world coordinates to check.
    :rtype: bool
    """
...
def get_sprite_image_id(id: int) -> int:
    """
...
def get_sprite_in_box(id: int, x1: float, y1: float, x2: float, y2: float) -> bool:
    """
    ...
    :param int id: The ID of the sprite to check.
    :param float x1: The X coordinate of the top left corner of the box in world coordinates.
    :param float y1: The Y coordinate of the top left corner of the box in world coordinates.
    :param float x2: The X coordinate of the bottom right corner of the box in world coordinates.
    :param float y2: The Y coordinate of the bottom right corner of the box in world coordinates.
    :rtype: bool
    """
    pass

def get_sprite_in_circle(id: int, x: float, y: float, radius: float) -> bool:
    """
    ...
    :param int id: The ID of the sprite to check.
    :param float x: The X coordinate of the center of the circle in world coordinates.
    :param float y: The Y coordinate of the center of the circle in world coordinates.
    :param float radius: The radius of the circle in world coordinates.
    :rtype: bool
    """
    pass

def get_sprite_num_shapes(id: int) -> int:
    """
...
def get_sprite_offset_x(id: int) -> float:
    """
...
def get_sprite_offset_y(id: int) -> float:
    """
...
def get_sprite_physics_angular_velocity(id: int) -> float:
    """
...
def get_sprite_physics_com_x(id: int) -> float:
    """
...
def get_sprite_physics_com_y(id: int) -> float:
    """
...
def get_sprite_physics_mass(id: int) -> float:
    """
...
def get_sprite_physics_velocity_x(id: int) -> float:
    """
...
def get_sprite_physics_velocity_y(id: int) -> float:
    """
...
def get_sprite_pixel_from_x(id: int, x: float) -> int:
    """
    ...
    :param int id: The ID of the sprite to check.
    :param float x: The x coordinate of the sprite point to check.
    :rtype: int
    """
    pass

def get_sprite_pixel_from_y(id: int, y: float) -> int:
    """
    Converts a point on the sprite's image to the pixel on the sprite's image that is underneath that point.
    ...
    :param int id: The ID of the sprite to check.
    :param float y: The y coordinate of the sprite point to check.
    :rtype: int
    """
    pass

def get_sprite_playing(id: int) -> bool:
    """
...
def get_sprite_scale_x(id: int) -> float:
    """
...
def get_sprite_scale_y(id: int) -> float:
    """
...
def get_sprite_transparency(id: int) -> int:
    """
...
def get_sprite_visible(id: int) -> bool:
    """
...
def get_sprite_width(id: int) -> float:
    """
...
def get_sprite_x_by_offset(id: int) -> float:
    """
...
def get_sprite_x_from_pixel(id: int, x: int) -> float:
    """
...
def get_sprite_x_from_world(id: int, x: float, y: float) -> float:
    """
    ...
    :param int id: The ID of the sprite to check.
    :param float x: The X component of the point to convert into sprite coordinates.
    :param float y: The Y component of the point to convert into sprite coordinates.
    :rtype: float
    """
    pass

def get_sprite_y(id: int) -> float:
    """
...
def get_sprite_y_by_offset(id: int) -> float:
    """
...
def get_sprite_y_from_pixel(id: int, y: int) -> float:
    """
    Converts a pixel point on the sprite's image to the point on the sprite's surface that represents where that pixel
    is.
...
def get_sprite_y_from_world(id: int, x: float, y: float) -> float:
    """
    Converts a point in world coordinates to a point on the sprite.
...
def get_world_x_from_sprite(id: int, x: float, y: float) -> float:
    """
    ...
    :param int id: The ID of the sprite to check.
    :param float x: The X component of the point on the sprite.
    :param float y: The Y component of the point on the sprite.
    :rtype: float
    """
    pass

def get_world_y_from_sprite(id: int, x: float, y: float) -> float:
    """
    Converts a point on the sprite to world coordinates.
...
def load_sprite(filename: str, id: int=0) -> int:
    """
...
def play_sprite(id: int, fps: float=10, loop: Union[bool, int]=True, from_frame: int=-1,
                to_frame: int=-1) -> None:
    """
    ...
    :param int id: The ID of the sprite to animate.
    :param Optional[float] fps: Frames per second. The number of frames the sprite should attempt to cycle through every
        second (optional, default 10).
    :param Optional[Union[bool, int]] loop: The looping mode of the sprite, False equals do not loop, True equals loop
        forever (optional, default 1).
    :param Optional[int] from_frame: The frame to begin at, frames start at 1 (optional, default -1).
    :param Optional[int] to_frame: The frame to end at, frames end at `get_sprite_frame_count()` (optional, default -1).
    :rtype: None
    """
    pass

def reset_sprite_uv(id: int) -> None:
    """
...
def resume_sprite(id: int) -> None:
    ...
    :param int id: The ID of the sprite to resume animating.
    :rtype: None
    """
    pass

def set_sprite_active(id: int, active: Union[bool, int]) -> None:
    """
...
def set_sprite_additional_image(id: int, image_id: int, stage: int) -> None:
    """
...
def set_sprite_angle(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to rotate.
    :param float angle: The angle to set the sprite in degrees.
    :rtype: None
    """
    pass

def set_sprite_angle_rad(id: int, angle: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to rotate.
    :param float angle: The angle to set the sprite in radians.
    :rtype: None
    """
    pass

def set_sprite_animation(id: int, width: int, height: int, count: int) -> None:
    """
...
def set_sprite_category_bit(id: int, category: int, enabled: Union[bool, int],
    ...
    shapeID value greater than 0. Shape IDs start at 1 for the first shape, with shapeID 0 meaning apply it to all
    shapes.
...
def set_sprite_category_bits(id: int, categories: int, shape_id: Optional[int]=None) -> None:
    """
...
def set_sprite_collide_bit(id: int, category: int, enabled: int,
                           shape_id: Optional[int]=None) -> None:
    """
...
def set_sprite_collide_bits(id: int, mask: int, shape_id: Optional[int]=None) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param int mask: The bitwise mask of categories this sprite can collide with during physics calculations.
    :param Optional[int] shape_id: The ID of the shape to change, 0 to set all the sprite's shapes to this value.
    :rtype: None
    """
    pass

def set_sprite_color(id: int, red: int, green: int, blue: int, alpha: int) -> None:
    """
...
def set_sprite_color_alpha(id: int, alpha: int) -> None:
    """
...
def set_sprite_color_blue(id: int, blue: int) -> None:
    """
...
def set_sprite_color_green(id: int, green: int) -> None:
    """
...
def set_sprite_color_red(id: int, red: int) -> None:
    """
...
def set_sprite_depth(id: int, depth: int) -> None:
    """
...
def set_sprite_flip(id: int, horizontal: Union[bool, int], vertical: Union[bool, int]) -> None:
    """
...
def set_sprite_frame(id: int, frame: int) -> None:
    """
...
def set_sprite_group(id: int, group: int, shape_id: Optional[int]=None) -> None:
    """
...
def set_sprite_image(id: int, image_id: int, update_shape: Optional[Union[bool, int]]=None) -> None:
    """
    ...
    although this is an expensive process. Using this command will clear any animation frames you have set with any of
    the sprite animation commands.
...
def set_sprite_offset(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The X distance from the top left corner to offset the rotation point.
    :param float y: The Y distance from the top left corner to offset the rotation point.
    :rtype: None
    """
    pass

def set_sprite_physics_angular_damping(id: int, damping: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float damping: The new damping value.
    :rtype: None
    """
    pass

def set_sprite_physics_angular_impulse(id: int, impulse: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float impulse: The size of the force to apply to the sprite's rotation. may be negative.
    :rtype: None
    """
    pass

def set_sprite_physics_angular_velocity(id: int, velocity: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float velocity: The new angular velocity.
    :rtype: None
    """
    pass

def set_sprite_physics_can_rotate(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_sprite_physics_com(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The x coordinate of the center of mass.
    :param float y: The y coordinate of the center of mass.
    :rtype: None
    """
    pass

def set_sprite_physics_damping(id: int, damping: float) -> None:
    """
...
def set_sprite_physics_delete(id: int) -> None:
    """
...
def set_sprite_physics_density(id: int, density: float, shape_id: int) -> None:
    """
    ...
    recalculate the mass and center of mass for this sprite. Use a shapeID of 0 to apply this density to all shapes or
    specify a shape ID greater than 0 to apply it only to that shape. Shape IDs start at 1 for the first shape.

    :param int id: The ID of the sprite to modify.
    :param float density: The new density value, default is 1.0.
    :param int shape_id: The ID of the shape to change, 0 to apply the value to all shapes.
    :rtype: None
    """
    pass

def set_sprite_physics_force(id: int, x: float, y: float, force_x: float, force_y: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The X coordinate of the force position in world coordinates.
    :param float y: The Y coordinate of the force position in world coordinates.
    :param float force_x: The X component of the force direction.
    :param float force_y: The Y component of the force direction.
    :rtype: None
    """
    pass

def set_sprite_physics_friction(id: int, friction: float, shape_id: Optional[int]=None) -> None:
    """
    ...
    can instead set it on a per shape basis by specifying a shapeID greater than 0. Shape IDs start at 1 for the first
...
def set_sprite_physics_impulse(id: int, x: float, y: float, impulse_x: float,
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The X coordinate of the impulse position in world coordinates.
    :param float y: The Y coordinate of the impulse position in world coordinates.
    :param float impulse_x: The X component of the impulse direction.
    :param float impulse_y: The Y component of the impulse direction.
    :rtype: None
    """
    pass

def set_sprite_physics_is_bullet(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_sprite_physics_is_sensor(id: int, enabled: Union[bool, int],
                                 shape_id: Optional[int]=None) -> None:
    """
...
def set_sprite_physics_mass(id: int, mass: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float mass: The new mass value.
    :rtype: None
    """
    pass

def set_sprite_physics_off(id: int) -> None:
    """
...
def set_sprite_physics_on(id: int, mode: int) -> None:
    """
...
def set_sprite_physics_restitution(id: int, restitution: float,
                                   shape_id: Optional[int]=None) -> None:
    """
    ...
    instead set it on a per shape basis by specifying a shapeID greater than 0. Shape IDs start at 1 for the first
    shape, with 0 meaning apply it to all shapes.

    :param int id: The ID of the sprite to modify.
    :param float restitution: The new restitution value.
    :param Optional[int] shape_id: The ID of the shape to change, 0 to apply the value to all shapes.
    :rtype: None
    """
    pass

def set_sprite_physics_torque(id: int, torque: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float torque: The size of the force to apply to the sprite's rotation. may be negative.
    :rtype: None
    """
    pass

def set_sprite_physics_velocity(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The x component of the new velocity.
    :param float y: The y component of the new velocity.
    :rtype: None
    """
    pass

def set_sprite_position(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to position.
    :param float x: The X coordinate to position the sprite, can use decimal values.
    :param float y: The Y coordinate to position the sprite, can use decimal values.
    :rtype: None
    """
    pass

def set_sprite_position_by_offset(id: int, x: float, y: float) -> None:
    """
    Immediately positions the specified sprite to the given X,Y world coordinates.
...
def set_sprite_scale(id: int, x: float, y: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float x: The value to scale the sprite in the X direction.
    :param float y: The value to scale the sprite in the Y direction.
    :rtype: None
    """
    pass

def set_sprite_scale_by_offset(id: int, x: float, y: float) -> None:
    """
    Sets the sprite scale as an absolute multiple of its original size.
...
def set_sprite_scissor(id: int, x1: float, y1: float, x2: float, y2: float) -> None:
    """
...
def set_sprite_shape(id: int, shape: int, shape_id: Optional[int]=None) -> None:
    """
    ...
    set shapes individually by specifying a shapeID greater than 0. Shape IDs start at 1 for the first shape, with 0
...
def set_sprite_shape_box(id: int, x1: float, y1: float, x2: float, y2: float, angle: float,
                         shape_id: Optional[int]=None) -> None:
    """
...
def set_sprite_shape_chain(id: int, total_points: int, point: int, loop: Union[bool, int], x: float,
                           y: float, shape_id: Optional[int]=None) -> None:
    """
    Overrides the current auto generated shape for use in collision detection, hit testing, and physics.
    ...
    calling this command multiple times, with index starting at 0. Once the index equals numPoints-1 then the shape will
    be created using the previously defined points. Once you start defining points you must complete the process by
    reaching index=numPoints-1 before defining points for any other shape.

    Using a shapeID of 0 removes all other shapes assigned to the sprite and replaces it with this one. You can set
    shapes individually by specifying a shapeID greater than 0. Shape IDs start at 1 for the first shape. This command
    only changes existing shapes, by default all sprites have a base shape at ID 1. You can add additional shapes by
    using `add_sprite_shape_box()`, `add_sprite_shape_chain()`, `add_sprite_shape_circle()`, and
    `add_sprite_shape_polygon()`.

    :param int id: The ID of the sprite to modify.
    :param int total_points: The number of points to use in the chain, min 2, no maximum.
    :param int point: The index of the point to set, if it equals numPoints-1 then the shape will be created.
    :param Union[bool, int] loop: True to join the two ends of the chain together, False to leave them unconnected.
    :param float x: X coordinate of the polygon to be added.
    :param float y: Y coordinate of the polygon to be added.
    :param Optional[int] shape_id: The ID of the shape to change, first shape is ID 1, 0=delete existing shapes and
        replace them with this new one.
    :rtype: None
    """
...
def set_sprite_shape_circle(id: int, x: float, y: float, radius: float,
                            shape_id: Optional[int]=None) -> None:
    """
    Overrides the current auto generated shape for use in collision detection, hit testing, and physics.
...
def set_sprite_shape_polygon(id: int, total_points: int, point: int, x: float, y: float,
                             shape_id: Optional[int]=None) -> None:
    """
    Overrides the current auto generated shape for use in collision detection, hit testing, and physics.
    ...
    from this point. Points are defined one at a time by calling this command multiple times, with index starting at 0.
    Once the index equals numPoints-1 then the shape will be created using the previously defined points. Once you start
    defining points you must complete the process by reaching index=numPoints-1 before defining points for any other
    shape.
    ...
    :param int id: The ID of the sprite to modify.
    :param int total_points: The number of points to use in the polygon, min 2, max 12.
    :param int point: The index of the point to set, if this equals numPoints-1 then the shape will be created.
    :param float x: X coordinate of the polygon to be added.
    :param float y: Y coordinate of the polygon to be added.
    :param Optional[int] shape_id: The ID of the shape to change, first shape is ID 1, 0=delete existing shapes and
        replace them with this new one.
...
def set_sprite_size(id: int, width: float, height: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to retrieve.
    :param float width: The width to use for the sprite, use -1 to have this value calculated.
    :param float height: The height to use for the sprite, use -1 to have this value calculated.
    :rtype: None
    """
    pass

def set_sprite_snap(id: int, enabled: Union[bool, int]) -> None:
    """
...
def set_sprite_speed(id: int, fps: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float fps: The rate at which the sprite should update, sprite frames will be skipped if the sprite frame rate
        is too high compared to the game frame rate.
    :rtype: None
    """
    pass

def set_sprite_transparency(id: int, mode: int) -> None:
    """
...
def set_sprite_uv(id: int, u1: float, v1: float, u2: float, v2: float, u3: float, v3: float,
                  u4: float, v4: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float u1: The U coordinate of the top left vertex.
    :param float v1: The V coordinate of the top left vertex.
    :param float u2: The U coordinate of the bottom left vertex.
    :param float v2: The V coordinate of the bottom left vertex.
    :param float u3: The U coordinate of the top right vertex.
    :param float v3: The V coordinate of the top right vertex.
    :param float u4: The U coordinate of the bottom right vertex.
    :param float v4: The V coordinate of the bottom right vertex.
    :rtype: None
    """
    pass

def set_sprite_uv_border(id: int, border: float) -> None:
    """
    ...
    :param int id: The ID of the sprite to modify.
    :param float border: 0=no border, 0.5=half pixel offset, 1=one pixel offset, etc.
    :rtype: None
    """
    pass

def set_sprite_uv_offset(id: int, u: float, v: float) -> None:
    """
    ...
    :param int id: The ID of the sprite whose UV coordinates are to be offset.
    :param float u: The amount to offset the UV coordinates in the U direction.
    :param float v: The amount to offset the UV coordinates in the V direction.
    :rtype: None
    """
    pass

def set_sprite_uv_scale(id: int, u: float, v: float) -> None:
    """
    ...
    :param int id: The ID of the sprite whose UV coordinates are to be scaled.
    :param float u: The amount to scale in the U direction.
    :param float v: The amount to scale in the V direction.
    :rtype: None
    """
    pass

def set_sprite_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def set_sprite_x(id: int, x: float) -> None:
    """
...
def set_sprite_y(id: int, y: float) -> None:
    """
...
def stop_sprite(id: int) -> None:
    """
    Stops the animation of a sprite, maintaining the values used to set it up.

    :param int id: The ID of the sprite to stop animating.
    :rtype: None
    """
    pass

def create_text(text: str, id: int=0) -> int:
    """
    ...
    :param Optional[int] id: The text ID to use to reference this text later (separate from image and sprite IDs, so
        there can be both a sprite 1 and a text 1).
    :rtype: int
    """
    pass

def delete_text(id: int) -> None:
    """
    Deletes a text object.

    :param int id: The ID of the text object to delete.
    :rtype: None
    """
    pass

def fix_text_to_screen(id: int, fixed: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the text to change.
    :param Union[bool, int] fixed: True for screen text, False for world text.
    :rtype: None
    """
    pass

def get_text_char_angle(id: int, char_index: int) -> float:
    """
...
def get_text_char_angle_rad(id: int, char_index: int) -> float:
    """
...
def get_text_char_color_alpha(id: int, char_index: int) -> int:
    """
...
def get_text_char_color_blue(id: int, char_index: int) -> int:
    """
...
def get_text_char_color_green(id: int, char_index: int) -> int:
    """
...
def get_text_char_color_red(id: int, char_index: int) -> int:
    """
...
def get_text_char_x(id: int, char_index: int) -> float:
    """
...
def get_text_char_y(id: int, char_index: int) -> float:
    """
...
def get_text_color_alpha(id: int) -> int:
    """
    Get the alpha component of the text color.

    The value will be in the range 0-255.

    :param int id: The ID of the text to check.
    :rtype: int
    """
    pass

def get_text_color_blue(id: int) -> int:
    """
...
def get_text_color_green(id: int) -> int:
    """
...
def get_text_color_red(id: int) -> int:
    """
...
def get_text_exists(id: int) -> bool:
    """
...
def get_text_hit_test(id: int, x: float, y: float) -> bool:
    """
    ...
    :param int id: The ID of the text object to check.
    :param float x: The x coordinate of the point to check in world coordinates.
    :param float y: The y coordinate of the point to check in world coordinates.
    :rtype: bool
    """
    pass

def get_text_length(id: int) -> int:
    """
    Returns the current length of the string the text object is displaying.

    :param int id: The ID of the text object to return.
    :rtype: int
    """
    pass

def get_text_line_spacing(id: int) -> float:
    """
...
def get_text_size(id: int) -> float:
    """
...
def get_text_spacing(id: int) -> float:
    """
...
def get_text_string(id: int) -> str:
    """
...
def get_text_total_height(id: int) -> float:
    """
...
def get_text_total_width(id: int) -> float:
    """
...
def get_text_visible(id: int) -> bool:
    """
    Returns False if the current text has been set as invisible using `set_text_visible()`, True if it is set as visible
    (default) This does not check if the text is currently positioned within the visible viewport.
...
def print_value(value: object, newline: Union[bool, int]=True) -> None:
    ...
    :param Optional[Union[bool, int]] newline: When True, adds a new line character so the next call will be one line
        down.
    :rtype: None
    """
    pass
...
'''*EXCLUDED*
def printc(value: object) -> None:
    """
    Prints the given value or string to the screen but does not add a new line character to the end.

    The next `print_value()` command will follow on directly from this one.

    :param object value: The value to print.
    :rtype: None
    """
    pass
'''
...
def set_print_color(red: int, green: int, blue: int, alpha: Optional[int]=None) -> None:
    """
    ...
    :param int green: The green component of the color.
    :param int blue: The blue component of the color.
    :param Optional[int] alpha: The alpha component of the color.
    :rtype: None
    """
    pass

def set_print_font(id: int) -> None:
    """
    ...
    :param int id: The font ID to use for `print_value()` text.
    :rtype: None
    """
    pass

def set_print_size(size: float) -> None:
    """
    ...
    :param float size: The size in virtual resolution pixels for the text.
    :rtype: None
    """
    pass

def set_print_spacing(spacing: float) -> None:
    """
    ...
    :param float spacing: The letter spacing to use.
    :rtype: None
    """
    pass

def set_text_alignment(id: int, align: int) -> None:
    """
...
def set_text_angle(id: int, angle: float) -> None:
    ...
    :param int id: The ID of the text object to update.
    :param float angle: The new angle in degrees.
    :rtype: None
    """
    pass

def set_text_angle_rad(id: int, angle: float) -> None:
    """
    Updates the angle of the text.
    ...
    :param int id: The ID of the text object to update.
    :param float angle: The new angle in radians.
    :rtype: None
    """
    pass

def set_text_bold(id: int, bold: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the text to modify.
    :param Union[bool, int] bold: True to use bold, False to use normal weight (default).
    :rtype: None
    """
    pass

def set_text_char_angle(id: int, char_index: int, angle: float) -> None:
    """
...
def set_text_char_angle_rad(id: int, char_index: int, angle: float) -> None:
    """
...
def set_text_char_bold(id: int, char_index: int, bold: Union[bool, int]) -> None:
    """
    ...
    :param int id: The ID of the text object to set.
...
def set_text_char_color(id: int, char_index: int, red: int, green: int, blue: int,
                        alpha: int) -> None:
    """
...
def set_text_char_color_alpha(id: int, char_index: int, alpha: int) -> None:
    """
    ...
    :param int char_index: The index of the character to set, indexes start at 0, if the index is out of range it will
        be ignored.
    :param int alpha: The alpha component for the character color.
    :rtype: None
    """
    pass

def set_text_char_color_blue(id: int, char_index: int, blue: int) -> None:
    """
    ...
    :param int char_index: The index of the character to set, indexes start at 0, if the index is out of range it will
        be ignored.
    :param int blue: The blue component for the character color.
    :rtype: None
    """
    pass

def set_text_char_color_green(id: int, char_index: int, green: int) -> None:
    """
    ...
    :param int char_index: The index of the character to set, indexes start at 0, if the index is out of range it will
        be ignored.
    :param int green: The green component for the character color.
    :rtype: None
    """
    pass

def set_text_char_color_red(id: int, char_index: int, red: int) -> None:
    """
    ...
    :param int char_index: The index of the character to set, indexes start at 0, if the index is out of range it will
        be ignored.
    :param int red: The red component for the character color.
    :rtype: None
    """
    pass

def set_text_char_position(id: int, char_index: int, x: float, y: float) -> None:
    """
    ...
    :param int char_index: The index of the character to modify, indexes start at 0, if the index is out of range it
        will be ignored.
    :param float x: The new X position of the character, relative to the current text position.
    :param float y: The new Y position of the character, relative to the current text position.
    :rtype: None
    """
    pass

def set_text_char_x(id: int, char_index: int, x: float) -> None:
    """
...
def set_text_char_y(id: int, char_index: int, y: float) -> None:
    """
...
def set_text_color(id: int, red: int, green: int, blue: int, alpha: int) -> None:
    """
...
def set_text_color_alpha(id: int, alpha: int) -> None:
    """
...
def set_text_color_blue(id: int, blue: int) -> None:
    """
...
def set_text_color_green(id: int, green: int) -> None:
    """
...
def set_text_color_red(id: int, red: int) -> None:
    """
...
def set_text_default_extended_font_image(id: int) -> None:
    """
    ...
    :param int id: The image containing the new font.
    :rtype: None
    """
    pass

def set_text_default_font_image(id: int) -> None:
    """
...
def set_text_depth(id: int, depth: int) -> None:
    """
...
def set_text_extended_font_image(id: int, image_id: int) -> None:
    """
    ...
    :param int id: The ID of the text object to change.
    :param int image_id: The image containing the new font.
    :rtype: None
    """
    pass

def set_text_font(id: int, font_id: int) -> None:
    """
...
def set_text_font_image(id: int, image_id: int) -> None:
    """
...
def set_text_line_spacing(id: int, spacing: float) -> None:
    """
    ...
    :param int id: The ID of the text object to update.
    :param float spacing: The new spacing to use.
    :rtype: None
    """
    pass

def set_text_max_width(id: int, width: float) -> None:
    """
    Sets the maximum width the text object will use to draw, any characters that extend beyond this value will wrap onto
    a new line.

    :param int id: The ID of the text object to change.
    :param float width: The maximum width the text will use.
    :rtype: None
    """
    pass

def set_text_position(id: int, x: float, y: float) -> None:
    """
...
def set_text_scissor(id: int, x1: float, y1: float, x2: float, y2: float) -> None:
    """
...
def set_text_size(id: int, size: float) -> None:
    """
    ...
    :param int id: The ID of the text object to update.
    :param float size: The new size of the text.
    :rtype: None
    """
    pass

def set_text_spacing(id: int, spacing: float) -> None:
    """
...
def set_text_string(id: int, text: str) -> None:
    """
...
def set_text_transparency(id: int, mode: int) -> None:
    """
...
def set_text_visible(id: int, visible: Union[bool, int]) -> None:
    """
...
def set_text_x(id: int, x: float) -> None:
    """
...
def set_text_y(id: int, y: float) -> None:
    """
...
def get_unix_from_date(year: int, month: int, day: int, hour: int, minute: int, second: int) -> int:
    """
    Converts a given date an time into its unix time equivalent, unix time is the number of seconds since 1st Jan 1970.
...
def add_tween_chain_camera(chain_id: int, tween_id: int, camera_id: int, delay: float=0) -> None:
    """
    ...
    :param Optional[float] delay: Number of seconds to wait before playing this tween when it is triggered.
    :rtype: None
    """
    pass
...
def add_tween_chain_custom(chain_id: int, tween_id: int, delay: float=0) -> None:
    """
...
def add_tween_chain_object(chain_id: int, tween_id: int, object_id: int, delay: float=0) -> None:
    """
...
def add_tween_chain_sprite(chain_id: int, tween_id: int, sprite_id: int, delay: float=0) -> None:
    """
...
def add_tween_chain_text(chain_id: int, tween_id: int, text_id: int, delay: float=0) -> None:
    """
...
def clear_tween_chain(id: int) -> None:
    """
    ...
    :param int id: ID of the tween to clear.
    :rtype: None
    """
    pass

def create_tween_camera(duration: float, id: int=0) -> int:
    """
    ...
    :param float duration: The duration of the tween in seconds.
    :param Optional[int] id: ID of the tween.
    :rtype: int
    """
    pass

def create_tween_chain(id: int=0) -> int:
    """
    ...
    :param Optional[int] id: ID of the chain.
    :rtype: int
    """
    pass

def create_tween_char(duration: float, id: int=0) -> int:
    """
...
def create_tween_custom(duration: float, id: int=0) -> int:
    """
...
def create_tween_object(duration: float, id: int=0) -> int:
    """
...
def create_tween_sprite(duration: float, id: int=0) -> int:
    """
...
def create_tween_text(duration: float, id: int=0) -> int:
    """
...
def delete_tween(id: int) -> None:
    """
    Delete a given tween ID.

    This can be used for all types of tween, sprite, text, object, etc.

    :param int id: ID of the tween to delete.
    :rtype: None
    """
    pass

def delete_tween_chain(id: int) -> None:
    """
    Deletes a chain and stops any tweens that were associated with it.

    Any tweens that were added to it are unaffected and can be used in future chains.

    :param int id: ID of the chain to delete.
    :rtype: None
    """
    pass

def get_tween_camera_exists(id: int) -> bool:
    """
    Returns True if a tween exists at the given ID and it is a camera tween, otherwise False.

    :param int id: ID of the tween to check.
    :rtype: bool
    """
    pass

def get_tween_camera_playing(id: int, camera_id: int) -> bool:
    """
...
def get_tween_chain_end_time(id: int) -> float:
    """
    Returns the total length of the tween chain in seconds.

    :param int id: ID of the chain to check.
    :rtype: float
    """
    pass

def get_tween_chain_playing(id: int) -> bool:
    """
...
def get_tween_char_exists(id: int) -> bool:
    """
...
def get_tween_char_playing(id: int, text_id: int, char_index: int) -> bool:
    """
...
def get_tween_custom_exists(id: int) -> bool:
    """
...
def get_tween_custom_float1(id: int) -> float:
    """
...
def get_tween_custom_float2(id: int) -> float:
    """
...
def get_tween_custom_float3(id: int) -> float:
    """
...
def get_tween_custom_float4(id: int) -> float:
    """
...
def get_tween_custom_integer1(id: int) -> int:
    """
...
def get_tween_custom_integer2(id: int) -> int:
    """
...
def get_tween_custom_integer3(id: int) -> int:
    """
...
def get_tween_custom_integer4(id: int) -> int:
    """
...
def get_tween_custom_playing(id: int) -> bool:
    """
...
def get_tween_exists(id: int) -> bool:
    """
...
def get_tween_object_exists(id: int) -> bool:
    """
...
def get_tween_object_playing(id: int, object_id: int) -> bool:
    """
...
def get_tween_sprite_exists(id: int) -> bool:
    """
...
def get_tween_sprite_playing(id: int, sprite_id: int) -> bool:
    """
...
def get_tween_text_exists(id: int) -> bool:
    """
...
def get_tween_text_playing(id: int, text_id: int) -> bool:
    """
...
def pause_tween_camera(id: int, camera_id: int) -> None:
    """
    ...
    :param int id: ID of the tween to pause.
    :param int camera_id: The ID of the camera.
    :rtype: None
    """
    pass

def pause_tween_chain(id: int) -> None:
    """
    Pauses the given chain that has started playing, it can be resumed with `play_tween_chain()`.

    :param int id: ID of the chain to modify.
    :rtype: None
    """
    pass

def pause_tween_char(id: int, text_id: int, char_index: int) -> None:
    """
    Pauses the given tween at its current point.
    ...
    :param int id: ID of the tween to pause.
    :param int text_id: The ID of the text object.
    :param int char_index: The index of the character.
    :rtype: None
    """
    pass

def pause_tween_custom(id: int) -> None:
    """
    Pauses the given tween at its current point.
...
def pause_tween_object(id: int, object_id: int) -> None:
    """
    Pauses the given tween at its current point.
...
def pause_tween_sprite(id: int, sprite_id: int) -> None:
    """
    Pauses the given tween at its current point.
...
def pause_tween_text(id: int, text_id: int) -> None:
    """
    Pauses the given tween at its current point.
...
def play_tween_camera(id: int, camera_id: int, delay: float=0) -> None:
    """
    ...
    :param int id: ID of the tween to use.
    :param int camera_id: ID of the camera to modify.
    :param Optional[float] delay: Number of seconds before the tween should start playing.
    :rtype: None
    """
    pass
...
def play_tween_char(id: int, text_id: int, char_index: int, delay: float=0) -> None:
    """
...
def play_tween_custom(id: int, delay: float=0) -> None:
    """
...
def play_tween_object(id: int, object_id: int, delay: float=0) -> None:
    """
...
def play_tween_sprite(id: int, sprite_id: int, delay: float=0) -> None:
    """
...
def play_tween_text(id: int, text_id: int, delay: float=0) -> None:
    """
...
def resume_tween_camera(id: int, camera_id: int) -> None:
    """
    ...
    :param int id: ID of the tween to resume.
    :param int camera_id: The ID of the camera.
    :rtype: None
    """
    pass

def resume_tween_char(id: int, text_id: int, char_index: int) -> None:
    """
...
def resume_tween_custom(id: int) -> None:
    """
...
def resume_tween_object(id: int, object_id: int) -> None:
    """
...
def resume_tween_sprite(id: int, sprite_id: int) -> None:
    """
...
def resume_tween_text(id: int, text_id: int) -> None:
    """
...
def set_tween_camera_angle_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Euler AngleX value for the camera, the camera will be rotated to this angle when
        playing starts.
    :param float end: The end Euler AngleX value for the camera, the camera will be rotated to this angle when playing
        ends.
...
def set_tween_camera_angle_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Euler AngleY value for the camera, the camera will be rotated to this angle when
        playing starts.
    :param float end: The end Euler AngleY value for the camera, the camera will be rotated to this angle when playing
        ends.
    :param int interpolation: The interpolation method whilst the camera is moving from begin to end.
    :rtype: None
    """
...
def set_tween_camera_angle_z(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Euler AngleZ value for the camera, the camera will be rotated to this angle when
        playing starts.
    :param float end: The end Euler AngleZ value for the camera, the camera will be rotated to this angle when playing
        ends.
    :param int interpolation: The interpolation method whilst the camera is moving from begin to end.
    :rtype: None
    """
...
def set_tween_camera_fov(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting FOV value for the camera, the camera will have this FOV value when playing starts.
    :param float end: The end FOV value for the camera, the camera will have this FOV value when playing ends.
    :param int interpolation: The interpolation method whilst the camera is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_camera_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting X value for the camera, the camera will be positioned here when playing starts.
    :param float end: The end X value for the camera, the camera will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the camera is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_camera_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Y value for the camera, the camera will be positioned here when playing starts.
    :param float end: The end Y value for the camera, the camera will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the camera is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_camera_z(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Z value for the camera, the camera will be positioned here when playing starts.
    :param float end: The end Z value for the camera, the camera will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the camera is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_chain_time(id: int, time: float) -> None:
    """
    ...
    :param int id: ID of the chain to modify.
    :param float time: The time in seconds to jump to in the tween chain.
    :rtype: None
    """
    pass

def set_tween_char_alpha(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_char_angle(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting angle value for the character, the character will be rotated at this angle when
        playing starts.
    :param float end: The end angle value for the character, the character will be rotated at this angle when playing
        ends.
    :param int interpolation: The interpolation method whilst the character is moving from begin to end.
    :rtype: None
    """
...
def set_tween_char_blue(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_char_green(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_char_red(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_char_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the X parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting X value for the character, the character will be positioned here when playing
        starts.
    :param float end: The end X value for the character, the character will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the character is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_char_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Y parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Y value for the character, the character will be positioned here when playing
        starts.
    :param float end: The end Y value for the character, the character will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the character is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_custom_float1(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting point for this value.
    :param float end: The end point for this value.
    :param int interpolation: The interpolation method whilst the value is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_custom_float2(id: int, begin: float, end: float, interpolation: int) -> None:
    """
...
def set_tween_custom_float3(id: int, begin: float, end: float, interpolation: int) -> None:
    """
...
def set_tween_custom_float4(id: int, begin: float, end: float, interpolation: int) -> None:
    """
...
def set_tween_custom_integer1(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_custom_integer2(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_custom_integer3(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_custom_integer4(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_duration(id: int, duration: float) -> None:
    """
    ...
    :param int id: ID of the tween to change, can be any type of tween.
    :param float duration: The new duration to use in seconds.
    :rtype: None
    """
    pass

def set_tween_object_alpha(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_object_angle_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Euler AngleX parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting AngleX value for the object, the object will be rotated to this angle when playing
        starts.
    :param float end: The end AngleX value for the object, the object will be rotated to this angle when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_angle_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Euler AngleY parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting AngleY value for the object, the object will be rotated to this angle when playing
        starts.
    :param float end: The end AngleY value for the object, the object will be rotated to this angle when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_angle_z(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Euler AngleZ parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting AngleZ value for the object, the object will be rotated to this angle when playing
        starts.
    :param float end: The end AngleZ value for the object, the object will be rotated to this angle when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_blue(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_object_green(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_object_red(id: int, begin: int, end: int, interpolation: int) -> None:
    """
...
def set_tween_object_scale_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting ScaleX value for the object, the object will be rotated to this angle when playing
        starts.
    :param float end: The end ScaleX value for the object, the object will be rotated to this angle when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_scale_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting ScaleY value for the object, the object will be rotated to this angle when playing
        starts.
    :param float end: The end ScaleY value for the object, the object will be rotated to this angle when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_scale_z(id: int, begin: float, end: float, interpolation: int) -> None:
    """
...
def set_tween_object_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the X parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting X value for the object, the object will be positioned here when playing starts.
    :param float end: The end X value for the object, the object will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Y parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Y value for the object, the object will be positioned here when playing starts.
    :param float end: The end Y value for the object, the object will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_object_z(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Z parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Z value for the object, the object will be positioned here when playing starts.
    :param float end: The end Z value for the object, the object will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the object is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_sprite_alpha(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the alpha parameter of the given tween ID.
...
def set_tween_sprite_angle(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the angle parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting angle value for the sprite, the sprite will be rotated at this angle when playing
        starts.
    :param float end: The end angle value for the sprite, the sprite will be rotated at this angle when playing ends.
    :param int interpolation: The interpolation method whilst the sprite is rotating from begin to end.
    :rtype: None
    """
    pass

def set_tween_sprite_blue(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the blue parameter of the given tween ID.
...
def set_tween_sprite_green(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the green parameter of the given tween ID.
...
def set_tween_sprite_red(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the red parameter of the given tween ID.
...
def set_tween_sprite_size_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting SizeX value for the sprite, the sprite will be this size when playing starts.
    :param float end: The end SizeX value for the sprite, the sprite will be this size when playing ends.
    :param int interpolation: The interpolation method whilst the sprite is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_sprite_size_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting SizeY value for the sprite, the sprite will be this size when playing starts.
    :param float end: The end SizeY value for the sprite, the sprite will be this size when playing ends.
    :param int interpolation: The interpolation method whilst the sprite is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_sprite_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the X parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting X value for the sprite, the sprite will be positioned here when playing starts.
    :param float end: The end X value for the sprite, the sprite will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the sprite is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_sprite_x_by_offset(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the X parameter of the given tween ID.
...
def set_tween_sprite_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Y parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Y value for the sprite, the sprite will be positioned here when playing starts.
    :param float end: The end Y value for the sprite, the sprite will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the sprite is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_sprite_y_by_offset(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Y parameter of the given tween ID.
...
def set_tween_text_alpha(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the alpha parameter of the given tween ID.
...
def set_tween_text_angle(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the angle parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting angle value for the text, the text will be rotated at this angle when playing
        starts.
    :param float end: The end angle value for the text, the text will be rotated at this angle when playing ends.
    :param int interpolation: The interpolation method whilst the text is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_text_blue(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the blue parameter of the given tween ID.
...
def set_tween_text_green(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the green parameter of the given tween ID.
...
def set_tween_text_line_spacing(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting lLine spacing value for the text, the text will have this spacing when playing
        starts.
    :param float end: The end line spacing value for the text, the text will have this spacing when playing ends.
    :param int interpolation: The interpolation method whilst the text is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_text_red(id: int, begin: int, end: int, interpolation: int) -> None:
    """
    Sets the red parameter of the given tween ID.
...
def set_tween_text_size(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting size value for the text, the text will be this size when playing starts.
    :param float end: The end size value for the text, the text will be this size when playing ends.
    :param int interpolation: The interpolation method whilst the text is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_text_spacing(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting spacing value for the text, the text will have this spacing when playing starts.
    :param float end: The end spacing value for the text, the text will have this spacing when playing ends.
    :param int interpolation: The interpolation method whilst the text is moving from begin to endSP.
    :rtype: None
    """
    pass

def set_tween_text_x(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the X parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting X value for the text, the text will be positioned here when playing starts.
    :param float end: The end X value for the text, the text will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the text is moving from begin to end.
    :rtype: None
    """
    pass

def set_tween_text_y(id: int, begin: float, end: float, interpolation: int) -> None:
    """
    Sets the Y parameter of the given tween ID.
    ...
    :param int id: ID of the tween to modify.
    :param float begin: The starting Y value for the text, the text will be positioned here when playing starts.
    :param float end: The end Y value for the text, the text will be positioned here when playing ends.
    :param int interpolation: The interpolation method whilst the text is moving from begin to end.
    :rtype: None
    """
    pass

def stop_tween_camera(id: int, camera_id: int) -> None:
    """
    ...
    :param int id: ID of the tween to stop.
    :param int camera_id: ID of the camera to stop.
    :rtype: None
    """
    pass

def stop_tween_chain(id: int) -> None:
    """
...
def stop_tween_char(id: int, text_id: int, char_index: int) -> None:
    """
...
def stop_tween_custom(id: int) -> None:
    """
...
def stop_tween_object(id: int, object_id: int) -> None:
    """
...
def stop_tween_sprite(id: int, sprite_id: int) -> None:
    """
...
def stop_tween_text(id: int, text_id: int) -> None:
    """
...
def update_all_tweens(time: float) -> None:
    """
    ...
    :param float time: The time to advance the tweens.
    :rtype: None
    """
    pass

def update_tween_camera(id: int, camera_id: int, time: float) -> None:
    """
    ...
    :param int id: The ID of the tween to update.
    :param int camera_id: The ID of the object to update.
    :param float time: The time to advance the tween.
    :rtype: None
    """
    pass

def update_tween_chain(id: int, time: float) -> None:
    """
    ...
    :param int id: The ID of the chain to update.
    :param float time: The time to advance the chain.
    :rtype: None
    """
    pass

def update_tween_char(id: int, text_id: int, char_index: int, time: float) -> None:
    """
    Updates a specific tween that has been started.
...
def update_tween_custom(id: int, time: float) -> None:
    """
    Updates a specific tween that has been started.
...
def update_tween_object(id: int, object_id: int, time: float) -> None:
    """
    Updates a specific tween that has been started.
...
def update_tween_sprite(id: int, sprite_id: int, time: float) -> None:
    """
    Updates a specific tween that has been started.
...
def update_tween_text(id: int, text_id: int, time: float) -> None:
    """
    Updates a specific tween that has been started.
...
def play_video_to_image(id: int) -> None:
    """
    ...
    :param int id: An ID to use to reference the new image, must not already exist.
    :rtype: None
    """
    pass

def set_video_dimensions(x: float, y: float, width: float, height: float) -> None:
    """
    ...
    :param float x: The x coordinate to position the top left corner of the video.
    :param float y: The y coordinate to position the top left corner of the video.
    :param float width: The width to display the video.
    :param float height: The height to display the video.
    :rtype: None
    """
    pass

def set_video_position(seconds: float) -> None:
    """
    ...
    :param float seconds: The position in the video to seek to.
    :rtype: None
    """
    pass

def set_video_volume(volume: float) -> None:
    """
    Currently not functional.

    :param float volume: The volume of the video in the range 0-100.
    :rtype: None
    """
    pass
...
def start_screen_recording(filename: str, microphone: int) -> None:
    ...
    device will always save the recording in the camera roll. The microphone parameter should be set to 1 to record
    audio from the device microphone during the recording. Unfortunately Android does not support recording audio
    directly from the app, so using a value of 0 will produce a silent video. The audio output from the app may be
    audible through the microphone recording though. Recording through the microphone requires that you enable the
    "Record Audio" permission when exporting your APK. On iOS a microphone value of 1 will record both the app audio
    output and the microphone, a value of 0 will only record the app audio.

    On Android the recording may stop at any time, for example if the app is sent to the background, or if another
    activity is activated such as an In App Purchase, or using the `facebook_login()` command. On iOS the recording will
    continue after such interruptions, until `stop_screen_recording()` is called.
...
def create_window(x: Optional[int]=None, y: Optional[int]=None, width: int=1024, height: int=768,
                  fullscreen: Union[bool, int]=False, company_name: Optional[str]=None,
...
def enable_debug_log(enabled: Union[bool, int]=True) -> None:
    ...
    :param Optional[Union[bool, int]] enabled: True to enable logging to stdout.
    :rtype: None
    """
    pass

def import_plugin(name: str) -> ctypes.CDLL:
    r"""
    ...
    Commands.txt file must also be located in your plugin's folder and distributed with your game.
...
def get_run_time() -> float:
    """
    Undocumented command that appears to return the time since the application started.
